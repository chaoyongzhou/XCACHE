...
Syntax :    bgn\_set\_by\_lua\_block {dir0|0|dir1|1|dir2|2|dir3|3|dir4|4} $res <lua-script-str>;
...
### 1.6.3 Run Lua Block - bgn\_lua\_block ###
**Directives**
...
### 1.6.4 Run Lua File - bgn\_lua\_file ###
**Directives**
