...
#rpmbuild -bb ${fs_type}.${os_type}.spec

#rpmbuild -ba ${fs_type}.${os_type}.spec || exit 1
...
cp -af ${pkg_src}/build/${fs_type}/centos7/${fs_type}.${os_type}.spec ${CUR_DIR}/${fs_type}.${os_type}.spec
