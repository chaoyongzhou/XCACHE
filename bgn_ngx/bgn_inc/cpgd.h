...
#define CPGD_TEST_SCENARIO_004G_DISK     (1)
#define CPGD_TEST_SCENARIO_008G_DISK     (2)
#define CPGD_TEST_SCENARIO_016G_DISK     (3)
#define CPGD_TEST_SCENARIO_032G_DISK     (4)
#define CPGD_TEST_SCENARIO_064G_DISK     (5)
#define CPGD_TEST_SCENARIO_128G_DISK     (6)
#define CPGD_TEST_SCENARIO_256G_DISK     (7)
#define CPGD_TEST_SCENARIO_512G_DISK     (8)
#define CPGD_TEST_SCENARIO_001T_DISK     (9)

#define CPGD_DEBUG_CHOICE CPGD_TEST_SCENARIO_032G_DISK


#if (CPGD_TEST_SCENARIO_004G_DISK == CPGD_DEBUG_CHOICE)
#define CPGD_MAX_BLOCK_NUM               (CPGD_004GB_BLOCK_NUM)
