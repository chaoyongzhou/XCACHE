...
#define                       MM_CXFSPGB    ((UINT32)264)
#define                       MM_CXFSPGD    ((UINT32)265)
#define                       MM_CXFSPGV    ((UINT32)266)
#define                  MM_CXFSNP_FNODE    ((UINT32)267)
#define                  MM_CXFSNP_DNODE    ((UINT32)268)
#define                   MM_CXFSNP_ITEM    ((UINT32)269)
#define                        MM_CXFSNP    ((UINT32)270)
#define                    MM_CXFSNP_MGR    ((UINT32)271)
#define                    MM_CXFSNP_KEY    ((UINT32)272)
#define                        MM_CXFSDN    ((UINT32)273)
#define                   MM_CXFSCONHASH    ((UINT32)274)
#define             MM_CXFSCONHASH_RNODE    ((UINT32)275)
#define             MM_CXFSCONHASH_VNODE    ((UINT32)276)
#define              MM_CXFS_LOCKED_FILE    ((UINT32)277)
#define                MM_CXFS_WAIT_FILE    ((UINT32)278)
#define                     MM_CXFS_NODE    ((UINT32)279)
#define                 MM_CXFS_HOT_PATH    ((UINT32)280)
