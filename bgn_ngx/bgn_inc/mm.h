...
#define                     MM_CAMD_PAGE    ((UINT32)245)
#define                      MM_CAMD_REQ    ((UINT32)246)
#define                     MM_CAMD_NODE    ((UINT32)247)

#define                         MM_CDCDN    ((UINT32)248)
#define                        MM_CDCPGV    ((UINT32)249)
#define                        MM_CDCPGD    ((UINT32)250)
#define                         MM_CDCNP    ((UINT32)251)
#define                   MM_CDCNP_FNODE    ((UINT32)252)
#define                   MM_CDCNP_DNODE    ((UINT32)253)
#define                     MM_CDCNP_KEY    ((UINT32)254)
#define                    MM_CDCNP_ITEM    ((UINT32)255)
#define                  MM_CDCNP_BITMAP    ((UINT32)256)
#define                     MM_CDCDN_AIO    ((UINT32)257)
#define                     MM_CDCNP_AIO    ((UINT32)258)
#define                MM_CDCDN_FILE_AIO    ((UINT32)259)
#define                  MM_CDC_FILE_AIO    ((UINT32)260)

#define                       MM_CXFSPGB    ((UINT32)261)
#define                       MM_CXFSPGD    ((UINT32)262)
#define                       MM_CXFSPGV    ((UINT32)263)
#define                  MM_CXFSNP_FNODE    ((UINT32)264)
#define                  MM_CXFSNP_DNODE    ((UINT32)265)
#define                   MM_CXFSNP_ITEM    ((UINT32)266)
#define                        MM_CXFSNP    ((UINT32)267)
#define                    MM_CXFSNP_MGR    ((UINT32)268)
#define                    MM_CXFSNP_KEY    ((UINT32)269)
#define                        MM_CXFSDN    ((UINT32)270)
#define                   MM_CXFSCONHASH    ((UINT32)271)
#define             MM_CXFSCONHASH_RNODE    ((UINT32)272)
#define             MM_CXFSCONHASH_VNODE    ((UINT32)273)
#define              MM_CXFS_LOCKED_FILE    ((UINT32)274)
#define                MM_CXFS_WAIT_FILE    ((UINT32)275)
#define                     MM_CXFS_NODE    ((UINT32)276)
#define                 MM_CXFS_HOT_PATH    ((UINT32)277)
