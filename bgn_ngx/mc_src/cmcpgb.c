...
static const CMCPGB_CONF g_cmcpgb_conf[] = {
    {"CMCPGB_032MB_MODEL", CMCPGB_032MB_MODEL,  CMCPGB_032MB_BITMAP_SIZE, CMCPGB_032MB_PAGE_NUM, 0,},
    {"CMCPGB_016MB_MODEL", CMCPGB_016MB_MODEL,  CMCPGB_016MB_BITMAP_SIZE, CMCPGB_016MB_PAGE_NUM, 0,},
    {"CMCPGB_008MB_MODEL", CMCPGB_008MB_MODEL,  CMCPGB_008MB_BITMAP_SIZE, CMCPGB_008MB_PAGE_NUM, 0,},
    {"CMCPGB_004MB_MODEL", CMCPGB_004MB_MODEL,  CMCPGB_004MB_BITMAP_SIZE, CMCPGB_004MB_PAGE_NUM, 0,},
    {"CMCPGB_002MB_MODEL", CMCPGB_002MB_MODEL,  CMCPGB_002MB_BITMAP_SIZE, CMCPGB_002MB_PAGE_NUM, 0,},
    {"CMCPGB_001MB_MODEL", CMCPGB_001MB_MODEL,  CMCPGB_001MB_BITMAP_SIZE, CMCPGB_001MB_PAGE_NUM, 0,},
    {"CMCPGB_512KB_MODEL", CMCPGB_512KB_MODEL,  CMCPGB_512KB_BITMAP_SIZE, CMCPGB_512KB_PAGE_NUM, 0,},
    {"CMCPGB_256KB_MODEL", CMCPGB_256KB_MODEL,  CMCPGB_256KB_BITMAP_SIZE, CMCPGB_256KB_PAGE_NUM, 0,},
    {"CMCPGB_128KB_MODEL", CMCPGB_128KB_MODEL,  CMCPGB_128KB_BITMAP_SIZE, CMCPGB_128KB_PAGE_NUM, 0,},
    {"CMCPGB_064KB_MODEL", CMCPGB_064KB_MODEL,  CMCPGB_064KB_BITMAP_SIZE, CMCPGB_064KB_PAGE_NUM, 0,},
    {"CMCPGB_032KB_MODEL", CMCPGB_032KB_MODEL,  CMCPGB_032KB_BITMAP_SIZE, CMCPGB_032KB_PAGE_NUM, 0,},
    {"CMCPGB_016KB_MODEL", CMCPGB_016KB_MODEL,  CMCPGB_016KB_BITMAP_SIZE, CMCPGB_016KB_PAGE_NUM, 0,},
    {"CMCPGB_008KB_MODEL", CMCPGB_008KB_MODEL,  CMCPGB_008KB_BITMAP_SIZE, CMCPGB_008KB_PAGE_NUM, 0,},
    {"CMCPGB_004KB_MODEL", CMCPGB_004KB_MODEL,  CMCPGB_004KB_BITMAP_SIZE, CMCPGB_004KB_PAGE_NUM, 0,},
    {"CMCPGB_002KB_MODEL", CMCPGB_002KB_MODEL,  CMCPGB_002KB_BITMAP_SIZE, CMCPGB_002KB_PAGE_NUM, 0,},
};
...
const char *cmcpgb_model_str(const uint16_t pgb_page_num)
{
    ...
    for(page_model = 0; page_model < sizeof(g_cmcpgb_conf)/sizeof(g_cmcpgb_conf[0]); page_model ++)
    {
        const CMCPGB_CONF *cmcpgb_conf;

        cmcpgb_conf = &(g_cmcpgb_conf[ page_model ]);
        if(pgb_page_num == CMCPGB_CONF_PAGE_NUM(cmcpgb_conf))
        {
            return CMCPGB_CONF_NAME(cmcpgb_conf);
        }
    }
...
void cmcpgb_page_model_print(LOG *log, const CMCPGB *cmcpgb, const uint16_t page_model)
{
    ...
    page_num            = CMCPGB_CONF_PAGE_NUM(cmcpgb_conf);
...
EC_BOOL cmcpgb_init(CMCPGB *cmcpgb, const uint16_t page_model_target)
{
    ...
    cmcpgb_conf  = &(g_cmcpgb_conf[ page_model_target ]);
    page_max_num = CMCPGB_CONF_PAGE_NUM(cmcpgb_conf);
...
EC_BOOL cmcpgb_new_space(CMCPGB *cmcpgb, const uint32_t size, uint16_t *page_no)
{
    ...
    CMCPGB_ASSERT(CMCPGB_032MB_PAGE_NUM >= page_num_need);
...
EC_BOOL cmcpgb_free_space(CMCPGB *cmcpgb, const uint16_t page_start_no, const uint32_t size)
{
    ...
    CMCPGB_ASSERT(CMCPGB_032MB_PAGE_NUM >= page_num_used);
...
EC_BOOL cmcpgb_check(const CMCPGB *cmcpgb)
{
    ...
    for(page_model = 0; CMCPGB_MODEL_NUM > page_model; page_model ++)
    {
        page_free_num += (uint16_t)(__cmcpgb_page_model_cmcpgrb_bitmap_count_bits(cmcpgb, page_model) << (CMCPGB_MODEL_NUM - 1 - page_model));
    }
...
void cmcpgb_print(LOG *log, const CMCPGB *cmcpgb)
{
    ...
    occupied_size = (0.0 + CMCPGB_PAGE_USED_NUM(cmcpgb) * (uint32_t)(1 << CMCPGB_PAGE_BIT_SIZE));
