...
#define CAIO_002M_MODEL   ((uint8_t)12)
#define CAIO_004M_MODEL   ((uint8_t)13)
#define CAIO_008M_MODEL   ((uint8_t)14)
#define CAIO_016M_MODEL   ((uint8_t)15)
#define CAIO_032M_MODEL   ((uint8_t)16)
#define CAIO_064M_MODEL   ((uint8_t)17)
...
#define CAIO_002M_BLOCK_SIZE_NBIT   (21)
#define CAIO_002M_BLOCK_SIZE_NBYTE  (UINT32_ONE << CAIO_002M_BLOCK_SIZE_NBIT)
#define CAIO_002M_BLOCK_SIZE_MASK   (CAIO_002M_BLOCK_SIZE_NBYTE - 1)

#define CAIO_004M_BLOCK_SIZE_NBIT   (22)
#define CAIO_004M_BLOCK_SIZE_NBYTE  (UINT32_ONE << CAIO_004M_BLOCK_SIZE_NBIT)
#define CAIO_004M_BLOCK_SIZE_MASK   (CAIO_004M_BLOCK_SIZE_NBYTE - 1)

#define CAIO_008M_BLOCK_SIZE_NBIT   (23)
#define CAIO_008M_BLOCK_SIZE_NBYTE  (UINT32_ONE << CAIO_008M_BLOCK_SIZE_NBIT)
#define CAIO_008M_BLOCK_SIZE_MASK   (CAIO_008M_BLOCK_SIZE_NBYTE - 1)

#define CAIO_016M_BLOCK_SIZE_NBIT   (24)
#define CAIO_016M_BLOCK_SIZE_NBYTE  (UINT32_ONE << CAIO_016M_BLOCK_SIZE_NBIT)
#define CAIO_016M_BLOCK_SIZE_MASK   (CAIO_016M_BLOCK_SIZE_NBYTE - 1)

#define CAIO_032M_BLOCK_SIZE_NBIT   (25)
#define CAIO_032M_BLOCK_SIZE_NBYTE  (UINT32_ONE << CAIO_032M_BLOCK_SIZE_NBIT)
#define CAIO_032M_BLOCK_SIZE_MASK   (CAIO_032M_BLOCK_SIZE_NBYTE - 1)

#define CAIO_064M_BLOCK_SIZE_NBIT   (26)
#define CAIO_064M_BLOCK_SIZE_NBYTE  (UINT32_ONE << CAIO_064M_BLOCK_SIZE_NBIT)
#define CAIO_064M_BLOCK_SIZE_MASK   (CAIO_064M_BLOCK_SIZE_NBYTE - 1)
