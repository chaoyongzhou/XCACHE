...
#define CMCDN_NODE_DESC                 ("32M-node")
...
#define CMCDN_NODE_DESC                 ("64M-node")
...
#define CMCDN_NODE_DESC                 ("128M-node")
...
#define CMCDN_NODE_DESC                 ("256M-node")
...
#define CMCDN_NODE_DESC                 ("512M-node")
...
#define CMCDN_NODE_DESC                 ("1G-node")
...
#define CMCDN_NODE_DESC                 ("2G-node")
...
#define CMCDN_NODE_DESC                 ("4G-node")
