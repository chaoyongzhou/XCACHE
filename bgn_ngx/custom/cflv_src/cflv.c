...
UINT32 cflv_start(ngx_http_request_t *r)
{
    ...
    CFLV_MD_CNGX_PRELOAD_SWITCH_ON_FLAG(cflv_md)        = BIT_FALSE;
    ...
    if(NULL_PTR != r->headers_in.range)
    {
        ...
        if(EC_FALSE == crange_parse_range(range_str, CFLV_MD_CNGX_RANGE_MGR(cflv_md)))
        {
            dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_get_req_range_segs: "
                                                 "invalid Range '%s'\n",
                                                 range_str);
            cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_RANGE_NOT_SATISFIABLE, LOC_CFLV_0001);
            return (EC_FALSE);
        }
...
EC_BOOL cflv_filter_rsp_range(const UINT32 cflv_md_id)
{
    ...
    && BIT_FALSE == CFLV_MD_CNGX_RANGE_ADJUSTED_FLAG(cflv_md))
    {
        ...
        if(0 == crange_mgr_node_num(CFLV_MD_CNGX_RANGE_MGR(cflv_md)))
        {
            ...
            cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_RANGE_NOT_SATISFIABLE, LOC_CFLV_0004);
            return (EC_FALSE);
        }
...
EC_BOOL cflv_content_handler(const UINT32 cflv_md_id)
{
    ...
    /*preload mode*/
    if(BIT_FALSE == CFLV_MD_CNGX_PRELOAD_SWITCH_ON_FLAG(cflv_md)
    && EC_TRUE == cngx_is_method(r, (const char *)"PUT"))
    {
        CFLV_MD_CNGX_PRELOAD_SWITCH_ON_FLAG(cflv_md) = BIT_TRUE;
    }

    if(EC_FALSE == cngx_option_set_cacheable_method(r, CFLV_MD_CNGX_OPTION(cflv_md)))
    {
    ...
    if(EC_TRUE == cngx_is_direct_orig_switch_on(r))
    {
        ...
        if(EC_TRUE == cflv_content_direct_procedure(cflv_md_id))
        {
            if(BIT_TRUE == CFLV_MD_CNGX_PRELOAD_SWITCH_ON_FLAG(cflv_md))
            {
                return cflv_content_preload_procedure(cflv_md_id);
            }
            return (EC_TRUE);
        }
    ...
    if(EC_TRUE == cflv_content_cache_procedure(cflv_md_id))
    {
        if(BIT_TRUE == CFLV_MD_CNGX_PRELOAD_SWITCH_ON_FLAG(cflv_md))
        {
            return cflv_content_preload_procedure(cflv_md_id);
...
EC_BOOL cflv_content_head_header_in_filter_upstream(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_head_header_in_filter_upstream: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_head_header_in_filter_upstream: "
...
EC_BOOL cflv_content_head_header_in_filter_server(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_head_header_in_filter_server: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
...
EC_BOOL cflv_content_head_header_in_filter(const UINT32 cflv_md_id)
{
    ...
    do
    {
        ...
        if(EC_TRUE == chttp_req_has_ipaddr(CFLV_MD_CHTTP_REQ(cflv_md))
        && EC_TRUE == chttp_req_has_port(CFLV_MD_CHTTP_REQ(cflv_md)))
        {
            break; /*ok*/
        }
        ...
        {
            /*upstream*/
            if(EC_FALSE == cflv_content_head_header_in_filter_upstream(cflv_md_id))
            {
                dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_head_header_in_filter: "
        ...
        {
            /*try best!*/
            if(EC_FALSE == cflv_content_head_header_in_filter_server(cflv_md_id))
            {
                dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_head_header_in_filter: "
    ...
    do
    {
        ...
        && NULL_PTR != v)
        {
            ...
            if(EC_FALSE == chttp_req_set_ca_file(CFLV_MD_CHTTP_REQ(cflv_md), v))
            {
                ...
                cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0029);
...
EC_BOOL cflv_content_head_header_out_rsp_status_filter(const UINT32 cflv_md_id)
{
    ...
    if(NULL_PTR != v)
    {
        ...
        {
            cflv_set_ngx_rc(cflv_md_id, CHTTP_NOT_FOUND, LOC_CFLV_0037);
...
EC_BOOL cflv_content_head_send_request(const UINT32 cflv_md_id)
{
    ...
    if(EC_FALSE == cngx_export_header_in(r, chttp_req))
    {
        ...
        cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0040);
        return (EC_FALSE);
    }
    if(EC_FALSE == cflv_content_head_header_in_filter(cflv_md_id))
    {
        ...
        cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0041);
        return (EC_FALSE);
    }
    ...
    if(EC_FALSE == chttp_request(chttp_req, NULL_PTR, chttp_rsp, NULL_PTR))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_head_send_request: "
                                             "http request failed\n");
        cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_BAD_GATEWAY, LOC_CFLV_0042);
        return (EC_FALSE);
    }
    if(do_log(SEC_0146_CFLV, 9))
    {
    ...
    if(EC_TRUE == cngx_need_send_header(r))
    {
        if(BIT_FALSE == CFLV_MD_CNGX_PRELOAD_SWITCH_ON_FLAG(cflv_md))
        {
            if(EC_FALSE == cflv_content_head_header_out_filter(cflv_md_id))
            {
                ...
                cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0043);
                return (EC_FALSE);
            }
...
EC_BOOL cflv_content_direct_header_in_filter_upstream(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_direct_header_in_filter_upstream: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    if(EC_FALSE == cngx_upstream_get_name(r, &upstream_name_str, &upstream_name_len))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_direct_header_in_filter_upstream: "
                                             "get upstream name failed\n");
        return (EC_FALSE);
    }
    ...
    if(EC_FALSE == chttp_req_set_ipaddr_word(chttp_req, upstream_peer_ipaddr))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_direct_header_in_filter_upstream: "
                                             ...
                                             c_word_to_ipv4(upstream_peer_ipaddr),
                                             upstream_name_len, upstream_name_str);
        cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0044);
        return (EC_FALSE);
    }
    ...
    if(EC_FALSE == chttp_req_set_port_word(chttp_req, upstream_peer_port))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_direct_header_in_filter_upstream: "
                                             ...
                                             upstream_peer_port,
                                             upstream_name_len, upstream_name_str);
        cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0045);
        return (EC_FALSE);
    }
...
EC_BOOL cflv_content_direct_header_in_filter_server(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_direct_header_in_filter_server: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    for(tag_idx = 0; tag_idx < sizeof(tags)/sizeof(tags[ 0 ]); tag_idx ++)
    {
        ...
        if(NULL_PTR != v)
        {
            ...
            if(EC_FALSE == chttp_req_set_ipaddr(chttp_req, segs[ 0 ]))
            {
                ...
                cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_GATEWAY_TIME_OUT, LOC_CFLV_0047);
                return (EC_FALSE);
            }
            dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_direct_header_in_filter_server: "
                                                 "[cngx] set host '%s' to http req done\n",
...
EC_BOOL cflv_content_direct_header_in_filter_host(const UINT32 cflv_md_id)
{
    ...
    if(NULL_PTR != v)
    {
        ...
        if(EC_FALSE == chttp_req_set_ipaddr(chttp_req, v))
        {
            ...
            cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_GATEWAY_TIME_OUT, LOC_CFLV_0050);
            return (EC_FALSE);
        }
    ...
    do
    {
        ...
        if(NULL_PTR != v)
        {
            ...
            if(EC_FALSE == chttp_req_set_server(CFLV_MD_CHTTP_REQ(cflv_md), v))
            {
                ...
                cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_GATEWAY_TIME_OUT, LOC_CFLV_0065);
        ...
        {
            /*upstream*/
            if(EC_FALSE == cflv_content_direct_header_in_filter_upstream(cflv_md_id))
            {
                dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_direct_header_in_filter: "
                                                     "filter upstream failed\n");
                return (EC_FALSE);
        ...
        {
            /*try best!*/
            if(EC_FALSE == cflv_content_direct_header_in_filter_server(cflv_md_id))
            {
                dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_direct_header_in_filter: "
                                                     "filter server failed\n");
                return (EC_FALSE);
...
EC_BOOL cflv_content_direct_header_out_range_filter(const UINT32 cflv_md_id)
{
    ...
    while(BIT_FALSE == CFLV_MD_CONTENT_LENGTH_EXIST_FLAG(cflv_md))
    {
        ...
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "warn:cflv_content_direct_header_out_range_filter: "
                                             "no 'Content-Range' => failed\n");
        /*maybe chunk*/
        return (EC_FALSE)/*cflv_content_chunk_header_out_filter(cflv_md_id)*/;
    }
...
EC_BOOL cflv_content_direct_header_out_rsp_status_filter(const UINT32 cflv_md_id)
{
    ...
    if(NULL_PTR != v)
    {
        ...
        if(CHTTP_NOT_FOUND == response_status)
        {
            cflv_set_ngx_rc(cflv_md_id, CHTTP_NOT_FOUND, LOC_CFLV_0073);
...
EC_BOOL cflv_content_direct_header_out_filter(const UINT32 cflv_md_id)
{
    ...
    if(BIT_FALSE == CFLV_MD_CNGX_DIRECT_IMS_FLAG(cflv_md))
    {
        if(EC_FALSE == cflv_filter_rsp_range(cflv_md_id))
        {
            ...
            cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_RANGE_NOT_SATISFIABLE, LOC_CFLV_0074);
            return (EC_FALSE);
        }
...
EC_BOOL cflv_content_direct_set_store(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_direct_set_store: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_direct_set_store: "
...
EC_BOOL cflv_content_direct_send_request(const UINT32 cflv_md_id)
{
    ...
    if(NULL_PTR == CFLV_MD_CHTTP_REQ(cflv_md))
    {
        ...
        if(NULL_PTR == chttp_req)
        {
            dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_direct_send_request: "
                                                 "new chttp_req failed\n");
            cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0075);
            return (EC_FALSE);
        }
        CFLV_MD_CHTTP_REQ(cflv_md) = chttp_req;
    }
    ...
    if(NULL_PTR == CFLV_MD_CHTTP_RSP(cflv_md))
    {
        ...
        if(NULL_PTR == chttp_rsp)
        {
            dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_direct_send_request: "
                                                 "new chttp_rsp failed\n");
            chttp_req_free(chttp_req);
            cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0076);
            return (EC_FALSE);
        }
        CFLV_MD_CHTTP_RSP(cflv_md) = chttp_rsp;
    }
    ...
    if(EC_FALSE == cflv_content_direct_header_in_filter(cflv_md_id))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_direct_send_request: "
                                             "header_in filter failed\n");
        cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0078);
        return (EC_FALSE);
    }
    ...
    if(NULL_PTR == CFLV_MD_CHTTP_STORE(cflv_md))
    {
        ...
        if(NULL_PTR == chttp_store)
        {
            ...
            cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0079);
            return (EC_FALSE);
        }
    ...
    if(EC_FALSE == cflv_content_direct_set_store(cflv_md_id))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_direct_send_request: "
    ...
    if(do_log(SEC_0146_CFLV, 9))
    {
        dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_direct_send_request: "
                                             "chttp_store is\n");
    ...
    if(EC_FALSE == chttp_request(chttp_req, chttp_store, chttp_rsp, NULL_PTR))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_direct_send_request: "
                                             "http request failed\n");
        cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_BAD_GATEWAY, LOC_CFLV_0081);
        return (EC_FALSE);
    }
...
EC_BOOL cflv_content_direct_send_seg_n(const UINT32 cflv_md_id, const CRANGE_SEG *crange_seg)
{
    ...
    /*check seg num*/
    if(CFLV_ERR_SEG_NO != CRANGE_SEG_NO(crange_seg)
    && CFLV_MD_CACHE_SEG_MAX_NUM(cflv_md) < CRANGE_SEG_NO(crange_seg))
    {
...
EC_BOOL cflv_content_direct_import_header(const UINT32 cflv_md_id, const CHTTP_NODE *chttp_node)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_direct_import_header: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    if(do_log(SEC_0146_CFLV, 9))
    {
        sys_log(LOGSTDOUT, "[DEBUG] cflv_content_direct_import_header: cloned chttp_rsp: \n");
...
EC_BOOL cflv_content_direct_send_header(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_direct_send_header: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    if(EC_FALSE == cngx_need_send_header(r))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_direct_send_header: "
    ...
    if(BIT_FALSE == CFLV_MD_CNGX_PRELOAD_SWITCH_ON_FLAG(cflv_md))
    {
        ...
        dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_direct_send_header: "
                                             "send header done\n");

        dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_direct_send_header: done\n");
    }
...
EC_BOOL cflv_content_direct_send_body(const UINT32 cflv_md_id, const UINT32 seg_no, const UINT8 *data, const UINT32 len)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_direct_send_body: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    {
        dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_direct_send_body: "
...
EC_BOOL cflv_content_direct_send_response(const UINT32 cflv_md_id)
{
        ...
        if(BIT_FALSE == CFLV_MD_CNGX_PRELOAD_SWITCH_ON_FLAG(cflv_md))
        {
            if(EC_FALSE == cflv_content_direct_header_out_filter(cflv_md_id))
            {
                dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_direct_send_response: "
                                                     "header_out filter failed\n");
                cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0082);
                return (EC_FALSE);
            }
    ...
    if(EC_FALSE == cflv_filter_rsp_range(cflv_md_id))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_direct_send_response: "
                                             "chttp rsp header_in range filter failed\n");
        cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_RANGE_NOT_SATISFIABLE, LOC_CFLV_0083);
        return (EC_FALSE);
    }
    dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_direct_send_response: "
                                         "chttp rsp header_in range filter done\n");
...
EC_BOOL cflv_content_repair_header_in_filter_upstream(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_repair_header_in_filter_upstream: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    if(EC_FALSE == cngx_upstream_get_name(r, &upstream_name_str, &upstream_name_len))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_repair_header_in_filter_upstream: "
                                             "get upstream name failed\n");
        return (EC_FALSE);
    }
    ...
    if(EC_FALSE == chttp_req_set_ipaddr_word(chttp_req, upstream_peer_ipaddr))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_repair_header_in_filter_upstream: "
                                             ...
                                             c_word_to_ipv4(upstream_peer_ipaddr),
                                             upstream_name_len, upstream_name_str);
        cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0084);
        return (EC_FALSE);
    }
    ...
    if(EC_FALSE == chttp_req_set_port_word(chttp_req, upstream_peer_port))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_repair_header_in_filter_upstream: "
                                             ...
                                             upstream_peer_port,
                                             upstream_name_len, upstream_name_str);
        cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0085);
        return (EC_FALSE);
    }
...
EC_BOOL cflv_content_repair_header_in_filter_server(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_repair_header_in_filter_server: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    for(tag_idx = 0; tag_idx < sizeof(tags)/sizeof(tags[ 0 ]); tag_idx ++)
    {
        ...
        if(NULL_PTR != v)
        {
            ...
            if(EC_FALSE == chttp_req_set_ipaddr(chttp_req, segs[ 0 ]))
            {
                ...
                cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_GATEWAY_TIME_OUT, LOC_CFLV_0087);
                return (EC_FALSE);
            }
            dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_repair_header_in_filter_server: "
                                                 "[cngx] set host '%s' to http req done\n",
...
EC_BOOL cflv_content_repair_header_in_filter_host(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_repair_header_in_filter_host: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    if(NULL_PTR != v)
    {
        ...
        if(EC_FALSE == chttp_req_set_ipaddr(chttp_req, v))
        {
            ...
            cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_GATEWAY_TIME_OUT, LOC_CFLV_0090);
            return (EC_FALSE);
        }
        ...
        if(EC_FALSE == chttp_req_renew_header(chttp_req, (const char *)"Host", v))
        {
            ...
            cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0092);
            return (EC_FALSE);
        }
...
EC_BOOL cflv_content_repair_header_in_filter_port(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_repair_header_in_filter_port: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    if(NULL_PTR != v)
    {
        ...
        if(EC_FALSE == chttp_req_set_port(chttp_req, v))
        {
            dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_repair_header_in_filter_port: "
                                                 "[conf] set port '%s' to http req failed\n",
                                                 v);
            safe_free(v, LOC_CFLV_0094);
            return (EC_FALSE);
        }
        dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_repair_header_in_filter_port: "
                                             "[conf] set port '%s' to http req done\n",
                                             v);
        safe_free(v, LOC_CFLV_0095);
        return (EC_TRUE);
    }
        ...
        if(NULL_PTR != v)
        {
            ...
            if(2 == c_str_split(v, ":", segs, 2))
            {
                ...
                dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_repair_header_in_filter_port: "
                                                     "[cngx] set port '%s' to http req done\n",
                                                     segs[ 1 ]);
                safe_free(v, LOC_CFLV_0097);

                return (EC_TRUE);
            }

            safe_free(v, LOC_CFLV_0098);
...
EC_BOOL cflv_content_repair_header_in_filter_ipaddr(const UINT32 cflv_md_id)
{
    ...
    if(NULL_PTR != v)
    {
        ...
        if(EC_FALSE == chttp_req_set_ipaddr(chttp_req, v))
        {
            ...
            cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_GATEWAY_TIME_OUT, LOC_CFLV_0102);
            return (EC_FALSE);
        }
...
EC_BOOL cflv_content_repair_header_in_filter(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_repair_header_in_filter: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    do
    {
        ...
        /*set host*/
        if(EC_FALSE == cflv_content_repair_header_in_filter_host(cflv_md_id))
        {
            dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_repair_header_in_filter: "
                                                 "filter host failed\n");
            return (EC_FALSE);
        ...
        {
            /*upstream*/
            if(EC_FALSE == cflv_content_repair_header_in_filter_upstream(cflv_md_id))
            {
                dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_repair_header_in_filter: "
                                                     "filter upstream failed\n");
                return (EC_FALSE);
        ...
        {
            /*try best!*/
            if(EC_FALSE == cflv_content_repair_header_in_filter_server(cflv_md_id))
            {
                dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_repair_header_in_filter: "
                                                     "filter server failed\n");
                return (EC_FALSE);
...
EC_BOOL cflv_content_repair_header_out_length_filter(const UINT32 cflv_md_id)
{
    CFLV_MD                     *cflv_md;
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_repair_header_out_length_filter: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    if(BIT_FALSE == CFLV_MD_CONTENT_LENGTH_EXIST_FLAG(cflv_md))
    {
        ...
        if(NULL_PTR == content_length_str)
        {
            dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_repair_header_out_length_filter: "
                                                 "no 'Content-Length'\n");
            return (EC_FALSE);
        }
        ...
        dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_repair_header_out_length_filter: "
                                             "parse Content-Length '%s' to %ld\n",
                                             content_length_str,
                                             content_length);
    }
...
EC_BOOL cflv_content_repair_header_out_range_filter(const UINT32 cflv_md_id)
{
    CFLV_MD                     *cflv_md;
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_repair_header_out_range_filter: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    while(BIT_FALSE == CFLV_MD_CONTENT_LENGTH_EXIST_FLAG(cflv_md))
    {
        ...
        if(NULL_PTR != content_range_str)
        {
            ...
            if(EC_FALSE == crange_parse_content_range(content_range_str, &range_start, &range_end, &content_length))
            {
                dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_repair_header_out_range_filter: "
                                                     "invalid Content-Range '%s'\n",
                                                     content_range_str);
                return (EC_FALSE);
            }
    ...
    if(EC_FALSE == cflv_content_repair_header_out_length_filter(cflv_md_id))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_repair_header_out_range_filter: "
                                             "filter length failed\n");
        return(EC_FALSE);
    ...
    if(BIT_FALSE == CFLV_MD_CNGX_RANGE_EXIST_FLAG(cflv_md))
    {
        ...
        k = (const char *)"Content-Range";
        chttp_rsp_del_header(CFLV_MD_CHTTP_RSP(cflv_md),k);
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "[DEBUG] cflv_content_repair_header_out_range_filter: "
                                             "del rsp header %s done\n",
                                             k);
...
EC_BOOL cflv_content_repair_header_out_rsp_status_filter(const UINT32 cflv_md_id)
{
    CFLV_MD                     *cflv_md;
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_repair_header_out_rsp_status_filter: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    if(NULL_PTR != v)
    {
        ...
        if(CHTTP_NOT_FOUND == response_status)
        {
            cflv_set_ngx_rc(cflv_md_id, CHTTP_NOT_FOUND, LOC_CFLV_0116);
...
EC_BOOL cflv_content_repair_header_out_connection_filter(const UINT32 cflv_md_id)
{
    CFLV_MD                     *cflv_md;
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_repair_header_out_connection_filter: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    if(CHTTP_NOT_FOUND == status)
    {
        ...
        dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_repair_header_out_connection_filter: "
                                             "404 => del %s\n",
                                             k);
        return (EC_TRUE);
    }
...
EC_BOOL cflv_content_repair_header_out_filter(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_repair_header_out_filter: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    {
        /*Content-Length and Content-Range*/
        if(EC_FALSE == cflv_content_repair_header_out_range_filter(cflv_md_id))
        {
            dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_repair_header_out_filter: "
                                                 "range filter failed\n");
            return (EC_FALSE);
        }

        dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_repair_header_out_filter: "
                                             "range filter done\n");
    }

    if(EC_FALSE == cflv_content_repair_header_out_rsp_status_filter(cflv_md_id))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_repair_header_out_filter: "
                                             "status filter failed\n");
        return (EC_FALSE);
    ...
    /*Connection*/
    if(EC_FALSE == cflv_content_repair_header_out_connection_filter(cflv_md_id))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_repair_header_out_filter: "
                                             "connection filter failed\n");
        return (EC_FALSE);
    ...
    dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_repair_header_out_filter: done\n");
...
EC_BOOL cflv_content_repair_body_out_filter(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_repair_body_out_filter: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
...
EC_BOOL cflv_content_repair_send_request(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_repair_send_request: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    if(NULL_PTR == CFLV_MD_CHTTP_REQ(cflv_md))
    {
        ...
        if(NULL_PTR == chttp_req)
        {
            dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_repair_send_request: "
                                                 "new chttp_req failed\n");
            cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0117);
            return (EC_FALSE);
        }
        CFLV_MD_CHTTP_REQ(cflv_md) = chttp_req;
    }
    ...
    if(EC_FALSE == cflv_content_repair_header_in_filter(cflv_md_id))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_repair_send_request: "
                                             "header_in filter failed\n");
        cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0120);
        return (EC_FALSE);
    }

    if(do_log(SEC_0146_CFLV, 9))
    {
        sys_log(LOGSTDOUT, "[DEBUG] cflv_content_repair_send_request: http req:\n");
        chttp_req_print_plain(LOGSTDOUT, chttp_req);
    }
    if(EC_FALSE == chttp_request(chttp_req, NULL_PTR, chttp_rsp, NULL_PTR))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_repair_send_request: "
                                             "http request failed\n");
        cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_BAD_GATEWAY, LOC_CFLV_0121);
        return (EC_FALSE);
    }
    if(do_log(SEC_0146_CFLV, 9))
    {
        sys_log(LOGSTDOUT, "[DEBUG] cflv_content_repair_send_request: http rsp:\n");
        chttp_rsp_print_plain(LOGSTDOUT, chttp_rsp);
    }
...
EC_BOOL cflv_content_repair_send_seg_n(const UINT32 cflv_md_id, const CRANGE_SEG *crange_seg)
{
    CFLV_MD                     *cflv_md;
    ngx_http_request_t          *r;
    CHTTP_RSP                   *chttp_rsp;
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_repair_send_seg_n: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    if(CFLV_MD_ABSENT_SEG_NO(cflv_md) == CRANGE_SEG_NO(crange_seg))
    {
        ...
        dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_repair_send_seg_n: "
                                             "send body seg %ld: %u bytes done\n",
                                             CRANGE_SEG_NO(crange_seg), len);
    ...
    && CFLV_MD_CACHE_SEG_MAX_NUM(cflv_md) < CFLV_MD_ABSENT_SEG_NO(cflv_md))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_repair_send_seg_n: seg no %ld overflow!\n",
                                             CFLV_MD_ABSENT_SEG_NO(cflv_md));
        return (EC_FALSE);
    }
    ...
    /*recursively*/
    return cflv_content_repair_procedure(cflv_md_id);
}

EC_BOOL cflv_content_repair_send_node(const UINT32 cflv_md_id, CRANGE_NODE *crange_node)
{
    CFLV_MD                     *cflv_md;
    ngx_http_request_t          *r;
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_repair_send_node: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    if(EC_FALSE == cstring_is_empty(CRANGE_NODE_BOUNDARY(crange_node)))
    {
        ...
        dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_repair_send_node: "
                                             "send body boundary: %ld bytes done\n",
                                             CSTRING_LEN(boundary));
    ...
    while(NULL_PTR != (crange_seg = crange_node_first_seg(crange_node)))
    {        UINT32      seg_no;
        ...
        if(EC_FALSE == cflv_content_repair_send_seg_n(cflv_md_id, crange_seg))
        {
            dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_repair_send_node: "
                                                 "send direct seg %ld failed\n",
                                                 seg_no);
...
EC_BOOL cflv_content_repair_send_response(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_repair_send_response: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    if(EC_TRUE == cngx_need_send_header(r))
    {
        if(BIT_FALSE == CFLV_MD_CNGX_PRELOAD_SWITCH_ON_FLAG(cflv_md))
        {
            if(EC_FALSE == cflv_content_repair_header_out_filter(cflv_md_id))
            {
                dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_repair_send_response: "
                                                     "header_out filter failed\n");
                cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0122);
                return (EC_FALSE);
            }
    ...
    if(EC_FALSE == cflv_filter_rsp_range(cflv_md_id))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_repair_send_response: "
                                             "chttp rsp header_in range filter failed\n");
        cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_RANGE_NOT_SATISFIABLE, LOC_CFLV_0123);
        return (EC_FALSE);
    }
    dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_repair_send_response: "
                                         "chttp rsp header_in range filter done\n");
    ...
    if(BIT_TRUE == CFLV_MD_ORIG_NO_CACHE_FLAG(cflv_md))
    {
        ...
        while(NULL_PTR != (crange_node = crange_mgr_first_node(crange_mgr)))
        {
            if(EC_FALSE == cflv_content_repair_send_node(cflv_md_id, crange_node))
            {
                dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_repair_send_response: "
                                                     "send node (%ld:%s, %ld:%s) failed\n",
                                                     CRANGE_NODE_RANGE_START(crange_node), c_bool_str(CRANGE_NODE_SUFFIX_START(crange_node)),
...
EC_BOOL cflv_content_repair_procedure(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_repair_procedure: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    if(EC_FALSE == cflv_content_repair_send_request(cflv_md_id))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_repair_procedure: "
                                             "send request failed\n");
        return (EC_FALSE);
    }
    ...
    if(EC_FALSE == cflv_content_repair_send_response(cflv_md_id))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_repair_procedure: "
                                             "send response failed\n");
        return (EC_FALSE);
...
EC_BOOL cflv_content_orig_header_in_filter_upstream(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_orig_header_in_filter_upstream: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    if(EC_FALSE == cngx_upstream_get_name(r, &upstream_name_str, &upstream_name_len))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_orig_header_in_filter_upstream: "
                                             "get upstream name failed\n");
        return (EC_FALSE);
    }
    ...
    if(EC_FALSE == chttp_req_set_ipaddr_word(chttp_req, upstream_peer_ipaddr))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_orig_header_in_filter_upstream: "
                                             ...
                                             c_word_to_ipv4(upstream_peer_ipaddr),
                                             upstream_name_len, upstream_name_str);
        cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0124);
        return (EC_FALSE);
    }
    ...
    if(EC_FALSE == chttp_req_set_port_word(chttp_req, upstream_peer_port))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_orig_header_in_filter_upstream: "
                                             ...
                                             upstream_peer_port,
                                             upstream_name_len, upstream_name_str);
        cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0125);
        return (EC_FALSE);
    }
...
EC_BOOL cflv_content_orig_header_in_filter_server(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_orig_header_in_filter_server: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    for(tag_idx = 0; tag_idx < sizeof(tags)/sizeof(tags[ 0 ]); tag_idx ++)
    {
        ...
        if(NULL_PTR != v)
        {
            ...
            if(EC_FALSE == chttp_req_set_ipaddr(chttp_req, segs[ 0 ]))
            {
                ...
                cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_GATEWAY_TIME_OUT, LOC_CFLV_0127);
                return (EC_FALSE);
            }
            dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_orig_header_in_filter_server: "
                                                 "[cngx] set host '%s' to http req done\n",
...
EC_BOOL cflv_content_orig_header_in_filter_host(const UINT32 cflv_md_id)
{
    ...
    if(NULL_PTR != v)
    {
        ...
        if(EC_FALSE == chttp_req_set_ipaddr(chttp_req, v))
        {
            ...
            cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_GATEWAY_TIME_OUT, LOC_CFLV_0130);
            return (EC_FALSE);
        }
...
EC_BOOL cflv_content_orig_header_in_filter_ipaddr(const UINT32 cflv_md_id)
{
    ...
    if(NULL_PTR != v)
    {
        ...
        if(EC_FALSE == chttp_req_set_ipaddr(chttp_req, v))
        {
            ...
            cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_GATEWAY_TIME_OUT, LOC_CFLV_0144);
            return (EC_FALSE);
        }
...
EC_BOOL cflv_content_orig_header_in_filter(const UINT32 cflv_md_id)
{
    ...
    do
    {
        ...
        if(NULL_PTR != v)
        {
            ...
            if(EC_FALSE == chttp_req_set_server(chttp_req, v))
            {
                ...
                cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_GATEWAY_TIME_OUT, LOC_CFLV_0147);
        ...
        {
            /*upstream*/
            if(EC_FALSE == cflv_content_orig_header_in_filter_upstream(cflv_md_id))
            {
                dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_orig_header_in_filter: "
                                                     "filter upstream failed\n");
                return (EC_FALSE);
        ...
        {
            /*try best!*/
            if(EC_FALSE == cflv_content_orig_header_in_filter_server(cflv_md_id))
            {
                dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_orig_header_in_filter: "
                                                     "filter server failed\n");
                return (EC_FALSE);
    ...
    if(EC_FALSE == chttp_req_set_method(chttp_req, v))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_orig_header_in_filter: "
                                             "set method '%s' failed\n",
                                             v);
        safe_free(v, LOC_CFLV_0149);
        return (EC_FALSE);
    }
    safe_free(v, LOC_CFLV_0150);
...
EC_BOOL cflv_content_orig_header_out_if_none_match_filter(const UINT32 cflv_md_id)
{
    ...
    if(NULL_PTR == v)
    {
        dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_orig_header_out_if_none_match_filter: "
                                             "[rsp] no '%s'\n",
                                             k);
        safe_free(etag_des, LOC_CFLV_0162);
        return (EC_TRUE);
    }
    etag_src = v;
...
EC_BOOL cflv_content_orig_header_out_rsp_status_filter(const UINT32 cflv_md_id)
{
    ...
    if(NULL_PTR != v)
    {
        ...
        if(CHTTP_NOT_FOUND == response_status)
        {
            cflv_set_ngx_rc(cflv_md_id, CHTTP_NOT_FOUND, LOC_CFLV_0163);
...
EC_BOOL cflv_content_orig_send_request(const UINT32 cflv_md_id)
{
    ...
    if(NULL_PTR == CFLV_MD_CHTTP_RSP(cflv_md))
    {
        ...
        if(NULL_PTR == chttp_rsp)
        {
            dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_orig_send_request: "
                                                 "new chttp_rsp failed\n");
            cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0165);
            return (EC_FALSE);
        }
        CFLV_MD_CHTTP_RSP(cflv_md) = chttp_rsp;
    }
    ...
    if(NULL_PTR == CFLV_MD_CHTTP_STORE(cflv_md))
    {
        ...
        if(NULL_PTR == chttp_store)
        {
            dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_orig_send_request: "
                                                 "new chttp_store failed\n");
            cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0166);
            return (EC_FALSE);
        }
        CFLV_MD_CHTTP_STORE(cflv_md) = chttp_store;
    }
    ...
    if(EC_FALSE == cflv_content_orig_set_store(cflv_md_id))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_orig_send_request: "
                                             "set chttp_store failed\n");
        cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0167);
        return (EC_FALSE);
    }
    ...
    if(NULL_PTR == CFLV_MD_CHTTP_STAT(cflv_md))
    {
        ...
        if(NULL_PTR == chttp_stat)
        {
            ...
            cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0168);
            return (EC_FALSE);
        }
    ...
    if(EC_FALSE == cngx_export_header_in(r, chttp_req))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_orig_send_request: "
                                             "export headers_in to http req failed\n");
        cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0169);
        return (EC_FALSE);
    }
    ...
    if(EC_FALSE == cflv_content_orig_header_in_filter(cflv_md_id))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_orig_send_request: "
                                             "header_in filter failed\n");
        cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0170);
        return (EC_FALSE);
    }
    ...
    if(EC_FALSE == chttp_request(chttp_req, chttp_store, chttp_rsp, chttp_stat))
    {
        ...
        {
            cflv_set_ngx_rc(cflv_md_id, CHTTP_STAT_RSP_STATUS(chttp_stat), LOC_CFLV_0171);
        }
        else
        {
            cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_BAD_GATEWAY, LOC_CFLV_0172);
        }
        return (EC_FALSE);
    }
    if(do_log(SEC_0146_CFLV, 9))
...
EC_BOOL cflv_content_orig_send_seg_n(const UINT32 cflv_md_id, const CRANGE_SEG *crange_seg)
{
    ...
    if(EC_FALSE == cflv_get_cache_seg_n(cflv_md_id, crange_seg, &seg_cbytes))
    {
        ...
        cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_NOT_FOUND, LOC_CFLV_0173);
        return (EC_FALSE);
    }
...
EC_BOOL cflv_content_ms_header_in_filter_upstream(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_ms_header_in_filter_upstream: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    if(EC_FALSE == cngx_upstream_get_name(r, &upstream_name_str, &upstream_name_len))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_ms_header_in_filter_upstream: "
                                             "get upstream name failed\n");
        return (EC_FALSE);
    }
    ...
    if(EC_FALSE == chttp_req_set_ipaddr_word(chttp_req, upstream_peer_ipaddr))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_ms_header_in_filter_upstream: "
                                             ...
                                             c_word_to_ipv4(upstream_peer_ipaddr),
                                             upstream_name_len, upstream_name_str);
        cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0174);
        return (EC_FALSE);
    }
    ...
    if(EC_FALSE == chttp_req_set_port_word(chttp_req, upstream_peer_port))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_ms_header_in_filter_upstream: "
                                             ...
                                             upstream_peer_port,
                                             upstream_name_len, upstream_name_str);
        cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0175);
        return (EC_FALSE);
    }
...
EC_BOOL cflv_content_ms_header_in_filter_server(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_ms_header_in_filter_server: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    for(tag_idx = 0; tag_idx < sizeof(tags)/sizeof(tags[ 0 ]); tag_idx ++)
    {
        ...
        if(NULL_PTR != v)
        {
            ...
            if(EC_FALSE == chttp_req_set_ipaddr(chttp_req, segs[ 0 ]))
            {
                ...
                cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_GATEWAY_TIME_OUT, LOC_CFLV_0177);
                return (EC_FALSE);
            }
            dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_ms_header_in_filter_server: "
                                                 "[cngx] set host '%s' to http req done\n",
...
EC_BOOL cflv_content_ms_header_in_filter_host(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_ms_header_in_filter_host: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    if(NULL_PTR != v)
    {
        ...
        if(EC_FALSE == chttp_req_set_ipaddr(chttp_req, v))
        {
            ...
            cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_GATEWAY_TIME_OUT, LOC_CFLV_0180);
            return (EC_FALSE);
        }
...
EC_BOOL cflv_content_ms_header_in_filter_port(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_ms_header_in_filter_port: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
...
EC_BOOL cflv_content_ms_header_in_filter_ipaddr(const UINT32 cflv_md_id)
{
    ...
    if(NULL_PTR != v)
    {
        ...
        if(EC_FALSE == chttp_req_set_ipaddr(chttp_req, v))
        {
            ...
            cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_GATEWAY_TIME_OUT, LOC_CFLV_0194);
            return (EC_FALSE);
        }
...
EC_BOOL cflv_content_ms_header_in_filter(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_ms_header_in_filter: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    do
    {
        ...
        if(NULL_PTR != v)
        {
            ...
            if(EC_FALSE == chttp_req_set_server(chttp_req, v))
            {
                ...
                cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_GATEWAY_TIME_OUT, LOC_CFLV_0197);
        ...
        /*set host*/
        if(EC_FALSE == cflv_content_ms_header_in_filter_host(cflv_md_id))
        {
            dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_ms_header_in_filter: "
                                                 "filter host failed\n");
            return (EC_FALSE);
        ...
        {
            /*upstream*/
            if(EC_FALSE == cflv_content_ms_header_in_filter_upstream(cflv_md_id))
            {
                dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_ms_header_in_filter: "
                                                     "filter upstream failed\n");
                return (EC_FALSE);
        ...
        {
            /*try best!*/
            if(EC_FALSE == cflv_content_ms_header_in_filter_server(cflv_md_id))
            {
                dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_ms_header_in_filter: "
                                                     "filter server failed\n");
                return (EC_FALSE);
    ...
    do
    {
        ...
        if(EC_FALSE == chttp_req_set_uri(chttp_req, v))
        {
            dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_ms_header_in_filter: "
                                                 "[cngx] set uri '%s' failed\n",
                                                 v);
            safe_free(v, LOC_CFLV_0204);
            return (EC_FALSE);
        }
        dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_ms_header_in_filter: "
                                             "[cngx] set uri '%s' to http req done\n",
                                             v);
        safe_free(v, LOC_CFLV_0205);
        ...
        if(EC_TRUE == cngx_get_req_arg(r, &v) && NULL_PTR != v)
        {
            ...
            if(EC_FALSE == chttp_req_set_uri(chttp_req, v))
            {
                dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_ms_header_in_filter: "
                                                     ...
                                                     v);
                safe_free(v, LOC_CFLV_0207);
                return (EC_FALSE);
            }
            dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_ms_header_in_filter: "
                                                 "[cngx] set args '%s' to http req done\n",
                                                 v);
            safe_free(v, LOC_CFLV_0208);
        }
    }while(0);
...
EC_BOOL cflv_content_ms_header_out_if_modified_since_filter(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_ms_header_out_if_modified_since_filter: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    if(EC_FALSE == cngx_get_header_in(r, k, &v))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_ms_header_out_if_modified_since_filter: "
                                             "[cngx] get '%s' failed\n",
                                             k);
        return (EC_FALSE);
    }
    ...
    if(NULL_PTR == v)
    {
        dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_ms_header_out_if_modified_since_filter: "
                                             "[cngx] no '%s'\n",
                                             k);
        return (EC_TRUE);
    }
...
EC_BOOL cflv_content_ms_header_out_if_none_match_filter(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_ms_header_out_if_none_match_filter: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    if(EC_FALSE == cngx_get_header_in(r, k, &v))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_ms_header_out_if_none_match_filter: "
                                             "[cngx] get '%s' failed\n",
                                             k);
        return (EC_FALSE);
    }
    ...
    if(NULL_PTR == v)
    {
        dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_ms_header_out_if_none_match_filter: "
                                             "[rsp] no '%s'\n",
                                             k);
        safe_free(etag_des, LOC_CFLV_0210);
        return (EC_TRUE);
    }
    etag_src = v;
...
EC_BOOL cflv_content_ms_header_out_range_filter(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_ms_header_out_range_filter: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    while(BIT_FALSE == CFLV_MD_CONTENT_LENGTH_EXIST_FLAG(cflv_md))
    {
        ...
        if(NULL_PTR == content_range_str)
        {
            dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "warn:cflv_content_ms_header_out_range_filter: "
                                                 "no 'Content-Range' => failed\n");
            /*maybe chunk*/
            return (EC_FALSE)/*cflv_content_chunk_header_out_filter(cflv_md_id)*/;
        }
        ...
        if(EC_FALSE == crange_parse_content_range(content_range_str, &range_start, &range_end, &content_length))
        {
            dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_ms_header_out_range_filter: "
                                                 "invalid Content-Range '%s'\n",
                                                 content_range_str);
            return (EC_FALSE);
        }
    ...
    if(BIT_TRUE == CFLV_MD_CNGX_RANGE_MULTIPLE_FLAG(cflv_md)
    && 1 == crange_mgr_node_num(CFLV_MD_CNGX_RANGE_MGR(cflv_md)))
    {
        UINT32                       content_length;

        content_length = CFLV_MD_CONTENT_LENGTH(cflv_md);

        if(EC_TRUE == crange_mgr_is_range(CFLV_MD_CNGX_RANGE_MGR(cflv_md), 0, content_length - 1))
        {
            const char                  *k;
            const char                  *v;
...
EC_BOOL cflv_content_ms_header_out_rsp_status_filter(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_ms_header_out_rsp_status_filter: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    if(NULL_PTR != v)
    {
        ...
        if(CHTTP_NOT_FOUND == response_status)
        {
            cflv_set_ngx_rc(cflv_md_id, CHTTP_NOT_FOUND, LOC_CFLV_0211);
...
EC_BOOL cflv_content_ms_header_out_cache_control_filter(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_ms_header_out_cache_control_filter: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    if(BIT_FALSE == CFLV_MD_ORIG_NO_CACHE_FLAG(cflv_md))
    {
        ...
        if(EC_TRUE == chttp_rsp_has_header(CFLV_MD_CHTTP_RSP(cflv_md), k, v))
        {
            dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_ms_header_out_cache_control_filter: "
                                                 "found '%s':'%s' => set orig_no_cache_flag = true\n",
                                                 k, v);
            CFLV_MD_ORIG_NO_CACHE_FLAG(cflv_md) = BIT_TRUE;
            return (EC_TRUE);
...
EC_BOOL cflv_content_ms_header_out_connection_filter(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_ms_header_out_connection_filter: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    k = (const char *)"Connection";
    chttp_rsp_del_header(CFLV_MD_CHTTP_RSP(cflv_md), k);
    dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_ms_header_out_connection_filter: "
                                         "del rsp header '%s' done\n",
                                         k);
...
EC_BOOL cflv_content_ms_header_out_filter(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_ms_header_out_filter: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    /*Connection*/
    if(EC_FALSE == cflv_content_ms_header_out_connection_filter(cflv_md_id))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_ms_header_out_filter: "
                                             "connection filter failed\n");
        return (EC_FALSE);
    }

    dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_ms_header_out_filter: "
                                         "connection filter done\n");

    /*Content-Length and Content-Range*/
    if(EC_FALSE == cflv_content_ms_header_out_range_filter(cflv_md_id))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_ms_header_out_filter: "
                                             "range filter failed\n");
        return (EC_FALSE);
    ...
    if(BIT_FALSE == CFLV_MD_ORIG_NO_CACHE_FLAG(cflv_md))
    {
        if(EC_FALSE == cflv_content_ms_header_out_rsp_status_filter(cflv_md_id))
        {
            dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_ms_header_out_filter: "
                                                 "status filter failed\n");
            return (EC_FALSE);
    ...
    if(EC_FALSE == cflv_content_ms_header_out_if_modified_since_filter(cflv_md_id))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_ms_header_out_filter: "
                                             "if-modified-since filter failed\n");
        return (EC_FALSE);
    ...
    if(EC_FALSE == cflv_content_ms_header_out_if_none_match_filter(cflv_md_id))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_ms_header_out_filter: "
                                             "if-none-match filter failed\n");
        return (EC_FALSE);
    ...
    dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_ms_header_out_filter: done\n");
    return (EC_TRUE);
}
...
EC_BOOL cflv_content_ms_body_out_filter(const UINT32 cflv_md_id, const UINT32 seg_no, uint8_t **data, uint32_t *len)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_ms_body_out_filter: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
...
EC_BOOL cflv_content_ms_set_store(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_ms_set_store: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    ASSERT(0 == CFLV_MD_ABSENT_SEG_NO(cflv_md));
    ...
    if(EC_FALSE == cngx_set_store(r, chttp_store))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_ms_set_store: "
                                             "fetch ngx cfg to chttp_store failed\n");
        return (EC_FALSE);
    }
...
EC_BOOL cflv_content_ms_send_request(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_ms_send_request: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    if(NULL_PTR == CFLV_MD_CHTTP_REQ(cflv_md))
    {
        ...
        if(NULL_PTR == chttp_req)
        {
            dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_ms_send_request: "
                                                 "new chttp_req failed\n");
            cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0212);
            return (EC_FALSE);
        }
        CFLV_MD_CHTTP_REQ(cflv_md) = chttp_req;
    }
    ...
    if(NULL_PTR == CFLV_MD_CHTTP_RSP(cflv_md))
    {
        ...
        if(NULL_PTR == chttp_rsp)
        {
            dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_ms_send_request: "
                                                 "new chttp_rsp failed\n");
            cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0213);
            return (EC_FALSE);
        }
        CFLV_MD_CHTTP_RSP(cflv_md) = chttp_rsp;
    }
    ...
    if(NULL_PTR == CFLV_MD_CHTTP_STORE(cflv_md))
    {
        ...
        if(NULL_PTR == chttp_store)
        {
            dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_ms_send_request: "
                                                 "new chttp_store failed\n");
            cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0214);
            return (EC_FALSE);
        }
        CFLV_MD_CHTTP_STORE(cflv_md) = chttp_store;
    }
    ...
    if(EC_FALSE == cflv_content_ms_set_store(cflv_md_id))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_ms_send_request: "
                                             "set chttp_store failed\n");
        cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0215);
        return (EC_FALSE);
    }

    if(do_log(SEC_0146_CFLV, 9))
    {
        dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_ms_send_request: "
                                             "chttp_store is\n");
        chttp_store_print(LOGSTDOUT, chttp_store);
    }
    ...
    if(EC_FALSE == cflv_content_ms_header_in_filter(cflv_md_id))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_ms_send_request: "
                                             "header_in filter failed\n");
    ...
    if(do_log(SEC_0146_CFLV, 9))
    {
        sys_log(LOGSTDOUT, "[DEBUG] cflv_content_ms_send_request: http req:\n");
        chttp_req_print_plain(LOGSTDOUT, chttp_req);
    }
    ...
    if(EC_FALSE == chttp_request(chttp_req, chttp_store, chttp_rsp, chttp_stat))
    {
        ...
        if(0 < CHTTP_STAT_RSP_STATUS(chttp_stat))
        {
            cflv_set_ngx_rc(cflv_md_id, CHTTP_STAT_RSP_STATUS(chttp_stat), LOC_CFLV_0219);
        }
        else
        {
            cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_BAD_GATEWAY, LOC_CFLV_0220);
        }
    ...
    if(do_log(SEC_0146_CFLV, 9))
    {
        sys_log(LOGSTDOUT, "[DEBUG] cflv_content_ms_send_request: http rsp:\n");
        chttp_rsp_print_plain(LOGSTDOUT, chttp_rsp);
    }
...
EC_BOOL cflv_content_ms_send_seg_n(const UINT32 cflv_md_id, const CRANGE_SEG *crange_seg)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_ms_send_seg_n: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    if(EC_FALSE == cflv_get_cache_seg_n(cflv_md_id, crange_seg, &seg_cbytes))
    {
        ...
        cbytes_clean(&seg_cbytes);
        cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_NOT_FOUND, LOC_CFLV_0221);
        return (EC_FALSE);
    }
    ...
    dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_ms_send_seg_n: "
                                         "send seg %ld [%ld, %ld], %ld bytes\n",
                                         CRANGE_SEG_NO(crange_seg),
                                         CRANGE_SEG_S_OFFSET(crange_seg),
                                         CRANGE_SEG_E_OFFSET(crange_seg),
...
EC_BOOL cflv_content_ms_import_header(const UINT32 cflv_md_id, const CHTTP_NODE *chttp_node)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_ms_import_header: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
...
EC_BOOL cflv_content_ms_send_header(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_ms_send_header: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
   ...
   dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_ms_send_header: "
    ...
    dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_ms_send_header: done\n");
    return (EC_TRUE);
}
...
EC_BOOL cflv_content_ms_send_body(const UINT32 cflv_md_id, const UINT32 seg_no, const UINT8 *data, const UINT32 len)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_ms_send_body: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    if(EC_TRUE == cngx_need_header_only(r))
    {
        dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_ms_send_body: "
                                             "need header only => give up body sending\n");
        return (EC_TRUE);
    }
    ...
    if(seg_no != CFLV_MD_ABSENT_SEG_NO(cflv_md))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "warn:cflv_content_ms_send_body: "
                                             "seg_no %ld != absent_seg_no %ld => return\n",
                                             seg_no, CFLV_MD_ABSENT_SEG_NO(cflv_md));
        return (EC_TRUE);
    }
...
EC_BOOL cflv_content_ms_send_response(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_ms_send_response: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    /*chunk*/
    if(EC_TRUE  == chttp_rsp_is_chunked(CFLV_MD_CHTTP_RSP(cflv_md)))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_ms_send_response: "
                                             "not support chunk procedure\n");

        return (EC_FALSE)/*cflv_content_chunk_send_response(cflv_md_id)*/;
    }
    ...
    if(EC_TRUE == cngx_need_send_header(r))
    {
        ...
        dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_ms_send_response: "
                                             "chttp rsp header range filter done\n");
    }
    ...
    if(0 == CFLV_MD_ABSENT_SEG_NO(cflv_md) && EC_TRUE == cngx_need_send_header(r))
    {
        dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_ms_send_response: "
                                             "crange_mgr size = %ld\n",
                                             crange_mgr_node_num(crange_mgr));
    ...
    dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_ms_send_response: done\n");
    return (EC_TRUE);
}
...
EC_BOOL cflv_content_ms_procedure(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_ms_procedure: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    if(EC_FALSE == cflv_content_ms_send_request(cflv_md_id))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_ms_procedure: "
                                             "send request failed\n");
        return (EC_FALSE);
    }
    ...
    if(EC_FALSE == cflv_content_ms_send_response(cflv_md_id))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_ms_procedure: "
                                             "send response failed\n");
        return (EC_FALSE);
...
EC_BOOL cflv_content_preload_parse_header(const UINT32 cflv_md_id, const CBYTES *header_cbytes)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_preload_parse_header: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    if(NULL_PTR != CFLV_MD_CHTTP_RSP(cflv_md))
    {
        dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_preload_parse_header: "
    ...
    if(NULL_PTR == CFLV_MD_CHTTP_RSP(cflv_md))
    {
        ...
        cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0222);
        return (EC_FALSE);
    }

    if(EC_FALSE == ccache_parse_http_header(header_cbytes, CFLV_MD_CHTTP_RSP(cflv_md)))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_preload_parse_header: "
                                             "parse header failed\n");

        cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0223);
        return (EC_FALSE);
    }
...
EC_BOOL cflv_content_preload_header_out_range_filter(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_preload_header_out_range_filter: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    while(BIT_FALSE == CFLV_MD_CONTENT_LENGTH_EXIST_FLAG(cflv_md))
    {
        ...
        if(NULL_PTR == v)
        {
            dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_preload_header_out_range_filter: "
                                                 "no 'Content-Range' => failed\n");
            return (EC_FALSE);
        }
...
EC_BOOL cflv_content_preload_header_out_rsp_status_filter(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_preload_header_out_rsp_status_filter: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    if(NULL_PTR != v)
    {
        ...
        if(CHTTP_NOT_FOUND == response_status)
        {
            cflv_set_ngx_rc(cflv_md_id, CHTTP_NOT_FOUND, LOC_CFLV_0224);
...
EC_BOOL cflv_content_preload_header_out_filter(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_preload_header_out_filter: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    k = (const char *)"cache";
    cflv_filter_header_out_common(cflv_md_id, k);
    dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_preload_header_out_filter: "
                                         "common filter done\n");

    /*flv filter Content-Range*/
    if(EC_FALSE == cflv_content_preload_header_out_range_filter(cflv_md_id))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_preload_header_out_filter: "
                                             "range filter failed\n");
        return (EC_FALSE);
    }
    dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_preload_header_out_filter: "
    ...
    if(EC_FALSE == cflv_content_preload_header_out_rsp_status_filter(cflv_md_id))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_preload_header_out_filter: "
                                             "status filter failed\n");
        return (EC_FALSE);
    ...
    dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_preload_header_out_filter: done\n");
...
EC_BOOL cflv_content_preload_send_response(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_preload_send_response: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    if(EC_TRUE == cngx_need_send_header(r))
    {
        if(EC_FALSE == cflv_content_preload_header_out_filter(cflv_md_id))
        {
            dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_preload_send_response: "
                                                 "header_out filter failed\n");
            cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0225);
            return (EC_FALSE);
        }

        if(do_log(SEC_0146_CFLV, 9))
        {
            dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_preload_send_response: "
                                                 "send header:\n");
            chttp_rsp_print_plain(LOGSTDOUT, CFLV_MD_CHTTP_RSP(cflv_md));
        }
    ...
    dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_preload_send_response: done\n");
...
EC_BOOL cflv_content_preload_procedure(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_preload_procedure: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    do
    {
        ...
        if(BIT_TRUE == CFLV_MD_ORIG_FORCE_FLAG(cflv_md))
        {
            ...
            && CFLV_MD_CACHE_SEG_MAX_NUM(cflv_md) < CFLV_MD_ABSENT_SEG_NO(cflv_md))
            {
                dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_preload_procedure: seg no %ld overflow!\n",
                                                     CFLV_MD_ABSENT_SEG_NO(cflv_md));
                return (EC_FALSE);
            }
        ...
        if(EC_FALSE == cflv_get_cache_seg(cflv_md_id, seg_no, &seg_cbytes))
        {
            ...
            {
                cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_SERVICE_UNAVAILABLE, LOC_CFLV_0226);
            ...
            if(BIT_FALSE == CFLV_MD_CNGX_PRELOAD_SWITCH_ON_FLAG(cflv_md))
            {
                if(EC_FALSE == cflv_content_ms_procedure(cflv_md_id))
                {
                    dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_preload_procedure: "
        ...
        /*parse header*/
        if(EC_FALSE == cflv_content_preload_parse_header(cflv_md_id, &seg_cbytes))
        {
            dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_preload_procedure: "
                                                 "parse seg %ld failed\n",
                                                 seg_no);
        ...
        if(EC_TRUE == crange_mgr_is_empty(CFLV_MD_CNGX_RANGE_MGR(cflv_md)))
        {
            if(EC_FALSE == cflv_get_rsp_length_segs(cflv_md_id, CFLV_MD_CACHE_SEG_SIZE(cflv_md)))
            {
                ...
                cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_BAD_REQUEST, LOC_CFLV_0227);
                return (EC_FALSE);
            }
            dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_preload_procedure: "
                                                 "get range segs from chttp rsp done\n");
        ...
        if(EC_FALSE == cflv_filter_rsp_range(cflv_md_id))
        {
            dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_preload_procedure: "
                                                 "chttp rsp header_in range filter failed\n");
            cflv_set_ngx_rc(cflv_md_id, CHTTP_REQUESTEDR_RANGE_NOT_SATISFIABLE, LOC_CFLV_0228);
            return (EC_FALSE);
        }
        dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_preload_procedure: "
                                             "chttp rsp header_in range filter done\n");
    ...
    if(EC_FALSE == cflv_content_preload_send_response(cflv_md_id))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_preload_procedure: "
                                             "send response failed\n");
...
EC_BOOL cflv_content_redirect_procedure(const UINT32 cflv_md_id)
{
    ...
    )
    {
        ...
        if(EC_FALSE == c_parse_location(loc, &host, &port, &uri))
        {
            if(NULL_PTR != host)
            {
                safe_free(host, LOC_CFLV_0229);
            }
            if(NULL_PTR != port)
            {
                safe_free(port, LOC_CFLV_0230);
            }
            if(NULL_PTR != uri)
            {
                safe_free(uri, LOC_CFLV_0231);
            }
            break;
        }
...
EC_BOOL cflv_content_ims_header_in_filter_upstream(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_ims_header_in_filter_upstream: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    if(EC_FALSE == cngx_upstream_get_name(r, &upstream_name_str, &upstream_name_len))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_ims_header_in_filter_upstream: "
                                             "get upstream name failed\n");
        return (EC_FALSE);
    }
    ...
    if(EC_FALSE == chttp_req_set_port_word(chttp_req, upstream_peer_port))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_ims_header_in_filter_upstream: "
                                             ...
                                             upstream_peer_port,
                                             upstream_name_len, upstream_name_str);
        cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0237);
        return (EC_FALSE);
    }
...
EC_BOOL cflv_content_ims_header_in_filter_server(const UINT32 cflv_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cflv_content_ims_header_in_filter_server: cflv module #0x%lx not started.\n",
                cflv_md_id);
        dbg_exit(MD_CFLV, cflv_md_id);
    }
#endif/*CFLV_DEBUG_SWITCH*/
    ...
    for(tag_idx = 0; tag_idx < sizeof(tags)/sizeof(tags[ 0 ]); tag_idx ++)
    {
        ...
        if(NULL_PTR != v)
        {
            ...
            if(EC_FALSE == chttp_req_set_ipaddr(chttp_req, segs[ 0 ]))
            {
                ...
                cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_GATEWAY_TIME_OUT, LOC_CFLV_0239);
                return (EC_FALSE);
            }
            dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_ims_header_in_filter_server: "
                                                 "[cngx] set host '%s' to http req done\n",
...
EC_BOOL cflv_content_ims_header_in_filter_host(const UINT32 cflv_md_id)
{
    ...
    if(NULL_PTR != v)
    {
        ...
        if(EC_FALSE == chttp_req_set_ipaddr(chttp_req, v))
        {
            ...
            cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_GATEWAY_TIME_OUT, LOC_CFLV_0242);
            return (EC_FALSE);
        }
        ...
        if(EC_FALSE == chttp_req_renew_header(chttp_req, (const char *)"Host", v))
        {
            ...
            cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0244);
            return (EC_FALSE);
        }
...
EC_BOOL cflv_content_ims_header_in_filter_ipaddr(const UINT32 cflv_md_id)
{
    ...
    if(NULL_PTR != v)
    {
        ...
        if(EC_FALSE == chttp_req_set_ipaddr(chttp_req, v))
        {
            ...
            cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_GATEWAY_TIME_OUT, LOC_CFLV_0254);
            return (EC_FALSE);
        }
    ...
    do
    {
        ...
        if(NULL_PTR != v)
        {
            ...
            if(EC_FALSE == chttp_req_set_server(CFLV_MD_CHTTP_REQ(cflv_md), v))
            {
                ...
                cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_GATEWAY_TIME_OUT, LOC_CFLV_0257);
        ...
        {
            /*upstream*/
            if(EC_FALSE == cflv_content_ims_header_in_filter_upstream(cflv_md_id))
            {
                dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_ims_header_in_filter: "
                                                     "filter upstream failed\n");
                return (EC_FALSE);
        ...
        {
            /*try best!*/
            if(EC_FALSE == cflv_content_ims_header_in_filter_server(cflv_md_id))
            {
                dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_ims_header_in_filter: "
                                                     "filter server failed\n");
                return (EC_FALSE);
    ...
    do
    {
        ...
        if(NULL_PTR != v)
        {
            ...
            if(EC_FALSE == chttp_req_set_uri(CFLV_MD_CHTTP_REQ(cflv_md), v))
            {
                dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_ims_header_in_filter: "
                                                     "[conf] set uri '%s' to http req failed\n",
                                                     v);
                safe_free(v, LOC_CFLV_0261);
                return (EC_FALSE);
            }
            dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_ims_header_in_filter: "
                                                 "[conf] set uri '%s' to http req done\n",
                                                 v);
            safe_free(v, LOC_CFLV_0262);
        ...
        if(EC_FALSE == chttp_req_set_uri(CFLV_MD_CHTTP_REQ(cflv_md), v))
        {
            dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_ims_header_in_filter: "
                                                 "[cngx] set uri '%s' failed\n",
                                                 v);
            safe_free(v, LOC_CFLV_0263);
            return (EC_FALSE);
        }
        dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_ims_header_in_filter: "
                                             "[cngx] set uri '%s' to http req done\n",
                                             v);
        safe_free(v, LOC_CFLV_0264);
        ...
        if(EC_TRUE == cngx_get_req_arg(r, &v) && NULL_PTR != v)
        {
            ...
            if(0 == arg_left_num)
            {
                dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_ims_header_in_filter: "
                                                     "[cngx] append nothing to uri\n");
                safe_free(v, LOC_CFLV_0265);
                break;
            }

            args = c_str_join((const char *)"&", (const char **)arg_fields, arg_left_num);
            safe_free(v, LOC_CFLV_0266);
            ...
            if(EC_FALSE == chttp_req_set_uri(CFLV_MD_CHTTP_REQ(cflv_md), v))
            {
                dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_ims_header_in_filter: "
                                                     "[cngx] set args '%s' failed\n",
                                                     v);
                safe_free(v, LOC_CFLV_0268);
                return (EC_FALSE);
            }
            dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_ims_header_in_filter: "
                                                 "[cngx] set args '%s' to http req done\n",
                                                 v);
            safe_free(v, LOC_CFLV_0269);
        }
    }while(0);
...
EC_BOOL cflv_content_ims_send_request(const UINT32 cflv_md_id)
{
    ...
    if(NULL_PTR == CFLV_MD_CHTTP_RSP(cflv_md))
    {
        ...
        if(NULL_PTR == chttp_rsp)
        {
            dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_ims_send_request: "
                                                 "new chttp_rsp failed\n");
            cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0271);
            return (EC_FALSE);
        }
        CFLV_MD_CHTTP_RSP(cflv_md) = chttp_rsp;
    }
    ...
    if(EC_FALSE == cngx_export_header_in(r, chttp_req))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_ims_send_request: "
                                             "export headers_in to http req failed\n");
        cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0272);
        return (EC_FALSE);
    }
    ...
    if(EC_FALSE == cflv_content_ims_header_in_filter(cflv_md_id))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_ims_send_request: "
                                             "header_in filter failed\n");
        cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0273);
        return (EC_FALSE);
    }
    ...
    if(EC_FALSE == chttp_request(chttp_req, NULL_PTR, chttp_rsp, NULL_PTR))
    {
        dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_ims_send_request: "
                                             "http request failed\n");
        cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_BAD_GATEWAY, LOC_CFLV_0274);
        return (EC_FALSE);
    }
...
EC_BOOL cflv_content_expired_send_seg_n(const UINT32 cflv_md_id, const CRANGE_SEG *crange_seg)
{
    ...
    if(EC_FALSE == cflv_get_cache_seg_n(cflv_md_id, crange_seg, &seg_cbytes))
    {
        ...
        if(BIT_TRUE == CNGX_OPTION_ONLY_IF_CACHED(CFLV_MD_CNGX_OPTION(cflv_md)))
        {
            cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_SERVICE_UNAVAILABLE, LOC_CFLV_0275);
        ...
        if(BIT_FALSE == CFLV_MD_CNGX_PRELOAD_SWITCH_ON_FLAG(cflv_md))
        {
            ...
            if(EC_FALSE == cflv_content_expired_header_out_filter(cflv_md_id))
            {
                dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_expired_send_response: "
                                                     "header_out filter failed\n");
                cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0276);
                return (EC_FALSE);
            }
...
EC_BOOL cflv_content_expired_procedure(const UINT32 cflv_md_id)
{
    ...
    if(EC_FALSE == cflv_content_handler(cflv_md_id_t))
    {
        ...
        cflv_set_ngx_rc(cflv_md_id, rc, LOC_CFLV_0277);
    ...
    cflv_get_ngx_rc(cflv_md_id_t, &rc, NULL_PTR);
    cflv_set_ngx_rc(cflv_md_id, rc, LOC_CFLV_0278);
...
EC_BOOL cflv_content_cache_parse_header(const UINT32 cflv_md_id, const CBYTES *header_cbytes)
{
    ...
    if(NULL_PTR == CFLV_MD_CHTTP_RSP(cflv_md))
    {
        ...
        cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0279);
        return (EC_FALSE);
    }
    ...
    if(EC_FALSE == ccache_parse_http_header(header_cbytes, CFLV_MD_CHTTP_RSP(cflv_md)))
    {
        ...
        cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0280);
        return (EC_FALSE);
    }
...
EC_BOOL cflv_content_cache_header_out_if_none_match_filter(const UINT32 cflv_md_id)
{
    ...
    if(NULL_PTR == v)
    {
        dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_cache_header_out_if_none_match_filter: "
                                             "[rsp] no '%s'\n",
                                             k);
        safe_free(etag_des, LOC_CFLV_0282);
        return (EC_TRUE);
    }
    etag_src = v;
...
EC_BOOL cflv_content_cache_header_out_rsp_status_filter(const UINT32 cflv_md_id)
{
    ...
    if(NULL_PTR != v)
    {
        ...
        if(CHTTP_NOT_FOUND == response_status)
        {
            cflv_set_ngx_rc(cflv_md_id, CHTTP_NOT_FOUND, LOC_CFLV_0283);
...
EC_BOOL cflv_content_cache_header_out_age_filter(const UINT32 cflv_md_id)
{
    ...
    do
    {
        ...
        if(EC_FALSE == cngx_get_header_in(r, k, &v))
        {
             dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_cache_header_out_age_filter: "
...
EC_BOOL cflv_content_cache_send_seg_n(const UINT32 cflv_md_id, const CRANGE_SEG *crange_seg)
{
    ...
    if(EC_FALSE == cflv_get_cache_seg_n(cflv_md_id, crange_seg, &seg_cbytes))
    {
        ...
        if(BIT_TRUE == CNGX_OPTION_ONLY_IF_CACHED(CFLV_MD_CNGX_OPTION(cflv_md)))
        {
            cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_SERVICE_UNAVAILABLE, LOC_CFLV_0292);
        ...
        if(BIT_FALSE == CFLV_MD_CNGX_PRELOAD_SWITCH_ON_FLAG(cflv_md))
        {
            ...
            if(EC_FALSE == cflv_content_cache_header_out_filter(cflv_md_id))
            {
                dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_cache_send_response: "
                                                     "header_out filter failed\n");
                cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_INTERNAL_SERVER_ERROR, LOC_CFLV_0293);
                return (EC_FALSE);
            }
...
EC_BOOL cflv_content_cache_procedure(const UINT32 cflv_md_id)
{
    ...
    do
    {
        ...
        if(EC_FALSE == cflv_get_cache_seg(cflv_md_id, seg_no, &seg_cbytes))
        {
            ...
            if(BIT_TRUE == CNGX_OPTION_ONLY_IF_CACHED(CFLV_MD_CNGX_OPTION(cflv_md)))
            {
                cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_SERVICE_UNAVAILABLE, LOC_CFLV_0294);
        ...
        if(EC_TRUE == crange_mgr_is_empty(CFLV_MD_CNGX_RANGE_MGR(cflv_md)))
        {
            if(EC_FALSE == cflv_get_rsp_length_segs(cflv_md_id, CFLV_MD_CACHE_SEG_SIZE(cflv_md)))
            {
                ...
                cflv_set_ngx_rc(cflv_md_id, NGX_HTTP_BAD_REQUEST, LOC_CFLV_0295);
                return (EC_FALSE);
            }
            dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_cache_procedure: "
                                                 "get range segs from chttp rsp done\n");
        ...
        if(EC_FALSE == cflv_filter_rsp_range(cflv_md_id))
        {
            dbg_log(SEC_0146_CFLV, 0)(LOGSTDOUT, "error:cflv_content_cache_procedure: "
                                                 "chttp rsp header_in range filter failed\n");
            cflv_set_ngx_rc(cflv_md_id, CHTTP_REQUESTEDR_RANGE_NOT_SATISFIABLE, LOC_CFLV_0296);
            return (EC_FALSE);
        }
        dbg_log(SEC_0146_CFLV, 9)(LOGSTDOUT, "[DEBUG] cflv_content_cache_procedure: "
                                             "chttp rsp header_in range filter done\n");
