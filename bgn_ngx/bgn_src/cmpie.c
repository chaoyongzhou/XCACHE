...
UINT32 cmpi_encode_chfsnp_item(const UINT32 comm, const CHFSNP_ITEM *chfsnp_item, UINT8 *out_buff, const UINT32 out_buff_max_len, UINT32 *position)
{
    ...
    cmpi_pack(CHFSNP_ITEM_KEY(chfsnp_item), CHFSNP_ITEM_KLEN(chfsnp_item), CMPI_UCHAR, out_buff, out_buff_max_len, position, comm);
...
UINT32 cmpi_encode_chfsnp_item_size(const UINT32 comm, const CHFSNP_ITEM *chfsnp_item, UINT32 *size)
{
    ...
    cmpi_pack_size(CHFSNP_ITEM_KLEN(chfsnp_item), CMPI_UCHAR, size,  comm);
...
UINT32 cmpi_decode_chfsnp_item(const UINT32 comm, const UINT8 *in_buff, const UINT32 in_buff_max_len, UINT32 *position, CHFSNP_ITEM *chfsnp_item)
{
    ...
    cmpi_decode_time_t(comm, in_buff, in_buff_max_len, position, &(CHFSNP_ITEM_C_TIME(chfsnp_item)));

    cmpi_decode_uint32_t(comm, in_buff, in_buff_max_len, position, &(CHFSNP_ITEM_BUCKET_POS(chfsnp_item)));
    cmpi_decode_uint32_t(comm, in_buff, in_buff_max_len, position, &(stat));
    cmpi_decode_uint32_t(comm, in_buff, in_buff_max_len, position, &(klen));

    CHFSNP_ITEM_STAT(chfsnp_item)  = (stat);
    CHFSNP_ITEM_KLEN(chfsnp_item)  = (klen);

    cmpi_unpack(in_buff, in_buff_max_len, position, CHFSNP_ITEM_KEY(chfsnp_item), CHFSNP_ITEM_KLEN(chfsnp_item), CMPI_UCHAR, comm);
...
UINT32 cmpi_encode_crfsconhash_rnode(const UINT32 comm, const CRFSCONHASH_RNODE *crfsconhash_rnode, UINT8 *out_buff, const UINT32 out_buff_max_len, UINT32 *position)
{
    ...
    cmpi_encode_uint16(comm, CRFSCONHASH_RNODE_STATUS(crfsconhash_rnode), out_buff, out_buff_max_len, position);
...
UINT32 cmpi_encode_crfsconhash_rnode_size(const UINT32 comm, const CRFSCONHASH_RNODE *crfsconhash_rnode, UINT32 *size)
{
    ...
    cmpi_encode_uint16_size(comm, CRFSCONHASH_RNODE_STATUS(crfsconhash_rnode), size);
...
UINT32 cmpi_decode_crfsconhash_rnode(const UINT32 comm, const UINT8 *in_buff, const UINT32 in_buff_max_len, UINT32 *position, CRFSCONHASH_RNODE *crfsconhash_rnode)
{
    ...
    cmpi_decode_uint16(comm, in_buff, in_buff_max_len, position, &(CRFSCONHASH_RNODE_STATUS(crfsconhash_rnode)));
...
{ 
   CRFSCONHASH_VNODE *crfsconhash_vnode;
    ...
    if(NULL_PTR != CRB_NODE_LEFT(node))
    {
        ...
        {
            dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT, "error:__crfsconhash_flush_vnodes_inorder: encode left subtree %p failed\n", CRB_NODE_LEFT(node));
            return ((UINT32)-1);
        }
    }
...
{ 
   CRFSCONHASH_VNODE *crfsconhash_vnode;
    ...
    if(NULL_PTR != CRB_NODE_LEFT(node))
    {
        ...
        {
            dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT, "error:__cmpi_encode_crfsconhash_vnode_tree_size_inorder: encode left subtree %p failed\n", CRB_NODE_LEFT(node));
            return ((UINT32)-1);
        }
    }
...
UINT32 cmpi_decode_crfsconhash_vnode_tree(const UINT32 comm, const UINT8 *in_buff, const UINT32 in_buff_max_len, UINT32 *position, CRB_TREE *vnode_tree)
{
    ...
    for(pos = 0; pos < num; pos ++)
    {
        ...
        {
            dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT, "error:cmpi_decode_crfsconhash_vnode_tree: insert vnode %u# at failed\n", pos);
            crfsconhash_vnode_free(crfsconhash_vnode);
            return ((UINT32)-1);
        }
    }
...
UINT32 cmpi_encode_chttp_stat(const UINT32 comm, const CHTTP_STAT *chttp_stat, UINT8 *out_buff, const UINT32 out_buff_max_len, UINT32 *position)
{
    ...
    cmpi_encode_uint32_t(comm, CHTTP_STAT_BASIC_S_NSEC(chttp_stat), out_buff, out_buff_max_len, position);
    cmpi_encode_uint32_t(comm, CHTTP_STAT_BASIC_S_MSEC(chttp_stat), out_buff, out_buff_max_len, position);

    cmpi_encode_uint32_t(comm, CHTTP_STAT_BASIC_R_NSEC(chttp_stat), out_buff, out_buff_max_len, position);
    cmpi_encode_uint32_t(comm, CHTTP_STAT_BASIC_R_MSEC(chttp_stat), out_buff, out_buff_max_len, position);

    cmpi_encode_uint32_t(comm, CHTTP_STAT_BASIC_L_NSEC(chttp_stat), out_buff, out_buff_max_len, position);
    cmpi_encode_uint32_t(comm, CHTTP_STAT_BASIC_L_MSEC(chttp_stat), out_buff, out_buff_max_len, position);

    cmpi_encode_uint32_t(comm, CHTTP_STAT_BASIC_H_NSEC(chttp_stat), out_buff, out_buff_max_len, position);
    cmpi_encode_uint32_t(comm, CHTTP_STAT_BASIC_H_MSEC(chttp_stat), out_buff, out_buff_max_len, position);

    cmpi_encode_uint32_t(comm, CHTTP_STAT_BASIC_D_NSEC(chttp_stat), out_buff, out_buff_max_len, position);
    cmpi_encode_uint32_t(comm, CHTTP_STAT_BASIC_D_MSEC(chttp_stat), out_buff, out_buff_max_len, position);
...
UINT32 cmpi_encode_chttp_stat_size(const UINT32 comm, const CHTTP_STAT *chttp_stat, UINT32 *size)
{
    ...
    cmpi_encode_uint32_t_size(comm, CHTTP_STAT_BASIC_S_NSEC(chttp_stat), size);
    cmpi_encode_uint32_t_size(comm, CHTTP_STAT_BASIC_S_MSEC(chttp_stat), size);

    cmpi_encode_uint32_t_size(comm, CHTTP_STAT_BASIC_R_NSEC(chttp_stat), size);
    cmpi_encode_uint32_t_size(comm, CHTTP_STAT_BASIC_R_MSEC(chttp_stat), size);
    ...
    cmpi_encode_uint32_t_size(comm, CHTTP_STAT_BASIC_D_NSEC(chttp_stat), size);
    cmpi_encode_uint32_t_size(comm, CHTTP_STAT_BASIC_D_MSEC(chttp_stat), size);

    cmpi_encode_uint32_t_size(comm, CHTTP_STAT_BASIC_E_NSEC(chttp_stat), size);
    cmpi_encode_uint32_t_size(comm, CHTTP_STAT_BASIC_E_MSEC(chttp_stat), size);
...
UINT32 cmpi_decode_chttp_stat(const UINT32 comm, const UINT8 *in_buff, const UINT32 in_buff_max_len, UINT32 *position, CHTTP_STAT *chttp_stat)
{
    ...
    cmpi_decode_uint32_t(comm, in_buff, in_buff_max_len, position, &CHTTP_STAT_BASIC_S_NSEC(chttp_stat));
    cmpi_decode_uint32_t(comm, in_buff, in_buff_max_len, position, &CHTTP_STAT_BASIC_S_MSEC(chttp_stat));

    cmpi_decode_uint32_t(comm, in_buff, in_buff_max_len, position, &CHTTP_STAT_BASIC_R_NSEC(chttp_stat));
    cmpi_decode_uint32_t(comm, in_buff, in_buff_max_len, position, &CHTTP_STAT_BASIC_R_MSEC(chttp_stat));

    cmpi_decode_uint32_t(comm, in_buff, in_buff_max_len, position, &CHTTP_STAT_BASIC_L_NSEC(chttp_stat));
    cmpi_decode_uint32_t(comm, in_buff, in_buff_max_len, position, &CHTTP_STAT_BASIC_L_MSEC(chttp_stat));

    cmpi_decode_uint32_t(comm, in_buff, in_buff_max_len, position, &CHTTP_STAT_BASIC_H_NSEC(chttp_stat));
    cmpi_decode_uint32_t(comm, in_buff, in_buff_max_len, position, &CHTTP_STAT_BASIC_H_MSEC(chttp_stat));

    cmpi_decode_uint32_t(comm, in_buff, in_buff_max_len, position, &CHTTP_STAT_BASIC_D_NSEC(chttp_stat));
    cmpi_decode_uint32_t(comm, in_buff, in_buff_max_len, position, &CHTTP_STAT_BASIC_D_MSEC(chttp_stat));

    cmpi_decode_uint32_t(comm, in_buff, in_buff_max_len, position, &CHTTP_STAT_BASIC_E_NSEC(chttp_stat));
    cmpi_decode_uint32_t(comm, in_buff, in_buff_max_len, position, &CHTTP_STAT_BASIC_E_MSEC(chttp_stat));
...
UINT32 cmpi_encode_chttp_store(const UINT32 comm, const CHTTP_STORE *chttp_store, UINT8 *out_buff, const UINT32 out_buff_max_len, UINT32 *position)
{
    ...
    cmpi_encode_uint32(comm, CHTTP_STORE_CACHE_CTRL(chttp_store), out_buff, out_buff_max_len, position);
    cmpi_encode_uint32(comm, CHTTP_STORE_MERGE_FLAG(chttp_store), out_buff, out_buff_max_len, position);
    cmpi_encode_uint32(comm, CHTTP_STORE_LOCKED_FLAG(chttp_store), out_buff, out_buff_max_len, position);
    cmpi_encode_uint32(comm, CHTTP_STORE_EXPIRED_FLAG(chttp_store), out_buff, out_buff_max_len, position);
    cmpi_encode_uint32(comm, CHTTP_STORE_CHUNK_FLAG(chttp_store), out_buff, out_buff_max_len, position);
...
UINT32 cmpi_encode_chttp_store_size(const UINT32 comm, const CHTTP_STORE *chttp_store, UINT32 *size)
{
    ...
    cmpi_encode_uint32_size(comm, CHTTP_STORE_CACHE_CTRL(chttp_store), size);
    cmpi_encode_uint32_size(comm, CHTTP_STORE_MERGE_FLAG(chttp_store), size);
    cmpi_encode_uint32_size(comm, CHTTP_STORE_LOCKED_FLAG(chttp_store), size);
    cmpi_encode_uint32_size(comm, CHTTP_STORE_EXPIRED_FLAG(chttp_store), size);
    cmpi_encode_uint32_size(comm, CHTTP_STORE_CHUNK_FLAG(chttp_store), size);
...
UINT32 cmpi_decode_chttp_store(const UINT32 comm, const UINT8 *in_buff, const UINT32 in_buff_max_len, UINT32 *position, CHTTP_STORE *chttp_store)
{
    ...
    cmpi_decode_uint32(comm, in_buff, in_buff_max_len, position, &CHTTP_STORE_CACHE_CTRL(chttp_store));
    cmpi_decode_uint32(comm, in_buff, in_buff_max_len, position, &CHTTP_STORE_MERGE_FLAG(chttp_store));
    cmpi_decode_uint32(comm, in_buff, in_buff_max_len, position, &CHTTP_STORE_LOCKED_FLAG(chttp_store));
    cmpi_decode_uint32(comm, in_buff, in_buff_max_len, position, &CHTTP_STORE_EXPIRED_FLAG(chttp_store));
    cmpi_decode_uint32(comm, in_buff, in_buff_max_len, position, &CHTTP_STORE_CHUNK_FLAG(chttp_store));
...
UINT32 cmpi_encode_crfs_node(const UINT32 comm, const CRFS_NODE *crfs_node, UINT8 *out_buff, const UINT32 out_buff_max_len, UINT32 *position)
{
    ...
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_encode_crfs_node: crfs_node is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == out_buff )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_encode_crfs_node: out_buff is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == position )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_encode_crfs_node: position is null.\n");
        dbg_exit(MD_TBD, 0);
    }
#endif /* ENCODE_DEBUG_SWITCH */

    cmpi_encode_uint32(comm, CRFS_NODE_TCID(crfs_node), out_buff, out_buff_max_len, position);
    cmpi_encode_uint32(comm, CRFS_NODE_IPADDR(crfs_node), out_buff, out_buff_max_len, position);
...
{
    cmpi_encode_uint32_size(comm, CRFS_NODE_TCID(crfs_node), size);
    cmpi_encode_uint32_size(comm, CRFS_NODE_IPADDR(crfs_node), size);
...
UINT32 cmpi_decode_crfs_node(const UINT32 comm, const UINT8 *in_buff, const UINT32 in_buff_max_len, UINT32 *position, CRFS_NODE *crfs_node)
{
    ...
    if ( NULL_PTR == in_buff )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_decode_crfs_node: in_buff is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == position )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_decode_crfs_node: position is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == crfs_node )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_decode_crfs_node: crfs_node is null.\n");
        dbg_exit(MD_TBD, 0);
    }
#endif /* ENCODE_DEBUG_SWITCH */

    cmpi_decode_uint32(comm, in_buff, in_buff_max_len, position, &CRFS_NODE_TCID(crfs_node));
    cmpi_decode_uint32(comm, in_buff, in_buff_max_len, position, &CRFS_NODE_IPADDR(crfs_node));
    cmpi_decode_uint32(comm, in_buff, in_buff_max_len, position, &CRFS_NODE_PORT(crfs_node));
    cmpi_decode_uint32(comm, in_buff, in_buff_max_len, position, &CRFS_NODE_MODI(crfs_node));
    cmpi_decode_uint32(comm, in_buff, in_buff_max_len, position, &CRFS_NODE_STATE(crfs_node));
...
UINT32 cmpi_encode_chfsconhash_rnode(const UINT32 comm, const CHFSCONHASH_RNODE *chfsconhash_rnode, UINT8 *out_buff, const UINT32 out_buff_max_len, UINT32 *position)
{
    ...
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_encode_chfsconhash_rnode: chfsconhash_rnode is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == out_buff )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_encode_chfsconhash_rnode: out_buff is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == position )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_encode_chfsconhash_rnode: position is null.\n");
        dbg_exit(MD_TBD, 0);
    }
#endif /* ENCODE_DEBUG_SWITCH */

    cmpi_encode_uint16(comm, CHFSCONHASH_RNODE_REPLICAS(chfsconhash_rnode), out_buff, out_buff_max_len, position);
    cmpi_encode_uint16(comm, CHFSCONHASH_RNODE_STATUS(chfsconhash_rnode), out_buff, out_buff_max_len, position);
    cmpi_encode_uint32_t(comm, CHFSCONHASH_RNODE_TCID(chfsconhash_rnode), out_buff, out_buff_max_len, position);
...
{
    cmpi_encode_uint16_size(comm, CHFSCONHASH_RNODE_REPLICAS(chfsconhash_rnode), size);
    cmpi_encode_uint16_size(comm, CHFSCONHASH_RNODE_STATUS(chfsconhash_rnode), size);
    cmpi_encode_uint32_t_size(comm, CHFSCONHASH_RNODE_TCID(chfsconhash_rnode), size);
    return ((UINT32)0);
}
...
UINT32 cmpi_decode_chfsconhash_rnode(const UINT32 comm, const UINT8 *in_buff, const UINT32 in_buff_max_len, UINT32 *position, CHFSCONHASH_RNODE *chfsconhash_rnode)
{
    ...
    if ( NULL_PTR == in_buff )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_decode_chfsconhash_rnode: in_buff is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == position )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_decode_chfsconhash_rnode: position is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == chfsconhash_rnode )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_decode_chfsconhash_rnode: chfsconhash_rnode is null.\n");
        dbg_exit(MD_TBD, 0);
    }
#endif /* ENCODE_DEBUG_SWITCH */

    cmpi_decode_uint16(comm, in_buff, in_buff_max_len, position, &(CHFSCONHASH_RNODE_REPLICAS(chfsconhash_rnode)));
    cmpi_decode_uint16(comm, in_buff, in_buff_max_len, position, &(CHFSCONHASH_RNODE_STATUS(chfsconhash_rnode)));
    cmpi_decode_uint32_t(comm, in_buff, in_buff_max_len, position, &(CHFSCONHASH_RNODE_TCID(chfsconhash_rnode)));
...
UINT32 cmpi_encode_chfsconhash_vnode(const UINT32 comm, const CHFSCONHASH_VNODE *chfsconhash_vnode, UINT8 *out_buff, const UINT32 out_buff_max_len, UINT32 *position)
{
    ...
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_encode_chfsconhash_vnode: chfsconhash_vnode is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == out_buff )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_encode_chfsconhash_vnode: out_buff is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == position )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_encode_chfsconhash_vnode: position is null.\n");
        dbg_exit(MD_TBD, 0);
    }
#endif /* ENCODE_DEBUG_SWITCH */

    cmpi_encode_uint32_t(comm, CHFSCONHASH_VNODE_HASH(chfsconhash_vnode), out_buff, out_buff_max_len, position);
    cmpi_encode_uint32_t(comm, CHFSCONHASH_VNODE_POS(chfsconhash_vnode), out_buff, out_buff_max_len, position);
...
{
    cmpi_encode_uint32_t_size(comm, CHFSCONHASH_VNODE_HASH(chfsconhash_vnode), size);
    cmpi_encode_uint32_t_size(comm, CHFSCONHASH_VNODE_POS(chfsconhash_vnode), size);
    return ((UINT32)0);
}
...
UINT32 cmpi_decode_chfsconhash_vnode(const UINT32 comm, const UINT8 *in_buff, const UINT32 in_buff_max_len, UINT32 *position, CHFSCONHASH_VNODE *chfsconhash_vnode)
{
    ...
    if ( NULL_PTR == in_buff )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_decode_chfsconhash_vnode: in_buff is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == position )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_decode_chfsconhash_vnode: position is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == chfsconhash_vnode )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_decode_chfsconhash_vnode: chfsconhash_vnode is null.\n");
        dbg_exit(MD_TBD, 0);
    }
#endif /* ENCODE_DEBUG_SWITCH */
...
UINT32 cmpi_encode_chfsconhash_rnode_vec(const UINT32 comm, const CVECTOR *rnode_vec, UINT8 *out_buff, const UINT32 out_buff_max_len, UINT32 *position)
{
    ...
    if ( NULL_PTR == rnode_vec )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_encode_chfsconhash_rnode_vec: rnode_vec is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == out_buff )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_encode_chfsconhash_rnode_vec: out_buff is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == position )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_encode_chfsconhash_rnode_vec: position is null.\n");
        dbg_exit(MD_TBD, 0);
    }
#endif /* ENCODE_DEBUG_SWITCH */
    ...
    for(pos = 0; pos < num; pos ++)
    {
        ...
        chfsconhash_rnode = (CHFSCONHASH_RNODE *)cvector_get(rnode_vec, pos);
        if(NULL_PTR == chfsconhash_rnode)
        {
            uint32_t     tcid;
            uint16_t     replicas;
        ...
        cmpi_encode_chfsconhash_rnode(comm, chfsconhash_rnode, out_buff, out_buff_max_len, position);
    }
    return ((UINT32)0);
}
...
UINT32 cmpi_encode_chfsconhash_rnode_vec_size(const UINT32 comm, const CVECTOR *rnode_vec, UINT32 *size)
{
    ...
    for(pos = 0; pos < num; pos ++)
    {
        ...
        cmpi_encode_chfsconhash_rnode_size(comm, chfsconhash_rnode, size);
    }
    return ((UINT32)0);
}
...
UINT32 cmpi_decode_chfsconhash_rnode_vec(const UINT32 comm, const UINT8 *in_buff, const UINT32 in_buff_max_len, UINT32 *position, CVECTOR *rnode_vec)
{
    ...
    if ( NULL_PTR == in_buff )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_decode_chfsconhash_rnode_vec: in_buff is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == position )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_decode_chfsconhash_rnode_vec: position is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == rnode_vec )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_decode_chfsconhash_rnode_vec: rnode_vec is null.\n");
        dbg_exit(MD_TBD, 0);
    }
#endif /* ENCODE_DEBUG_SWITCH */
    ...
    for(pos = 0; pos < num; pos ++)
    {
        ...
        cvector_push(rnode_vec, chfsconhash_rnode);
    }
...
{ 
   CHFSCONHASH_VNODE *chfsconhash_vnode;
    ...
    if(NULL_PTR != CRB_NODE_LEFT(node))
    {
        ...
        {
            dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT, "error:__chfsconhash_flush_vnodes_inorder: encode left subtree %p failed\n", CRB_NODE_LEFT(node));
            return ((UINT32)-1);
        }
    }
    ...
    if(NULL_PTR != CRB_NODE_RIGHT(node))
    {
        if(0 != __cmpi_encode_chfsconhash_vnode_tree_inorder(comm, vnode_tree, CRB_NODE_RIGHT(node), out_buff, out_buff_max_len, position))
        {
...
UINT32 cmpi_encode_chfsconhash_vnode_tree(const UINT32 comm, const CRB_TREE *vnode_tree, UINT8 *out_buff, const UINT32 out_buff_max_len, UINT32 *position)
{
    ...
    if ( NULL_PTR == vnode_tree )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_encode_chfsconhash_vnode_tree: vnode_tree is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == out_buff )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_encode_chfsconhash_vnode_tree: out_buff is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == position )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_encode_chfsconhash_vnode_tree: position is null.\n");
        dbg_exit(MD_TBD, 0);
    }
#endif /* ENCODE_DEBUG_SWITCH */
    ...
    __cmpi_encode_chfsconhash_vnode_tree_inorder(comm, vnode_tree, CRB_TREE_ROOT(vnode_tree), out_buff, out_buff_max_len, position);
...
{ 
   CHFSCONHASH_VNODE *chfsconhash_vnode;
    ...
    if(NULL_PTR != CRB_NODE_LEFT(node))
    {
        ...
        {
            dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT, "error:__cmpi_encode_chfsconhash_vnode_tree_size_inorder: encode left subtree %p failed\n", CRB_NODE_LEFT(node));
            return ((UINT32)-1);
        }
    }
    ...
    if(NULL_PTR != CRB_NODE_RIGHT(node))
    {
        if(0 != __cmpi_encode_chfsconhash_vnode_tree_size_inorder(comm, vnode_tree, CRB_NODE_RIGHT(node), size))
        {
...
UINT32 cmpi_encode_chfsconhash_vnode_tree_size(const UINT32 comm, const CRB_TREE *vnode_tree, UINT32 *size)
{
    ...
    __cmpi_encode_chfsconhash_vnode_tree_size_inorder(comm, vnode_tree, CRB_TREE_ROOT(vnode_tree), size);
...
UINT32 cmpi_decode_chfsconhash_vnode_tree(const UINT32 comm, const UINT8 *in_buff, const UINT32 in_buff_max_len, UINT32 *position, CRB_TREE *vnode_tree)
{
    ...
    if ( NULL_PTR == in_buff )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_decode_chfsconhash_vnode_tree: in_buff is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == position )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_decode_chfsconhash_vnode_tree: position is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == vnode_tree )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_decode_chfsconhash_vnode_tree: vnode_tree is null.\n");
        dbg_exit(MD_TBD, 0);
    }
#endif /* ENCODE_DEBUG_SWITCH */
    ...
    for(pos = 0; pos < num; pos ++)
    {
        ...
        {
            dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT, "error:cmpi_decode_chfsconhash_vnode_tree: insert vnode %u# at failed\n", pos);
            chfsconhash_vnode_free(chfsconhash_vnode);
            return ((UINT32)-1);
        }
    }
...
UINT32 cmpi_encode_chfsconhash(const UINT32 comm, const CHFSCONHASH *chfsconhash, UINT8 *out_buff, const UINT32 out_buff_max_len, UINT32 *position)
{
    ...
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_encode_chfsconhash: chfsconhash is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == out_buff )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_encode_chfsconhash: out_buff is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == position )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_encode_chfsconhash: position is null.\n");
        dbg_exit(MD_TBD, 0);
    }
#endif /* ENCODE_DEBUG_SWITCH */

    cmpi_encode_uint32(comm, CHFSCONHASH_HASH_ID(chfsconhash), out_buff, out_buff_max_len, position);
    cmpi_encode_chfsconhash_rnode_vec(comm, CHFSCONHASH_RNODE_VEC(chfsconhash), out_buff, out_buff_max_len, position);
    cmpi_encode_chfsconhash_vnode_tree(comm, CHFSCONHASH_VNODE_TREE(chfsconhash), out_buff, out_buff_max_len, position);
    return ((UINT32)0);
}

UINT32 cmpi_encode_chfsconhash_size(const UINT32 comm, const CHFSCONHASH *chfsconhash, UINT32 *size)
{
    cmpi_encode_uint32_size(comm, CHFSCONHASH_HASH_ID(chfsconhash), size);
    cmpi_encode_chfsconhash_rnode_vec_size(comm, CHFSCONHASH_RNODE_VEC(chfsconhash), size);
    cmpi_encode_chfsconhash_vnode_tree_size(comm, CHFSCONHASH_VNODE_TREE(chfsconhash), size);
    return ((UINT32)0);
}
...
UINT32 cmpi_decode_chfsconhash(const UINT32 comm, const UINT8 *in_buff, const UINT32 in_buff_max_len, UINT32 *position, CHFSCONHASH *chfsconhash)
{
    ...
    if ( NULL_PTR == in_buff )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_decode_chfsconhash: in_buff is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == position )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_decode_chfsconhash: position is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == chfsconhash )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_decode_chfsconhash: chfsconhash is null.\n");
        dbg_exit(MD_TBD, 0);
    }
#endif /* ENCODE_DEBUG_SWITCH */

    cmpi_decode_uint32(comm, in_buff, in_buff_max_len, position, &(CHFSCONHASH_HASH_ID(chfsconhash)));
    cmpi_decode_chfsconhash_rnode_vec(comm, in_buff, in_buff_max_len, position, CHFSCONHASH_RNODE_VEC(chfsconhash));
    cmpi_decode_chfsconhash_vnode_tree(comm, in_buff, in_buff_max_len, position, CHFSCONHASH_VNODE_TREE(chfsconhash));
...
UINT32 cmpi_encode_chfs_node(const UINT32 comm, const CHFS_NODE *chfs_node, UINT8 *out_buff, const UINT32 out_buff_max_len, UINT32 *position)
{
    ...
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_encode_chfs_node: chfs_node is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == out_buff )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_encode_chfs_node: out_buff is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == position )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_encode_chfs_node: position is null.\n");
        dbg_exit(MD_TBD, 0);
    }
#endif /* ENCODE_DEBUG_SWITCH */

    cmpi_encode_uint32(comm, CHFS_NODE_TCID(chfs_node), out_buff, out_buff_max_len, position);
    cmpi_encode_uint32(comm, CHFS_NODE_IPADDR(chfs_node), out_buff, out_buff_max_len, position);
...
{
    cmpi_encode_uint32_size(comm, CHFS_NODE_TCID(chfs_node), size);
    cmpi_encode_uint32_size(comm, CHFS_NODE_IPADDR(chfs_node), size);
...
UINT32 cmpi_decode_chfs_node(const UINT32 comm, const UINT8 *in_buff, const UINT32 in_buff_max_len, UINT32 *position, CHFS_NODE *chfs_node)
{
    ...
    if ( NULL_PTR == in_buff )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_decode_chfs_node: in_buff is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == position )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_decode_chfs_node: position is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == chfs_node )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_decode_chfs_node: chfs_node is null.\n");
        dbg_exit(MD_TBD, 0);
    }
#endif /* ENCODE_DEBUG_SWITCH */

    cmpi_decode_uint32(comm, in_buff, in_buff_max_len, position, &CHFS_NODE_TCID(chfs_node));
    cmpi_decode_uint32(comm, in_buff, in_buff_max_len, position, &CHFS_NODE_IPADDR(chfs_node));
    cmpi_decode_uint32(comm, in_buff, in_buff_max_len, position, &CHFS_NODE_PORT(chfs_node));
    cmpi_decode_uint32(comm, in_buff, in_buff_max_len, position, &CHFS_NODE_MODI(chfs_node));
    cmpi_decode_uint32(comm, in_buff, in_buff_max_len, position, &CHFS_NODE_STATE(chfs_node));
...
UINT32 cmpi_encode_csfsconhash_rnode(const UINT32 comm, const CSFSCONHASH_RNODE *csfsconhash_rnode, UINT8 *out_buff, const UINT32 out_buff_max_len, UINT32 *position)
{
    ...
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_encode_csfsconhash_rnode: csfsconhash_rnode is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == out_buff )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_encode_csfsconhash_rnode: out_buff is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == position )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_encode_csfsconhash_rnode: position is null.\n");
        dbg_exit(MD_TBD, 0);
    }
#endif /* ENCODE_DEBUG_SWITCH */

    cmpi_encode_uint16(comm, CSFSCONHASH_RNODE_REPLICAS(csfsconhash_rnode), out_buff, out_buff_max_len, position);
    cmpi_encode_uint16(comm, CSFSCONHASH_RNODE_STATUS(csfsconhash_rnode), out_buff, out_buff_max_len, position);
    cmpi_encode_uint32_t(comm, CSFSCONHASH_RNODE_TCID(csfsconhash_rnode), out_buff, out_buff_max_len, position);
...
{
    cmpi_encode_uint16_size(comm, CSFSCONHASH_RNODE_REPLICAS(csfsconhash_rnode), size);
    cmpi_encode_uint16_size(comm, CSFSCONHASH_RNODE_STATUS(csfsconhash_rnode), size);
    cmpi_encode_uint32_t_size(comm, CSFSCONHASH_RNODE_TCID(csfsconhash_rnode), size);
    return ((UINT32)0);
}
...
UINT32 cmpi_decode_csfsconhash_rnode(const UINT32 comm, const UINT8 *in_buff, const UINT32 in_buff_max_len, UINT32 *position, CSFSCONHASH_RNODE *csfsconhash_rnode)
{
    ...
    if ( NULL_PTR == in_buff )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_decode_csfsconhash_rnode: in_buff is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == position )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_decode_csfsconhash_rnode: position is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == csfsconhash_rnode )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_decode_csfsconhash_rnode: csfsconhash_rnode is null.\n");
        dbg_exit(MD_TBD, 0);
    }
#endif /* ENCODE_DEBUG_SWITCH */

    cmpi_decode_uint16(comm, in_buff, in_buff_max_len, position, &(CSFSCONHASH_RNODE_REPLICAS(csfsconhash_rnode)));
    cmpi_decode_uint16(comm, in_buff, in_buff_max_len, position, &(CSFSCONHASH_RNODE_STATUS(csfsconhash_rnode)));
    cmpi_decode_uint32_t(comm, in_buff, in_buff_max_len, position, &(CSFSCONHASH_RNODE_TCID(csfsconhash_rnode)));
...
UINT32 cmpi_encode_csfsconhash_vnode(const UINT32 comm, const CSFSCONHASH_VNODE *csfsconhash_vnode, UINT8 *out_buff, const UINT32 out_buff_max_len, UINT32 *position)
{
    ...
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_encode_csfsconhash_vnode: csfsconhash_vnode is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == out_buff )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_encode_csfsconhash_vnode: out_buff is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == position )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_encode_csfsconhash_vnode: position is null.\n");
        dbg_exit(MD_TBD, 0);
    }
#endif /* ENCODE_DEBUG_SWITCH */

    cmpi_encode_uint32_t(comm, CSFSCONHASH_VNODE_HASH(csfsconhash_vnode), out_buff, out_buff_max_len, position);
    cmpi_encode_uint32_t(comm, CSFSCONHASH_VNODE_POS(csfsconhash_vnode), out_buff, out_buff_max_len, position);
...
{
    cmpi_encode_uint32_t_size(comm, CSFSCONHASH_VNODE_HASH(csfsconhash_vnode), size);
    cmpi_encode_uint32_t_size(comm, CSFSCONHASH_VNODE_POS(csfsconhash_vnode), size);
    return ((UINT32)0);
}
...
UINT32 cmpi_decode_csfsconhash_vnode(const UINT32 comm, const UINT8 *in_buff, const UINT32 in_buff_max_len, UINT32 *position, CSFSCONHASH_VNODE *csfsconhash_vnode)
{
    ...
    if ( NULL_PTR == in_buff )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_decode_csfsconhash_vnode: in_buff is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == position )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_decode_csfsconhash_vnode: position is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == csfsconhash_vnode )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_decode_csfsconhash_vnode: csfsconhash_vnode is null.\n");
        dbg_exit(MD_TBD, 0);
    }
#endif /* ENCODE_DEBUG_SWITCH */
...
UINT32 cmpi_encode_csfsconhash_rnode_vec(const UINT32 comm, const CVECTOR *rnode_vec, UINT8 *out_buff, const UINT32 out_buff_max_len, UINT32 *position)
{
    ...
    if ( NULL_PTR == rnode_vec )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_encode_csfsconhash_rnode_vec: rnode_vec is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == out_buff )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_encode_csfsconhash_rnode_vec: out_buff is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == position )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_encode_csfsconhash_rnode_vec: position is null.\n");
        dbg_exit(MD_TBD, 0);
    }
#endif /* ENCODE_DEBUG_SWITCH */
    ...
    for(pos = 0; pos < num; pos ++)
    {
        ...
        csfsconhash_rnode = (CSFSCONHASH_RNODE *)cvector_get(rnode_vec, pos);
        if(NULL_PTR == csfsconhash_rnode)
        {
            uint32_t     tcid;
            uint16_t     replicas;
        ...
        cmpi_encode_csfsconhash_rnode(comm, csfsconhash_rnode, out_buff, out_buff_max_len, position);
    }
    return ((UINT32)0);
}
...
UINT32 cmpi_encode_csfsconhash_rnode_vec_size(const UINT32 comm, const CVECTOR *rnode_vec, UINT32 *size)
{
    ...
    for(pos = 0; pos < num; pos ++)
    {
        ...
        cmpi_encode_csfsconhash_rnode_size(comm, csfsconhash_rnode, size);
    }
    return ((UINT32)0);
}
...
UINT32 cmpi_decode_csfsconhash_rnode_vec(const UINT32 comm, const UINT8 *in_buff, const UINT32 in_buff_max_len, UINT32 *position, CVECTOR *rnode_vec)
{
    ...
    if ( NULL_PTR == in_buff )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_decode_csfsconhash_rnode_vec: in_buff is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == position )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_decode_csfsconhash_rnode_vec: position is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == rnode_vec )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_decode_csfsconhash_rnode_vec: rnode_vec is null.\n");
        dbg_exit(MD_TBD, 0);
    }
#endif /* ENCODE_DEBUG_SWITCH */
    ...
    for(pos = 0; pos < num; pos ++)
    {
        ...
        cvector_push(rnode_vec, csfsconhash_rnode);
    }
...
{ 
   CSFSCONHASH_VNODE *csfsconhash_vnode;
    ...
    if(NULL_PTR != CRB_NODE_LEFT(node))
    {
        ...
        {
            dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT, "error:__csfsconhash_flush_vnodes_inorder: encode left subtree %p failed\n", CRB_NODE_LEFT(node));
            return ((UINT32)-1);
        }
    }
    ...
    if(NULL_PTR != CRB_NODE_RIGHT(node))
    {
        if(0 != __cmpi_encode_csfsconhash_vnode_tree_inorder(comm, vnode_tree, CRB_NODE_RIGHT(node), out_buff, out_buff_max_len, position))
        {
...
UINT32 cmpi_encode_csfsconhash_vnode_tree(const UINT32 comm, const CRB_TREE *vnode_tree, UINT8 *out_buff, const UINT32 out_buff_max_len, UINT32 *position)
{
    ...
    if ( NULL_PTR == vnode_tree )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_encode_csfsconhash_vnode_tree: vnode_tree is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == out_buff )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_encode_csfsconhash_vnode_tree: out_buff is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == position )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_encode_csfsconhash_vnode_tree: position is null.\n");
        dbg_exit(MD_TBD, 0);
    }
#endif /* ENCODE_DEBUG_SWITCH */
    ...
    __cmpi_encode_csfsconhash_vnode_tree_inorder(comm, vnode_tree, CRB_TREE_ROOT(vnode_tree), out_buff, out_buff_max_len, position);
...
{ 
   CSFSCONHASH_VNODE *csfsconhash_vnode;
    ...
    if(NULL_PTR != CRB_NODE_LEFT(node))
    {
        ...
        {
            dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT, "error:__cmpi_encode_csfsconhash_vnode_tree_size_inorder: encode left subtree %p failed\n", CRB_NODE_LEFT(node));
            return ((UINT32)-1);
        }
    }
    ...
    if(NULL_PTR != CRB_NODE_RIGHT(node))
    {
        if(0 != __cmpi_encode_csfsconhash_vnode_tree_size_inorder(comm, vnode_tree, CRB_NODE_RIGHT(node), size))
        {
...
UINT32 cmpi_encode_csfsconhash_vnode_tree_size(const UINT32 comm, const CRB_TREE *vnode_tree, UINT32 *size)
{
    ...
    __cmpi_encode_csfsconhash_vnode_tree_size_inorder(comm, vnode_tree, CRB_TREE_ROOT(vnode_tree), size);
...
UINT32 cmpi_decode_csfsconhash_vnode_tree(const UINT32 comm, const UINT8 *in_buff, const UINT32 in_buff_max_len, UINT32 *position, CRB_TREE *vnode_tree)
{
    ...
    if ( NULL_PTR == in_buff )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_decode_csfsconhash_vnode_tree: in_buff is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == position )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_decode_csfsconhash_vnode_tree: position is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == vnode_tree )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_decode_csfsconhash_vnode_tree: vnode_tree is null.\n");
        dbg_exit(MD_TBD, 0);
    }
#endif /* ENCODE_DEBUG_SWITCH */
    ...
    for(pos = 0; pos < num; pos ++)
    {
        ...
        {
            dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT, "error:cmpi_decode_csfsconhash_vnode_tree: insert vnode %u# at failed\n", pos);
            csfsconhash_vnode_free(csfsconhash_vnode);
            return ((UINT32)-1);
        }
    }
...
UINT32 cmpi_encode_csfsconhash(const UINT32 comm, const CSFSCONHASH *csfsconhash, UINT8 *out_buff, const UINT32 out_buff_max_len, UINT32 *position)
{
    ...
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_encode_csfsconhash: csfsconhash is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == out_buff )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_encode_csfsconhash: out_buff is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == position )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_encode_csfsconhash: position is null.\n");
        dbg_exit(MD_TBD, 0);
    }
#endif /* ENCODE_DEBUG_SWITCH */

    cmpi_encode_uint32(comm, CSFSCONHASH_HASH_ID(csfsconhash), out_buff, out_buff_max_len, position);
    cmpi_encode_csfsconhash_rnode_vec(comm, CSFSCONHASH_RNODE_VEC(csfsconhash), out_buff, out_buff_max_len, position);
    cmpi_encode_csfsconhash_vnode_tree(comm, CSFSCONHASH_VNODE_TREE(csfsconhash), out_buff, out_buff_max_len, position);
    return ((UINT32)0);
}

UINT32 cmpi_encode_csfsconhash_size(const UINT32 comm, const CSFSCONHASH *csfsconhash, UINT32 *size)
{
    cmpi_encode_uint32_size(comm, CSFSCONHASH_HASH_ID(csfsconhash), size);
    cmpi_encode_csfsconhash_rnode_vec_size(comm, CSFSCONHASH_RNODE_VEC(csfsconhash), size);
    cmpi_encode_csfsconhash_vnode_tree_size(comm, CSFSCONHASH_VNODE_TREE(csfsconhash), size);
    return ((UINT32)0);
}
...
UINT32 cmpi_decode_csfsconhash(const UINT32 comm, const UINT8 *in_buff, const UINT32 in_buff_max_len, UINT32 *position, CSFSCONHASH *csfsconhash)
{
    ...
    if ( NULL_PTR == in_buff )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_decode_csfsconhash: in_buff is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == position )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_decode_csfsconhash: position is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == csfsconhash )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_decode_csfsconhash: csfsconhash is null.\n");
        dbg_exit(MD_TBD, 0);
    }
#endif /* ENCODE_DEBUG_SWITCH */

    cmpi_decode_uint32(comm, in_buff, in_buff_max_len, position, &(CSFSCONHASH_HASH_ID(csfsconhash)));
    cmpi_decode_csfsconhash_rnode_vec(comm, in_buff, in_buff_max_len, position, CSFSCONHASH_RNODE_VEC(csfsconhash));
    cmpi_decode_csfsconhash_vnode_tree(comm, in_buff, in_buff_max_len, position, CSFSCONHASH_VNODE_TREE(csfsconhash));
...
UINT32 cmpi_encode_csfs_node(const UINT32 comm, const CSFS_NODE *csfs_node, UINT8 *out_buff, const UINT32 out_buff_max_len, UINT32 *position)
{
    ...
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_encode_csfs_node: csfs_node is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == out_buff )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_encode_csfs_node: out_buff is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == position )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_encode_csfs_node: position is null.\n");
        dbg_exit(MD_TBD, 0);
    }
#endif /* ENCODE_DEBUG_SWITCH */

    cmpi_encode_uint32(comm, CSFS_NODE_TCID(csfs_node), out_buff, out_buff_max_len, position);
    cmpi_encode_uint32(comm, CSFS_NODE_IPADDR(csfs_node), out_buff, out_buff_max_len, position);
...
{
    cmpi_encode_uint32_size(comm, CSFS_NODE_TCID(csfs_node), size);
    cmpi_encode_uint32_size(comm, CSFS_NODE_IPADDR(csfs_node), size);
...
UINT32 cmpi_decode_csfs_node(const UINT32 comm, const UINT8 *in_buff, const UINT32 in_buff_max_len, UINT32 *position, CSFS_NODE *csfs_node)
{
    ...
    if ( NULL_PTR == in_buff )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_decode_csfs_node: in_buff is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == position )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_decode_csfs_node: position is null.\n");
        dbg_exit(MD_TBD, 0);
    }
    if ( NULL_PTR == csfs_node )
    {
        dbg_log(SEC_0035_CMPIE, 0)(LOGSTDOUT,"error:cmpi_decode_csfs_node: csfs_node is null.\n");
        dbg_exit(MD_TBD, 0);
    }
#endif /* ENCODE_DEBUG_SWITCH */

    cmpi_decode_uint32(comm, in_buff, in_buff_max_len, position, &CSFS_NODE_TCID(csfs_node));
    cmpi_decode_uint32(comm, in_buff, in_buff_max_len, position, &CSFS_NODE_IPADDR(csfs_node));
    cmpi_decode_uint32(comm, in_buff, in_buff_max_len, position, &CSFS_NODE_PORT(csfs_node));
    cmpi_decode_uint32(comm, in_buff, in_buff_max_len, position, &CSFS_NODE_MODI(csfs_node));
    cmpi_decode_uint32(comm, in_buff, in_buff_max_len, position, &CSFS_NODE_STATE(csfs_node));
