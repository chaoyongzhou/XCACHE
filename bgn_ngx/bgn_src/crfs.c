...
/*Jan 16, 2017*/
static EC_BOOL __crfs_write_no_lock(const UINT32 crfs_md_id, const CSTRING *file_path, const CBYTES *cbytes, const UINT32 expire_nsec)
{
    CRFS_MD      *crfs_md;
    CRFSNP_FNODE *crfsnp_fnode;
    uint32_t      path_hash;
...
EC_BOOL crfs_write_no_lock(const UINT32 crfs_md_id, const CSTRING *file_path, const CBYTES *cbytes, const UINT32 expire_nsec)
{
    ...
    return __crfs_write_no_lock(crfs_md_id, file_path, cbytes, expire_nsec);
}
...
EC_BOOL crfs_read(const UINT32 crfs_md_id, const CSTRING *file_path, CBYTES *cbytes, UINT32 *expires_timestamp, const EC_BOOL need_expired_content)
{
    ...
    CRFS_RDLOCK(crfs_md, LOC_CRFS_0050);
    if(EC_FALSE == crfs_read_npp(crfs_md_id, file_path, &crfsnp_fnode, expires_timestamp))
    {
...
EC_BOOL crfs_write_e(const UINT32 crfs_md_id, const CSTRING *file_path, UINT32 *offset, const UINT32 max_len, const CBYTES *cbytes)
{
    ...
    CRFS_WRLOCK(crfs_md, LOC_CRFS_0053);
...
EC_BOOL crfs_read_e(const UINT32 crfs_md_id, const CSTRING *file_path, UINT32 *offset, const UINT32 max_len, CBYTES *cbytes, UINT32 *expires_timestamp, const EC_BOOL need_expired_content)
{
    ...
    CRFS_RDLOCK(crfs_md, LOC_CRFS_0058);
    ...
    CRFS_UNLOCK(crfs_md, LOC_CRFS_0062);
    return (EC_TRUE);
}
...
static EC_BOOL __crfs_create_b_npp(const UINT32 crfs_md_id, const CSTRING *file_path, const uint64_t *file_size)
{
    ...
    crfsnp_mgr_rdlock(CRFS_MD_NPP(crfs_md), LOC_CRFS_0063);
...
EC_BOOL crfs_create_b(const UINT32 crfs_md_id, const CSTRING *file_path, const uint64_t *file_size)
{
    ...
    CRFS_WRLOCK(crfs_md, LOC_CRFS_0066);
...
EC_BOOL crfs_write_b(const UINT32 crfs_md_id, const CSTRING *file_path, uint64_t *offset, const CBYTES *cbytes)
{
    ...
    CRFS_WRLOCK(crfs_md, LOC_CRFS_0069);
...
EC_BOOL crfs_read_b(const UINT32 crfs_md_id, const CSTRING *file_path, uint64_t *offset, const UINT32 max_len, CBYTES *cbytes, UINT32 *expires_timestamp, const EC_BOOL need_expired_content)
{
    ...
    CRFS_RDLOCK(crfs_md, LOC_CRFS_0073);
    ...
    **/
    ...
    {
        CRFS_UNLOCK(crfs_md, LOC_CRFS_0077);
...
EC_BOOL crfs_fetch_block_fd_b(const UINT32 crfs_md_id, const CSTRING *file_path, const uint64_t offset, UINT32 *expires_timestamp, const EC_BOOL need_expired_content, uint32_t *block_size, int *block_fd)
{
    ...
    CRFS_RDLOCK(crfs_md, LOC_CRFS_0079);
...
static EC_BOOL __crfs_transfer_handle_of_np(const UINT32 crfs_md_id, const uint32_t crfsnp_id, const CSTRING *dir_path, const CRFSDT_PNODE *crfsdt_pnode, const CRFSNP_TRANS_DN *crfsnp_trans_dn)
{
    ...
    //CRFS_RDLOCK(crfs_md, LOC_CRFS_0088);
...
EC_BOOL crfs_umount_disk(const UINT32 crfs_md_id, const UINT32 disk_no)
{
    ...
    CRFS_WRLOCK(crfs_md, LOC_CRFS_0103);
    ...
    CRFS_UNLOCK(crfs_md, LOC_CRFS_0105);
    return (EC_TRUE);
}
...
EC_BOOL crfs_read_dn(const UINT32 crfs_md_id, const CRFSNP_FNODE *crfsnp_fnode, CBYTES *cbytes)
{
    ...
    if(CBYTES_LEN(cbytes) < file_size)
    {
        ...
        {
            SAFE_FREE(CBYTES_BUF(cbytes), LOC_CRFS_0109);
        }
        CBYTES_BUF(cbytes) = (UINT8 *)SAFE_MALLOC(file_size, LOC_CRFS_0110);
        ASSERT(NULL_PTR != CBYTES_BUF(cbytes));
        CBYTES_LEN(cbytes) = 0;
    }

    crfsdn_rdlock(CRFS_MD_DN(crfs_md), LOC_CRFS_0111);
...
EC_BOOL crfs_read_e_dn(const UINT32 crfs_md_id, const CRFSNP_FNODE *crfsnp_fnode, UINT32 *offset, const UINT32 max_len, CBYTES *cbytes)
{
    ...
    if(CBYTES_LEN(cbytes) < max_len_t)
    {
        if(NULL_PTR != CBYTES_BUF(cbytes))
        {
            SAFE_FREE(CBYTES_BUF(cbytes), LOC_CRFS_0117);
        }
        CBYTES_BUF(cbytes) = (UINT8 *)SAFE_MALLOC(max_len_t, LOC_CRFS_0118);
        CBYTES_LEN(cbytes) = 0;
    } 

    crfsdn_rdlock(CRFS_MD_DN(crfs_md), LOC_CRFS_0119);
...
EC_BOOL crfs_renew_http_header(const UINT32 crfs_md_id, const CSTRING *file_path, const CSTRING *key, const CSTRING *val)
{
    ...
    if(EC_FALSE == crfs_read(crfs_md_id, file_path, &cbytes, NULL_PTR, EC_TRUE))
    {
    ...
    if(EC_FALSE == crfs_update(crfs_md_id, file_path, &cbytes, 0))
    {
...
EC_BOOL crfs_delete_file_no_lock(const UINT32 crfs_md_id, const CSTRING *path)
{
    ...
    if(EC_TRUE == crfs_is_state(crfs_md_id, CRFS_SYNC_STATE))
    {
        if(EC_TRUE == crfs_delete_file_backup(crfs_md_id, path))
        {
            dbg_log(SEC_0031_CRFS, 9)(LOGSTDOUT, "[DEBUG] crfs_delete_file_no_lock: delete file %s with from backup RFS done\n",
                                   (char *)cstring_get_str(path));         
            return (EC_TRUE);
        }

        /*fall through to RFS*/
        dbg_log(SEC_0031_CRFS, 0)(LOGSTDOUT, "error:crfs_delete_file_no_lock: delete file %s with from backup RFS failed\n",
                               (char *)cstring_get_str(path));         
        return (EC_FALSE);/*terminate, not change RFS*/
    }
...
EC_BOOL crfs_delete_file_b_no_lock(const UINT32 crfs_md_id, const CSTRING *path)
{
    ...
    if(EC_TRUE == crfs_is_state(crfs_md_id, CRFS_SYNC_STATE))
    {
        if(EC_TRUE == crfs_delete_file_b_backup(crfs_md_id, path))
        {
            dbg_log(SEC_0031_CRFS, 9)(LOGSTDOUT, "[DEBUG] crfs_delete_file_b_no_lock: delete file %s with from backup RFS done\n",
                                   (char *)cstring_get_str(path));         
            return (EC_TRUE);
        }

        /*fall through to RFS*/
        dbg_log(SEC_0031_CRFS, 0)(LOGSTDOUT, "error:crfs_delete_file_b_no_lock: delete file %s with from backup RFS failed\n",
                               (char *)cstring_get_str(path));         
        return (EC_FALSE);/*terminate, not change RFS*/
    }
...
EC_BOOL crfs_delete_dir_no_lock(const UINT32 crfs_md_id, const CSTRING *path)
{
    ...
    if(EC_TRUE == crfs_is_state(crfs_md_id, CRFS_SYNC_STATE))
    {
        if(EC_TRUE == crfs_delete_dir_backup(crfs_md_id, path))
        {
            dbg_log(SEC_0031_CRFS, 9)(LOGSTDOUT, "[DEBUG] crfs_delete_dir_no_lock: delete dir %s with from backup RFS done\n",
                                   (char *)cstring_get_str(path));         
            return (EC_TRUE);
        }

        /*fall through to RFS*/
        dbg_log(SEC_0031_CRFS, 0)(LOGSTDOUT, "error:crfs_delete_dir_no_lock: delete dir %s with from backup RFS failed\n",
                               (char *)cstring_get_str(path));         
        return (EC_FALSE);/*terminate, not change RFS*/
    }
...
*
**/
EC_BOOL crfs_update_0(const UINT32 crfs_md_id, const CSTRING *file_path, const CBYTES *cbytes, const UINT32 expire_nsec)
{
    CRFS_MD      *crfs_md;
    CRFSNP_FNODE  crfsnp_fnode;
    UINT32        expires_timestamp;
...
EC_BOOL crfs_update(const UINT32 crfs_md_id, const CSTRING *file_path, const CBYTES *cbytes, const UINT32 expire_nsec)
{
    ...
    if(EC_FALSE == crfs_update_no_lock(crfs_md_id, file_path, cbytes, expire_nsec))
    {
...
EC_BOOL crfs_update_no_lock(const UINT32 crfs_md_id, const CSTRING *file_path, const CBYTES *cbytes, const UINT32 expire_nsec)
{
    ...
    if(EC_FALSE == crfs_read_npp(crfs_md_id, file_path, NULL_PTR, NULL_PTR))
    {
        /*file not exist, write as new file*/
        if(EC_FALSE == crfs_write_no_lock(crfs_md_id, file_path, cbytes, expire_nsec))
        {
...
static EC_BOOL __crfs_cat_path(const CRFSNP_ITEM *crfsnp_item, CSTRING *des_path)
{
    ...
    cstring_append_chars(des_path, (UINT32)1, (const UINT8 *)"/");
    cstring_append_chars(des_path, CRFSNP_ITEM_KLEN(crfsnp_item), CRFSNP_ITEM_KEY(crfsnp_item));
...
static EC_BOOL __crfs_qlist_tree(CRFSNP_DIT_NODE *crfsnp_dit_node, CRFSNP *crfsnp, CRFSNP_ITEM *crfsnp_item, const uint32_t node_pos)
{
    ...
    if(CRFSNP_ITEM_FILE_IS_REG == CRFSNP_ITEM_DIR_FLAG(crfsnp_item))
    {
        ...
        full_path = cstring_new(cstring_get_str(base_dir), LOC_CRFS_0208);
...
EC_BOOL crfs_qlist_tree(const UINT32 crfs_md_id, const CSTRING *file_path, CVECTOR  *path_cstr_vec)
{
    ...
    base_dir = cstring_new(cstring_get_str(file_path), LOC_CRFS_0209);
...
EC_BOOL crfs_qlist_tree_of_np(const UINT32 crfs_md_id, const UINT32 crfsnp_id, const CSTRING *file_path, CVECTOR  *path_cstr_vec)
{
    ...
    base_dir = cstring_new(cstring_get_str(file_path), LOC_CRFS_0216);
    if(NULL_PTR == base_dir)
    {
    ...
    crfsnp_mgr_rdlock(CRFS_MD_NPP(crfs_md), LOC_CRFS_0218);
...
EC_BOOL crfs_flush_npp(const UINT32 crfs_md_id)
{
    ...
    CRFS_WRLOCK(crfs_md, LOC_CRFS_0223);
    crfsnp_mgr_wrlock(CRFS_MD_NPP(crfs_md), LOC_CRFS_0224);
    if(EC_FALSE == crfsnp_mgr_flush(CRFS_MD_NPP(crfs_md)))
    {
        crfsnp_mgr_unlock(CRFS_MD_NPP(crfs_md), LOC_CRFS_0225);
        CRFS_UNLOCK(crfs_md, LOC_CRFS_0226);
...
EC_BOOL crfs_flush_dn(const UINT32 crfs_md_id)
{
    ...
    CRFS_WRLOCK(crfs_md, LOC_CRFS_0229);
    crfsdn_wrlock(CRFS_MD_DN(crfs_md), LOC_CRFS_0230);
    if(EC_FALSE == crfsdn_flush(CRFS_MD_DN(crfs_md)))
    {
        crfsdn_unlock(CRFS_MD_DN(crfs_md), LOC_CRFS_0231);
        CRFS_UNLOCK(crfs_md, LOC_CRFS_0232);
...
EC_BOOL crfs_file_num(const UINT32 crfs_md_id, const CSTRING *path_cstr, UINT32 *file_num)
{
    ...
    CRFS_RDLOCK(crfs_md, LOC_CRFS_0235);
...
EC_BOOL crfs_file_size(const UINT32 crfs_md_id, const CSTRING *path_cstr, uint64_t *file_size)
{
    ...
    crfsnp_mgr_rdlock(CRFS_MD_NPP(crfs_md), LOC_CRFS_0241);
    if(EC_FALSE == crfsnp_mgr_file_size(CRFS_MD_NPP(crfs_md), path_cstr, file_size))
    {
        crfsnp_mgr_unlock(CRFS_MD_NPP(crfs_md), LOC_CRFS_0242);
...
EC_BOOL crfs_dir_expire(const UINT32 crfs_md_id, const CSTRING *path_cstr)
{
    ...
    crfsnp_mgr_wrlock(CRFS_MD_NPP(crfs_md), LOC_CRFS_0244);
    ...
    crfsnp_mgr_unlock(CRFS_MD_NPP(crfs_md), LOC_CRFS_0246); 
    return (EC_TRUE);
}
...
EC_BOOL crfs_store_size_b(const UINT32 crfs_md_id, const CSTRING *path_cstr, uint64_t *store_size, UINT32 *expires_timestamp)
{
    ...
    crfsnp_mgr_rdlock(CRFS_MD_NPP(crfs_md), LOC_CRFS_0247);
    ...
    crfsnp_mgr_unlock(CRFS_MD_NPP(crfs_md), LOC_CRFS_0249); 
    return (EC_TRUE);
}
...
EC_BOOL crfs_file_md5sum(const UINT32 crfs_md_id, const CSTRING *path_cstr, CMD5_DIGEST *md5sum)
{
    ...
    crfsnp_mgr_rdlock(CRFS_MD_NPP(crfs_md), LOC_CRFS_0250);
    ...
    crfsnp_mgr_unlock(CRFS_MD_NPP(crfs_md), LOC_CRFS_0252); 
    return (EC_TRUE);
}
...
EC_BOOL crfs_file_md5sum_b(const UINT32 crfs_md_id, const CSTRING *path_cstr, const UINT32 seg_no, CMD5_DIGEST *md5sum)
{
    ...
    crfsnp_mgr_rdlock(CRFS_MD_NPP(crfs_md), LOC_CRFS_0253);
    ...
    crfsnp_mgr_unlock(CRFS_MD_NPP(crfs_md), LOC_CRFS_0255); 
    return (EC_TRUE);
}
...
EC_BOOL crfs_mkdir(const UINT32 crfs_md_id, const CSTRING *path_cstr)
{
    ...
    CRFS_WRLOCK(crfs_md, LOC_CRFS_0256);
    crfsnp_mgr_wrlock(CRFS_MD_NPP(crfs_md), LOC_CRFS_0257);
    if(EC_FALSE == crfsnp_mgr_mkdir(CRFS_MD_NPP(crfs_md), path_cstr))
    {
        crfsnp_mgr_unlock(CRFS_MD_NPP(crfs_md), LOC_CRFS_0258);
        CRFS_UNLOCK(crfs_md, LOC_CRFS_0259);
...
EC_BOOL crfs_search(const UINT32 crfs_md_id, const CSTRING *path_cstr, const UINT32 dflag)
{
    ...
    CRFS_RDLOCK(crfs_md, LOC_CRFS_0262);
    crfsnp_mgr_rdlock(CRFS_MD_NPP(crfs_md), LOC_CRFS_0263);
    ...
    {
        crfsnp_mgr_unlock(CRFS_MD_NPP(crfs_md), LOC_CRFS_0264);
        CRFS_UNLOCK(crfs_md, LOC_CRFS_0265);
...
static EC_BOOL __crfs_recycle_of_np(const UINT32 crfs_md_id, const uint32_t crfsnp_id, const UINT32 max_num, UINT32 *complete_num)
{
    ...
    CRFS_WRLOCK(crfs_md, LOC_CRFS_0268);
...
EC_BOOL crfs_check_file_content(const UINT32 crfs_md_id, const UINT32 disk_no, const UINT32 block_no, const UINT32 page_no, const UINT32 file_size, const CSTRING *file_content_cstr)
{
    ...
    {
        CRFS_UNLOCK(crfs_md, LOC_CRFS_0273);
...
EC_BOOL crfs_show_npp(const UINT32 crfs_md_id, LOG *log)
{
    ...
    CRFS_RDLOCK(crfs_md, LOC_CRFS_0276);
    crfsnp_mgr_rdlock(CRFS_MD_NPP(crfs_md), LOC_CRFS_0277);
 
    crfsnp_mgr_print(log, CRFS_MD_NPP(crfs_md));
 
    crfsnp_mgr_unlock(CRFS_MD_NPP(crfs_md), LOC_CRFS_0278);
    CRFS_UNLOCK(crfs_md, LOC_CRFS_0279);
...
EC_BOOL crfs_show_dn_no_lock(const UINT32 crfs_md_id, LOG *log)
{
    ...
    //CRFS_RDLOCK(crfs_md, LOC_CRFS_0280);
    //crfsdn_rdlock(CRFS_MD_DN(crfs_md), LOC_CRFS_0281);
    crfsdn_print(log, CRFS_MD_DN(crfs_md));
    //crfsdn_unlock(CRFS_MD_DN(crfs_md), LOC_CRFS_0282);
    //CRFS_UNLOCK(crfs_md, LOC_CRFS_0283);
...
EC_BOOL crfs_show_dn(const UINT32 crfs_md_id, LOG *log)
{
    ...
    CRFS_RDLOCK(crfs_md, LOC_CRFS_0284);
    crfsdn_rdlock(CRFS_MD_DN(crfs_md), LOC_CRFS_0285);
    crfsdn_print(log, CRFS_MD_DN(crfs_md));
    crfsdn_unlock(CRFS_MD_DN(crfs_md), LOC_CRFS_0286);
    CRFS_UNLOCK(crfs_md, LOC_CRFS_0287);
...
EC_BOOL crfs_show_cached_np(const UINT32 crfs_md_id, LOG *log)
{
    ...
    CRFS_RDLOCK(crfs_md, LOC_CRFS_0288);
    crfsnp_mgr_rdlock(CRFS_MD_NPP(crfs_md), LOC_CRFS_0289); 
    if(EC_FALSE == crfsnp_mgr_show_cached_np(log, CRFS_MD_NPP(crfs_md)))
    {
        crfsnp_mgr_unlock(CRFS_MD_NPP(crfs_md), LOC_CRFS_0290);
        CRFS_UNLOCK(crfs_md, LOC_CRFS_0291);
...
EC_BOOL crfs_show_specific_np(const UINT32 crfs_md_id, const UINT32 crfsnp_id, LOG *log)
{
    ...
    CRFS_RDLOCK(crfs_md, LOC_CRFS_0294);
    crfsnp_mgr_rdlock(CRFS_MD_NPP(crfs_md), LOC_CRFS_0295); 
    if(EC_FALSE == crfsnp_mgr_show_np(log, CRFS_MD_NPP(crfs_md), (uint32_t)crfsnp_id))
    {
        crfsnp_mgr_unlock(CRFS_MD_NPP(crfs_md), LOC_CRFS_0296);
        CRFS_UNLOCK(crfs_md, LOC_CRFS_0297);
...
EC_BOOL crfs_show_path_depth(const UINT32 crfs_md_id, const CSTRING *path, LOG *log)
{
    ...
    CRFS_RDLOCK(crfs_md, LOC_CRFS_0300);
    crfsnp_mgr_rdlock(CRFS_MD_NPP(crfs_md), LOC_CRFS_0301); 
    if(EC_FALSE == crfsnp_mgr_show_path_depth(log, CRFS_MD_NPP(crfs_md), path))
    {
        crfsnp_mgr_unlock(CRFS_MD_NPP(crfs_md), LOC_CRFS_0302);
...
EC_BOOL crfs_show_path(const UINT32 crfs_md_id, const CSTRING *path, LOG *log)
{
    ...
    CRFS_RDLOCK(crfs_md, LOC_CRFS_0306);
    crfsnp_mgr_rdlock(CRFS_MD_NPP(crfs_md), LOC_CRFS_0307); 
    if(EC_FALSE == crfsnp_mgr_show_path(log, CRFS_MD_NPP(crfs_md), path))
    {
        crfsnp_mgr_unlock(CRFS_MD_NPP(crfs_md), LOC_CRFS_0308);
...
static EC_BOOL __crfs_retire_of_np(const UINT32 crfs_md_id, const uint32_t crfsnp_id, const uint32_t dflag, const UINT32 nsec, const UINT32 expect_retire_num, const UINT32 max_step, UINT32 *complete_retire_num)
{
    ...
    CRFS_WRLOCK(crfs_md, LOC_CRFS_0312);
    ...
    CRFS_UNLOCK(crfs_md, LOC_CRFS_0314);
    return (EC_TRUE);
}
...
CRFS_WAIT_FILE *crfs_wait_file_new()
{
    ...
    alloc_static_mem(MM_CRFS_WAIT_FILE, &crfs_wait_file, LOC_CRFS_0315);
...
EC_BOOL crfs_wait_file_init(CRFS_WAIT_FILE *crfs_wait_file)
{
    ...
    clist_init(CRFS_WAIT_FILE_OWNER_LIST(crfs_wait_file), MM_MOD_NODE, LOC_CRFS_0316);
...
EC_BOOL crfs_wait_file_free(CRFS_WAIT_FILE *crfs_wait_file)
{
    if(NULL_PTR != crfs_wait_file)
    {
        ...
        free_static_mem(MM_CRFS_WAIT_FILE, crfs_wait_file, LOC_CRFS_0317);
    }
    return (EC_TRUE);
}
...
EC_BOOL crfs_file_wait(const UINT32 crfs_md_id, const UINT32 tcid, const CSTRING *file_path, CBYTES *cbytes, UINT32 *data_ready)
{
    ...
    if(NULL_PTR != data_ready)
    {
        ...
        if(EC_OBSCURE != (*data_ready))
        {
            ...
            if(EC_TRUE == crfs_read(crfs_md_id, file_path, cbytes, NULL_PTR, EC_TRUE))
            {
                (*data_ready) = EC_TRUE;
                return (EC_TRUE);
            }
...
EC_BOOL crfs_file_wait_e(const UINT32 crfs_md_id, const UINT32 tcid, const CSTRING *file_path, UINT32 *offset, const UINT32 max_len, CBYTES *cbytes, UINT32 *data_ready)
{
    ...
    if(NULL_PTR != data_ready)
    {
        ...
        {
            /*if data is already ready, return now*/
            if(EC_TRUE == crfs_read_e(crfs_md_id, file_path, offset, max_len, cbytes, NULL_PTR, EC_TRUE))
            {
                (*data_ready) = EC_TRUE;
                return (EC_TRUE);
            }
...
EC_BOOL crfs_cache_file(const UINT32 crfs_md_id, const CSTRING *path)
{
    ...
    if(SWITCH_ON == CRFS_MEMC_SWITCH)
    {
        ...
        if(EC_FALSE == crfs_read(crfs_md_id, path, &cbytes, &expires_timestamp, EC_TRUE))
        {
    ...
    if(EC_FALSE == crfs_is_state(crfs_md_id, CRFS_SYNC_STATE))
    {
        ...
        for(mod_node_idx = 0; mod_node_idx < mod_node_num; mod_node_idx ++)
        {
            ...
            task_p2p_inc(task_mgr, crfs_md_id, recv_mod_node,
                        &(ret[ mod_node_idx ]), FI_crfs_write,CMPI_ERROR_MODI, file_path, cbytes, expire_nsec);
        }
...
EC_BOOL crfs_update_r(const UINT32 crfs_md_id, const CSTRING *file_path, const CBYTES *cbytes, const UINT32 expire_nsec, const UINT32 replica_num)
{
    ...
    if(EC_FALSE == crfs_is_state(crfs_md_id, CRFS_SYNC_STATE))
    {
        ...
        for(mod_node_idx = 0; mod_node_idx < mod_node_num; mod_node_idx ++)
        {
            ...
            task_p2p_inc(task_mgr, crfs_md_id, recv_mod_node,
                        &(ret_vec[ mod_node_idx ]), FI_crfs_update,CMPI_ERROR_MODI, file_path, cbytes, expire_nsec);
        }
        task_wait(task_mgr, TASK_DEFAULT_LIVE, TASK_NOT_NEED_RESCHEDULE_FLAG, NULL_PTR);
...
EC_BOOL crfs_renew_r(const UINT32 crfs_md_id, const CSTRING *file_path, const UINT32 expires_timestamp, const UINT32 replica_num)
{
    ...
    if(EC_FALSE == crfs_is_state(crfs_md_id, CRFS_SYNC_STATE))
    {
        ...
        for(mod_node_idx = 0; mod_node_idx < mod_node_num; mod_node_idx ++)
        {
            ...
            ret_vec[ mod_node_idx ] = EC_FALSE;
            task_p2p_inc(task_mgr, crfs_md_id, recv_mod_node,
                         &(ret_vec[ mod_node_idx ]), FI_crfs_renew,CMPI_ERROR_MODI, file_path, expires_timestamp);
        }
        task_wait(task_mgr, TASK_DEFAULT_LIVE, TASK_NOT_NEED_RESCHEDULE_FLAG, NULL_PTR);
