...
EC_BOOL cping_check(const UINT32 srv_ipaddr, const UINT32 srv_port, UINT32 *elapsed_msec)
{
    ...
    cping_node_set_socket_callback(cping_node);
    cping_node_set_socket_epoll(cping_node);
