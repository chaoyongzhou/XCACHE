...
static const CHTTP_API g_cxfshttp_api_list[] = {
    ...
    {CONST_STR_AND_LEN("sexpire")           , CHTTP_METHOD_PATCH , cxfshttp_commit_sexpire_request},
    ...
    {CONST_STR_AND_LEN("renew_header")      , CHTTP_METHOD_PUT   , cxfshttp_commit_renew_header_request},
    ...
    {CONST_STR_AND_LEN("mexpire")           , CHTTP_METHOD_PATCH , cxfshttp_commit_mexpire_request},
    {CONST_STR_AND_LEN("mdsmf")             , CHTTP_METHOD_DELETE, cxfshttp_commit_mdsmf_request},
    {CONST_STR_AND_LEN("mddir")             , CHTTP_METHOD_DELETE, cxfshttp_commit_mddir_request},
    {CONST_STR_AND_LEN("update")            , CHTTP_METHOD_PUT   , cxfshttp_commit_update_request},
    {CONST_STR_AND_LEN("renew")             , CHTTP_METHOD_PUT   , cxfshttp_commit_renew_request},
...
EC_BOOL cxfshttp_handle_getsmf_request(CHTTP_NODE *chttp_node)
{
    ...
    cstring_append_chars(&path_cstr, cache_len, cache_key, LOC_CXFSHTTP_0003);
...
STATIC_CAST static UINT32 __cxfshttp_convert_expires_str_to_nseconds(const char *expires_str)
{
    ...
    if(1 == seg_num)
    {
        ...
        safe_free(str, LOC_CXFSHTTP_0004);
        return (expires_nsec);
    }
    ...
    if(2 == seg_num)/*if has dot, we regard client gives absolute time (in seconds)*/
    {
        ...
        safe_free(str, LOC_CXFSHTTP_0005);
        return (expires_nsec);
    }
...
EC_BOOL cxfshttp_handle_unlock_req_request(CHTTP_NODE *chttp_node)
{
    ...
    cstring_init(&path_cstr, NULL_PTR);
    cstring_append_chars(&path_cstr, cache_len, cache_key, LOC_CXFSHTTP_0008);
