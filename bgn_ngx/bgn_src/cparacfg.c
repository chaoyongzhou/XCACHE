...
EC_BOOL cparacfg_init(CPARACFG *cparacfg, const UINT32 this_tcid, const UINT32 this_rank)
{
    ...
    CPARACFG_SET_STR_DEFAULT(cparacfg, CPARACFG_CUNIXPACKET_AGENT_HTTP_REQ_SERVER_CSTR);
    CPARACFG_SET_STR_DEFAULT(cparacfg, CPARACFG_CUNIXPACKET_AGENT_HTTP_REQ_DOMAIN_CSTR);
    CPARACFG_SET_STR_DEFAULT(cparacfg, CPARACFG_CUNIXPACKET_AGENT_HTTP_REQ_URI_CSTR);
    CPARACFG_SET_STR_DEFAULT(cparacfg, CPARACFG_CUNIXPACKET_AGENT_HTTP_REQ_OP_CSTR);
    CPARACFG_SET_STR_DEFAULT(cparacfg, CPARACFG_CUNIXPACKET_AGENT_HTTP_REQ_ACL_TOKEN_CSTR);
    CPARACFG_SET_DEFAULT(cparacfg, CPARACFG_CUNIXPACKET_AGENT_HTTP_REQ_EXPIRED_NSEC);
    CPARACFG_SET_DEFAULT(cparacfg, CPARACFG_CUNIXPACKET_AGENT_UDS_PACKET_MAX_SIZE);
    CPARACFG_SET_DEFAULT(cparacfg, CPARACFG_CUNIXPACKET_AGENT_UDS_PACKET_BUF_SIZE);
    CPARACFG_SET_DEFAULT(cparacfg, CPARACFG_CUNIXPACKET_AGENT_UDS_PACKET_CACHE_MAX_NUM);
    CPARACFG_SET_DEFAULT(cparacfg, CPARACFG_CUNIXPACKET_AGENT_UDS_PACKET_SENT_MAX_NUM);
    CPARACFG_SET_DEFAULT(cparacfg, CPARACFG_CUNIXPACKET_AGENT_UDS_PACKET_RECV_MAX_NUM);
...
void cparacfg_print(LOG *log, const CPARACFG *cparacfg)
{
    ...
    sys_log(log, "CUNIXPACKET_AGENT_HTTP_REQ_SERVER          = %s\n" ,  CPARACFG_CUNIXPACKET_AGENT_HTTP_REQ_SERVER_STR(cparacfg));
    sys_log(log, "CUNIXPACKET_AGENT_HTTP_REQ_DOMAIN          = %s\n" ,  CPARACFG_CUNIXPACKET_AGENT_HTTP_REQ_DOMAIN_STR(cparacfg));
    sys_log(log, "CUNIXPACKET_AGENT_HTTP_REQ_URI             = %s\n" ,  CPARACFG_CUNIXPACKET_AGENT_HTTP_REQ_URI_STR(cparacfg));
    sys_log(log, "CUNIXPACKET_AGENT_HTTP_REQ_OP              = %s\n" ,  CPARACFG_CUNIXPACKET_AGENT_HTTP_REQ_OP_STR(cparacfg));
    sys_log(log, "CUNIXPACKET_AGENT_HTTP_REQ_ACL_TOKEN       = %s\n" ,  CPARACFG_CUNIXPACKET_AGENT_HTTP_REQ_ACL_TOKEN_STR(cparacfg));
    sys_log(log, "CUNIXPACKET_AGENT_HTTP_REQ_EXPIRED_NSEC    = %ld\n",  CPARACFG_CUNIXPACKET_AGENT_HTTP_REQ_EXPIRED_NSEC(cparacfg));
    sys_log(log, "CUNIXPACKET_AGENT_UDS_PACKET_MAX_SIZE      = %u\n" ,  CPARACFG_CUNIXPACKET_AGENT_UDS_PACKET_MAX_SIZE(cparacfg));
    sys_log(log, "CUNIXPACKET_AGENT_UDS_PACKET_BUF_SIZE      = %u\n" ,  CPARACFG_CUNIXPACKET_AGENT_UDS_PACKET_BUF_SIZE(cparacfg));
    sys_log(log, "CUNIXPACKET_AGENT_UDS_PACKET_CACHE_MAX_NUM = %u\n" ,  CPARACFG_CUNIXPACKET_AGENT_UDS_PACKET_CACHE_MAX_NUM(cparacfg));
    sys_log(log, "CUNIXPACKET_AGENT_UDS_PACKET_SENT_MAX_NUM  = %u\n" ,  CPARACFG_CUNIXPACKET_AGENT_UDS_PACKET_SENT_MAX_NUM(cparacfg));
    sys_log(log, "CUNIXPACKET_AGENT_UDS_PACKET_RECV_MAX_NUM  = %u\n" ,  CPARACFG_CUNIXPACKET_AGENT_UDS_PACKET_RECV_MAX_NUM(cparacfg));
...
void cparacfg_json(json_object *obj, const CPARACFG *cparacfg)
{
    ...
    json_object_add_kv(obj,      "CUNIXPACKET_AGENT_HTTP_REQ_SERVER",           CPARACFG_CUNIXPACKET_AGENT_HTTP_REQ_SERVER_STR(cparacfg));
    json_object_add_kv(obj,      "CUNIXPACKET_AGENT_HTTP_REQ_DOMAIN",           CPARACFG_CUNIXPACKET_AGENT_HTTP_REQ_DOMAIN_STR(cparacfg));
    json_object_add_kv(obj,      "CUNIXPACKET_AGENT_HTTP_REQ_URI",              CPARACFG_CUNIXPACKET_AGENT_HTTP_REQ_URI_STR(cparacfg));
    json_object_add_kv(obj,      "CUNIXPACKET_AGENT_HTTP_REQ_OP",               CPARACFG_CUNIXPACKET_AGENT_HTTP_REQ_OP_STR(cparacfg));
    json_object_add_kv(obj,      "CUNIXPACKET_AGENT_HTTP_REQ_ACL_TOKEN",        CPARACFG_CUNIXPACKET_AGENT_HTTP_REQ_ACL_TOKEN_STR(cparacfg));
    json_object_add_k_int64(obj, "CUNIXPACKET_AGENT_HTTP_REQ_EXPIRED_NSEC",     CPARACFG_CUNIXPACKET_AGENT_HTTP_REQ_EXPIRED_NSEC(cparacfg));
    json_object_add_k_int32(obj, "CUNIXPACKET_AGENT_UDS_PACKET_MAX_SIZE",       CPARACFG_CUNIXPACKET_AGENT_UDS_PACKET_MAX_SIZE(cparacfg));
    json_object_add_k_int32(obj, "CUNIXPACKET_AGENT_UDS_PACKET_BUF_SIZE",       CPARACFG_CUNIXPACKET_AGENT_UDS_PACKET_BUF_SIZE(cparacfg));
    json_object_add_k_int32(obj, "CUNIXPACKET_AGENT_UDS_PACKET_CACHE_MAX_NUM",  CPARACFG_CUNIXPACKET_AGENT_UDS_PACKET_CACHE_MAX_NUM(cparacfg));
    json_object_add_k_int32(obj, "CUNIXPACKET_AGENT_UDS_PACKET_SENT_MAX_NUM",   CPARACFG_CUNIXPACKET_AGENT_UDS_PACKET_SENT_MAX_NUM(cparacfg));
    json_object_add_k_int32(obj, "CUNIXPACKET_AGENT_UDS_PACKET_RECV_MAX_NUM",   CPARACFG_CUNIXPACKET_AGENT_UDS_PACKET_RECV_MAX_NUM(cparacfg));
