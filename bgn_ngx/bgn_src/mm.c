...
STATIC_CAST static UINT32 init_mem_manager()
{
    ...
    MM_MGR_DEF(MM_CLUSTER_NODE_CFG             ,"MM_CLUSTER_NODE_CFG             ",4        , sizeof(CLUSTER_NODE_CFG)            , LOC_MM_0107);
    MM_MGR_DEF(MM_CLUSTER_CFG                  ,"MM_CLUSTER_CFG                  ",4        , sizeof(CLUSTER_CFG)                 , LOC_MM_0108);
    MM_MGR_DEF(MM_CPARACFG                     ,"MM_CPARACFG                     ",1        , sizeof(CPARACFG)                    , LOC_MM_0109);
    MM_MGR_DEF(MM_MCAST_CFG                    ,"MM_MCAST_CFG                    ",1        , sizeof(MCAST_CFG)                   , LOC_MM_0110);
    MM_MGR_DEF(MM_BCAST_DHCP_CFG               ,"MM_BCAST_DHCP_CFG               ",1        , sizeof(BCAST_DHCP_CFG)              , LOC_MM_0111);
    MM_MGR_DEF(MM_MACIP_CFG                    ,"MM_MACIP_CFG                    ",4        , sizeof(MACIP_CFG)                   , LOC_MM_0112);
    MM_MGR_DEF(MM_SYS_CFG                      ,"MM_SYS_CFG                      ",1        , sizeof(SYS_CFG)                     , LOC_MM_0113);

    MM_MGR_DEF(MM_SUPER_FNODE                  ,"MM_SUPER_FNODE                  ",1        , sizeof(SUPER_FNODE)                 , LOC_MM_0114);

    MM_MGR_DEF(MM_CMAP_NODE                    ,"MM_CMAP_NODE                    ",4        , sizeof(CMAP_NODE)                   , LOC_MM_0115);
    MM_MGR_DEF(MM_CMAP                         ,"MM_CMAP                         ",4        , sizeof(CMAP)                        , LOC_MM_0116);
    ...
    MM_MGR_DEF(MM_COROUTINE_POOL               ,"MM_COROUTINE_POOL               ",4        , sizeof(COROUTINE_POOL)              , LOC_MM_0126);

    MM_MGR_DEF(MM_CRFSDN_NODE                  ,"MM_CRFSDN_NODE                  ",4        , sizeof(CRFSDN_NODE)                 , LOC_MM_0127);
    MM_MGR_DEF(MM_CRFSDN                       ,"MM_CRFSDN                       ",1        , sizeof(CRFSDN)                      , LOC_MM_0128);

    MM_MGR_DEF(MM_CPGB                         ,"MM_CPGB                         ",1        , CPGB_SIZE                           , LOC_MM_0129);
    MM_MGR_DEF(MM_CPGD                         ,"MM_CPGD                         ",256      , sizeof(CPGD)                        , LOC_MM_0130);
    MM_MGR_DEF(MM_CPGV                         ,"MM_CPGV                         ",64       , sizeof(CPGV)                        , LOC_MM_0131);

    MM_MGR_DEF(MM_CRB_NODE                     ,"MM_CRB_NODE                     ",64       , sizeof(CRB_NODE)                    , LOC_MM_0132);
    MM_MGR_DEF(MM_CRB_TREE                     ,"MM_CRB_TREE                     ",1        , sizeof(CRB_TREE)                    , LOC_MM_0133);

    MM_MGR_DEF(MM_CRFSNP_FNODE                 ,"MM_CRFSNP_FNODE                 ",1        , sizeof(CRFSNP_FNODE)                , LOC_MM_0134);
    MM_MGR_DEF(MM_CRFSNP_DNODE                 ,"MM_CRFSNP_DNODE                 ",1        , sizeof(CRFSNP_DNODE)                , LOC_MM_0135);
    MM_MGR_DEF(MM_CRFSNP_ITEM                  ,"MM_CRFSNP_ITEM                  ",1        , sizeof(CRFSNP_ITEM)                 , LOC_MM_0136);
    MM_MGR_DEF(MM_CRFSNP                       ,"MM_CRFSNP                       ",1        , sizeof(CRFSNP)                      , LOC_MM_0137);
    MM_MGR_DEF(MM_CRFSNP_MGR                   ,"MM_CRFSNP_MGR                   ",1        , sizeof(CRFSNP_MGR)                  , LOC_MM_0138);
    MM_MGR_DEF(MM_CRFSNP_KEY                   ,"MM_CRFSNP_KEY                   ",1        , sizeof(CRFSNP_KEY)                  , LOC_MM_0139);
    MM_MGR_DEF(MM_CRFSDN_CACHE_NODE            ,"MM_CRFSDN_CACHE_NODE            ",1        , sizeof(CRFSDN_CACHE_NODE)           , LOC_MM_0140);

    MM_MGR_DEF(MM_CHFSNP_FNODE                 ,"MM_CHFSNP_FNODE                 ",1        , sizeof(CHFSNP_FNODE)                , LOC_MM_0141);
    MM_MGR_DEF(MM_CHFSNP_ITEM                  ,"MM_CHFSNP_ITEM                  ",1        , sizeof(CHFSNP_ITEM)                 , LOC_MM_0142);
    MM_MGR_DEF(MM_CHFSNP                       ,"MM_CHFSNP                       ",1        , sizeof(CHFSNP)                      , LOC_MM_0143);
    MM_MGR_DEF(MM_CHFSNP_MGR                   ,"MM_CHFSNP_MGR                   ",1        , sizeof(CHFSNP_MGR)                  , LOC_MM_0144);

    MM_MGR_DEF(MM_UINT64                       ,"MM_UINT64                       ",32       , sizeof(uint64_t)                    , LOC_MM_0145);

    MM_MGR_DEF(MM_CEPOLL                       ,"MM_CEPOLL                       ",1        , sizeof(CEPOLL)                      , LOC_MM_0146);

    MM_MGR_DEF(MM_CSEM                         ,"MM_CSEM                         ",32        , sizeof(CSEM)                       , LOC_MM_0147);

    MM_MGR_DEF(MM_CSTRKV                       ,"MM_CSTRKV                       ",32        , sizeof(CSTRKV)                     , LOC_MM_0148);
    MM_MGR_DEF(MM_CSTRKV_MGR                   ,"MM_CSTRKV_MGR                   ",32        , sizeof(CSTRKV_MGR)                 , LOC_MM_0149);
    MM_MGR_DEF(MM_CBUFFER                      ,"MM_CBUFFER                      ",32        , sizeof(CBUFFER)                    , LOC_MM_0150);
    MM_MGR_DEF(MM_CHUNK                        ,"MM_CHUNK                        ",32        , sizeof(CHUNK)                      , LOC_MM_0151);
    MM_MGR_DEF(MM_CHUNK_MGR                    ,"MM_CHUNK_MGR                    ",32        , sizeof(CHUNK_MGR)                  , LOC_MM_0152);

    MM_MGR_DEF(MM_CMD5_DIGEST                  ,"MM_CMD5_DIGEST                  ",4         , sizeof(CMD5_DIGEST)                , LOC_MM_0153);
    MM_MGR_DEF(MM_CRFSOP                       ,"MM_CRFSOP                       ",32        , sizeof(CRFSOP)                     , LOC_MM_0154);

    MM_MGR_DEF(MM_CRFSDT_PNODE                 ,"MM_CRFSDT_PNODE                 ",32        , sizeof(CRFSDT_PNODE)               , LOC_MM_0155);
    MM_MGR_DEF(MM_CRFSDT_RNODE                 ,"MM_CRFSDT_RNODE                 ",32        , sizeof(CRFSDT_RNODE)               , LOC_MM_0156);
    MM_MGR_DEF(MM_CRFSDT                       ,"MM_CRFSDT                       ",32        , sizeof(CRFSDT)                     , LOC_MM_0157);

    MM_MGR_DEF(MM_CRFSCONHASH                  ,"MM_CRFSCONHASH                  ",1         , sizeof(CRFSCONHASH)                , LOC_MM_0158);
    MM_MGR_DEF(MM_CRFSCONHASH_RNODE            ,"MM_CRFSCONHASH_RNODE            ",32        , sizeof(CRFSCONHASH_RNODE)          , LOC_MM_0159);
    MM_MGR_DEF(MM_CRFSCONHASH_VNODE            ,"MM_CRFSCONHASH_VNODE            ",32        , sizeof(CRFSCONHASH_VNODE)          , LOC_MM_0160);
    ...
    MM_MGR_DEF(MM_CDETECTN_DOMAIN_NODE          ,"MM_CDETECTN_DOMAIN_NODE         ",256      , sizeof(CDETECTN_DOMAIN_NODE)         , LOC_MM_0225);

    MM_MGR_DEF(MM_CP2P_FILE                     ,"MM_CP2P_FILE                   ",256       , sizeof(CP2P_FILE)                    , LOC_MM_0226);
    MM_MGR_DEF(MM_CP2P_CMD                      ,"MM_CP2P_CMD                    ",256       , sizeof(CP2P_CMD)                     , LOC_MM_0227);

    MM_MGR_DEF(MM_CAGENT                        ,"MM_CAGENT                      ",1         , sizeof(CAGENT)                       , LOC_MM_0228);
    MM_MGR_DEF(MM_CPING_NODE                    ,"MM_CPING_NODE                  ",1         , sizeof(CPING_NODE)                   , LOC_MM_0229);

    MM_MGR_DEF(MM_CTDNS_SUSV_NODE               ,"MM_CTDNS_SUSV_NODE             ",1         , sizeof(CTDNS_SUSV_NODE)              , LOC_MM_0230);

    MM_MGR_DEF(MM_CMCDN                        ,"MM_CMCDN                        ",1         , sizeof(CMCDN)                        , LOC_MM_0231);
    MM_MGR_DEF(MM_CMCPGV                       ,"MM_CMCPGV                       ",1         , sizeof(CMCPGV)                       , LOC_MM_0232);
    MM_MGR_DEF(MM_CMCPGD                       ,"MM_CMCPGD                       ",256       , sizeof(CMCPGD)                       , LOC_MM_0233);

    MM_MGR_DEF(MM_CMCNP                        ,"MM_CMCNP                        ",1         , sizeof(CMCNP)                        , LOC_MM_0234);
    MM_MGR_DEF(MM_CMCNP_FNODE                  ,"MM_CMCNP_FNODE                  ",256       , sizeof(CMCNP_FNODE)                  , LOC_MM_0235);
    MM_MGR_DEF(MM_CMCNP_DNODE                  ,"MM_CMCNP_DNODE                  ",256       , sizeof(CMCNP_DNODE)                  , LOC_MM_0236);
    MM_MGR_DEF(MM_CMCNP_KEY                    ,"MM_CMCNP_KEY                    ",256       , sizeof(CMCNP_KEY)                    , LOC_MM_0237);
    MM_MGR_DEF(MM_CMCNP_ITEM                   ,"MM_CMCNP_ITEM                   ",256       , sizeof(CMCNP_ITEM)                   , LOC_MM_0238);
    MM_MGR_DEF(MM_CMCNP_BITMAP                 ,"MM_CMCNP_BITMAP                 ",256       , sizeof(CMCNP_BITMAP)                 , LOC_MM_0239);

    MM_MGR_DEF(MM_CAIO_NODE                    ,"MM_CAIO_NODE                    ",32        , sizeof(CAIO_NODE)                    , LOC_MM_0240);
    MM_MGR_DEF(MM_CAIO_REQ                     ,"MM_CAIO_REQ                     ",32        , sizeof(CAIO_REQ)                     , LOC_MM_0241);
    MM_MGR_DEF(MM_CAIO_PAGE                    ,"MM_CAIO_PAGE                    ",64        , sizeof(CAIO_PAGE)                    , LOC_MM_0242);
    MM_MGR_DEF(MM_CAIO_DISK                    ,"MM_CAIO_DISK                    ",64        , sizeof(CAIO_DISK)                    , LOC_MM_0243);

    MM_MGR_DEF(MM_CAMD_PAGE                    ,"MM_CAMD_PAGE                    ",256       , sizeof(CAMD_PAGE)                    , LOC_MM_0244);
    MM_MGR_DEF(MM_CAMD_REQ                     ,"MM_CAMD_REQ                     ",256       , sizeof(CAMD_REQ)                     , LOC_MM_0245);
    ...
    MM_MGR_DEF(MM_CDCPGD                       ,"MM_CDCPGD                       ",256       , sizeof(CDCPGD)                       , LOC_MM_0251);

    MM_MGR_DEF(MM_CDCNP                        ,"MM_CDCNP                        ",1         , sizeof(CDCNP)                        , LOC_MM_0252);
    MM_MGR_DEF(MM_CDCNP_FNODE                  ,"MM_CDCNP_FNODE                  ",256       , sizeof(CDCNP_FNODE)                  , LOC_MM_0253);
    MM_MGR_DEF(MM_CDCNP_DNODE                  ,"MM_CDCNP_DNODE                  ",256       , sizeof(CDCNP_DNODE)                  , LOC_MM_0254);
    MM_MGR_DEF(MM_CDCNP_KEY                    ,"MM_CDCNP_KEY                    ",256       , sizeof(CDCNP_KEY)                    , LOC_MM_0255);
    MM_MGR_DEF(MM_CDCNP_ITEM                   ,"MM_CDCNP_ITEM                   ",256       , sizeof(CDCNP_ITEM)                   , LOC_MM_0256);
    MM_MGR_DEF(MM_CDCNP_BITMAP                 ,"MM_CDCNP_BITMAP                 ",256       , sizeof(CDCNP_BITMAP)                 , LOC_MM_0257);
    ...
    MM_MGR_DEF(MM_CMMAP_NODE                   ,"MM_CMMAP_NODE                   ",4         , sizeof(CMMAP_NODE)                   , LOC_MM_0262);
    MM_MGR_DEF(MM_CMSYNC_NODE                  ,"MM_CMSYNC_NODE                  ",4         , sizeof(CMSYNC_NODE)                  , LOC_MM_0263);

    MM_MGR_DEF(MM_CXFSPGB                      ,"MM_CXFSPGB                      ",1        , CXFSPGB_SIZE                        , LOC_MM_0264);
    MM_MGR_DEF(MM_CXFSPGD                      ,"MM_CXFSPGD                      ",256      , sizeof(CXFSPGD)                     , LOC_MM_0265);
    MM_MGR_DEF(MM_CXFSPGV                      ,"MM_CXFSPGV                      ",64       , sizeof(CXFSPGV)                     , LOC_MM_0266);

    MM_MGR_DEF(MM_CXFSDN                       ,"MM_CXFSDN                       ",1        , sizeof(CXFSDN)                      , LOC_MM_0267);

    MM_MGR_DEF(MM_CXFSNP_FNODE                 ,"MM_CXFSNP_FNODE                 ",1        , sizeof(CXFSNP_FNODE)                , LOC_MM_0268);
    MM_MGR_DEF(MM_CXFSNP_DNODE                 ,"MM_CXFSNP_DNODE                 ",1        , sizeof(CXFSNP_DNODE)                , LOC_MM_0269);
    MM_MGR_DEF(MM_CXFSNP_ITEM                  ,"MM_CXFSNP_ITEM                  ",1        , sizeof(CXFSNP_ITEM)                 , LOC_MM_0270);
    MM_MGR_DEF(MM_CXFSNP                       ,"MM_CXFSNP                       ",1        , sizeof(CXFSNP)                      , LOC_MM_0271);
    MM_MGR_DEF(MM_CXFSNP_MGR                   ,"MM_CXFSNP_MGR                   ",1        , sizeof(CXFSNP_MGR)                  , LOC_MM_0272);
    MM_MGR_DEF(MM_CXFSNP_KEY                   ,"MM_CXFSNP_KEY                   ",1        , sizeof(CXFSNP_KEY)                  , LOC_MM_0273);

    MM_MGR_DEF(MM_CXFSCONHASH                  ,"MM_CXFSCONHASH                  ",1         , sizeof(CXFSCONHASH)                , LOC_MM_0274);
    MM_MGR_DEF(MM_CXFSCONHASH_RNODE            ,"MM_CXFSCONHASH_RNODE            ",32        , sizeof(CXFSCONHASH_RNODE)          , LOC_MM_0275);
    MM_MGR_DEF(MM_CXFSCONHASH_VNODE            ,"MM_CXFSCONHASH_VNODE            ",32        , sizeof(CXFSCONHASH_VNODE)          , LOC_MM_0276);

    MM_MGR_DEF(MM_CXFS_LOCKED_FILE             ,"MM_CXFS_LOCKED_FILE             ",32        , sizeof(CXFS_LOCKED_FILE)           , LOC_MM_0277);
    MM_MGR_DEF(MM_CXFS_WAIT_FILE               ,"MM_CXFS_WAIT_FILE               ",256       , sizeof(CXFS_WAIT_FILE)             , LOC_MM_0278);

    MM_MGR_DEF(MM_CXFS_NODE                    ,"MM_CXFS_NODE                    ",256       , sizeof(CXFS_NODE)                  , LOC_MM_0279);
    MM_MGR_DEF(MM_CXFS_HOT_PATH                ,"MM_CXFS_HOT_PATH                ",32        , sizeof(CXFS_HOT_PATH)              , LOC_MM_0280);
    MM_MGR_DEF(MM_CXFSOP_MGR                   ,"MM_CXFSOP_MGR                   ",4         , sizeof(CXFSOP_MGR)                 , LOC_MM_0281);
...
UINT32 destory_static_mem()
{
    ...
    for ( type = 0; type < MM_END; type ++ )
    {
        ...
        MAN_UNLOCK(pMan, LOC_MM_0299);
        MAN_CLEAN_LOCK(pMan, LOC_MM_0300);/*clean lock*/
    }
...
{
    free_static_mem(MM_MM_MAN_OCCUPY_NODE, mm_man_occupy_node, LOC_MM_0304);
    return (0);
}
...
{
    free_static_mem(MM_MM_MAN_LOAD_NODE, mm_man_load_node, LOC_MM_0305);
    return (0);
}
