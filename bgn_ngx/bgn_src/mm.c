...
STATIC_CAST static UINT32 init_mem_manager()
{
    ...
    MM_MGR_DEF(MM_CMON_NODE                    ,"MM_CMON_NODE                    ",256       , sizeof(CMON_NODE)                  , LOC_MM_0216);
    MM_MGR_DEF(MM_CMON_HOT_PATH                ,"MM_CMON_HOT_PATH                ",32        , sizeof(CMON_HOT_PATH)              , LOC_MM_0217);

    MM_MGR_DEF(MM_CCONHASH                     ,"MM_CCONHASH                     ",1         , sizeof(CCONHASH)                   , LOC_MM_0218);
    MM_MGR_DEF(MM_CCONHASH_RNODE               ,"MM_CCONHASH_RNODE               ",32        , sizeof(CCONHASH_RNODE)             , LOC_MM_0219);
    MM_MGR_DEF(MM_CCONHASH_VNODE               ,"MM_CCONHASH_VNODE               ",32        , sizeof(CCONHASH_VNODE)             , LOC_MM_0220);

    MM_MGR_DEF(MM_CSDISC_NODE                  ,"MM_CSDISC_NODE                  ",1         , sizeof(CSDISC_NODE)                , LOC_MM_0221);
    MM_MGR_DEF(MM_CSDISC_SENDER                ,"MM_CSDISC_SENDER                ",1         , sizeof(CSDISC_SENDER)              , LOC_MM_0222);
    MM_MGR_DEF(MM_CSDISC_RECVER                ,"MM_CSDISC_RECVER                ",1         , sizeof(CSDISC_RECVER)              , LOC_MM_0223);

    MM_MGR_DEF(MM_CDNSCACHE_NODE               ,"MM_CDNSCACHE_NODE               ",1         , sizeof(CDNSCACHE_NODE)             , LOC_MM_0224);
    MM_MGR_DEF(MM_CDNSCACHE                    ,"MM_CDNSCACHE                    ",1         , sizeof(CDNSCACHE)                  , LOC_MM_0225);

    MM_MGR_DEF(MM_CEVENTFD_NODE                ,"MM_CEVENTFD_NODE                ",4         , sizeof(CEVENTFD_NODE)              , LOC_MM_0226);

    MM_MGR_DEF(MM_CMAGLEV                      ,"MM_CMAGLEV                      ",1         , sizeof(CMAGLEV)                    , LOC_MM_0227);
    MM_MGR_DEF(MM_CMAGLEV_RNODE                ,"MM_CMAGLEV_RNODE                ",1         , sizeof(CMAGLEV_RNODE)              , LOC_MM_0228);
    MM_MGR_DEF(MM_CMAGLEV_QNODE                ,"MM_CMAGLEV_QNODE                ",2         , sizeof(CMAGLEV_QNODE)              , LOC_MM_0229);
...
{
    free_static_mem(MM_MM_MAN_OCCUPY_NODE, mm_man_occupy_node, LOC_MM_0259);
    return (0);
}
...
{
    free_static_mem(MM_MM_MAN_LOAD_NODE, mm_man_load_node, LOC_MM_0260);
    return (0);
}
