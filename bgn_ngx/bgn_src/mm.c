...
STATIC_CAST static UINT32 init_mem_manager()
{
    ...
    MM_MGR_DEF(MM_CCALLBACK_NODE               ,"MM_CCALLBACK_NODE               ",256       , sizeof(CCALLBACK_NODE)             , LOC_MM_0149);

    MM_MGR_DEF(MM_CTDNSNP_ITEM                 ,"MM_CTDNSNP_ITEM                 ",256       , sizeof(CTDNSNP_ITEM)                 , LOC_MM_0150);
    MM_MGR_DEF(MM_CTDNSNP                      ,"MM_CTDNSNP                      ",256       , sizeof(CTDNSNP)                      , LOC_MM_0151);
    MM_MGR_DEF(MM_CTDNSNP_MGR                  ,"MM_CTDNSNP_MGR                  ",256       , sizeof(CTDNSNP_MGR)                  , LOC_MM_0152);
    MM_MGR_DEF(MM_CTDNSSV_ITEM                 ,"MM_CTDNSSV_ITEM                 ",256       , sizeof(CTDNSSV_ITEM)                 , LOC_MM_0153);
    MM_MGR_DEF(MM_CTDNSSV_NODE                 ,"MM_CTDNSSV_NODE                 ",256       , sizeof(CTDNSSV_NODE)                 , LOC_MM_0154);
    MM_MGR_DEF(MM_CTDNSSV_NODE_MGR             ,"MM_CTDNSSV_NODE_MGR             ",1         , sizeof(CTDNSSV_NODE_MGR)             , LOC_MM_0155);
    MM_MGR_DEF(MM_CTDNSSV_MGR                  ,"MM_CTDNSSV_MGR                  ",256       , sizeof(CTDNSSV_MGR)                  , LOC_MM_0156);
    MM_MGR_DEF(MM_CTDNSSV                      ,"MM_CTDNSSV                      ",256       , sizeof(CTDNSSV)                      , LOC_MM_0157);

    MM_MGR_DEF(MM_CDETECTN_ORIG_NODE           ,"MM_CDETECTN_ORIG_NODE           ",256      , sizeof(CDETECTN_ORIG_NODE)           , LOC_MM_0158);
    MM_MGR_DEF(MM_CDETECTN_IP_NODE             ,"MM_CDETECTN_IP_NODE             ",256      , sizeof(CDETECTN_IP_NODE)             , LOC_MM_0159);
    MM_MGR_DEF(MM_CDETECTN_STATUS_RANGE        ,"MM_CDETECTN_STATUS_RANGE        ",256      , sizeof(CDETECTN_STATUS_RANGE)        , LOC_MM_0160);
    MM_MGR_DEF(MM_CDETECTN_DOMAIN_NODE         ,"MM_CDETECTN_DOMAIN_NODE         ",256      , sizeof(CDETECTN_DOMAIN_NODE)         , LOC_MM_0161);

    MM_MGR_DEF(MM_CP2P_FILE                    ,"MM_CP2P_FILE                    ",256       , sizeof(CP2P_FILE)                    , LOC_MM_0162);
    MM_MGR_DEF(MM_CP2P_CMD                     ,"MM_CP2P_CMD                     ",256       , sizeof(CP2P_CMD)                     , LOC_MM_0163);

    MM_MGR_DEF(MM_CAGENT                       ,"MM_CAGENT                       ",1         , sizeof(CAGENT)                       , LOC_MM_0164);
    MM_MGR_DEF(MM_CPING_NODE                   ,"MM_CPING_NODE                   ",1         , sizeof(CPING_NODE)                   , LOC_MM_0165);

    MM_MGR_DEF(MM_CTDNS_SUSV_NODE              ,"MM_CTDNS_SUSV_NODE              ",1         , sizeof(CTDNS_SUSV_NODE)              , LOC_MM_0166);

    MM_MGR_DEF(MM_CMCDN                        ,"MM_CMCDN                        ",1         , sizeof(CMCDN)                        , LOC_MM_0167);
    MM_MGR_DEF(MM_CMCPGV                       ,"MM_CMCPGV                       ",1         , sizeof(CMCPGV)                       , LOC_MM_0168);
    MM_MGR_DEF(MM_CMCPGD                       ,"MM_CMCPGD                       ",256       , sizeof(CMCPGD)                       , LOC_MM_0169);

    MM_MGR_DEF(MM_CMCNP                        ,"MM_CMCNP                        ",1         , sizeof(CMCNP)                        , LOC_MM_0170);
    MM_MGR_DEF(MM_CMCNP_FNODE                  ,"MM_CMCNP_FNODE                  ",256       , sizeof(CMCNP_FNODE)                  , LOC_MM_0171);
    MM_MGR_DEF(MM_CMCNP_DNODE                  ,"MM_CMCNP_DNODE                  ",256       , sizeof(CMCNP_DNODE)                  , LOC_MM_0172);
    MM_MGR_DEF(MM_CMCNP_KEY                    ,"MM_CMCNP_KEY                    ",256       , sizeof(CMCNP_KEY)                    , LOC_MM_0173);
    MM_MGR_DEF(MM_CMCNP_ITEM                   ,"MM_CMCNP_ITEM                   ",256       , sizeof(CMCNP_ITEM)                   , LOC_MM_0174);
    MM_MGR_DEF(MM_CMCNP_BITMAP                 ,"MM_CMCNP_BITMAP                 ",256       , sizeof(CMCNP_BITMAP)                 , LOC_MM_0175);

    MM_MGR_DEF(MM_CAIO_NODE                    ,"MM_CAIO_NODE                    ",32        , sizeof(CAIO_NODE)                    , LOC_MM_0176);
    MM_MGR_DEF(MM_CAIO_REQ                     ,"MM_CAIO_REQ                     ",32        , sizeof(CAIO_REQ)                     , LOC_MM_0177);
    MM_MGR_DEF(MM_CAIO_PAGE                    ,"MM_CAIO_PAGE                    ",64        , sizeof(CAIO_PAGE)                    , LOC_MM_0178);
    MM_MGR_DEF(MM_CAIO_DISK                    ,"MM_CAIO_DISK                    ",64        , sizeof(CAIO_DISK)                    , LOC_MM_0179);

    MM_MGR_DEF(MM_CAMD_PAGE                    ,"MM_CAMD_PAGE                    ",256       , sizeof(CAMD_PAGE)                    , LOC_MM_0180);
    MM_MGR_DEF(MM_CAMD_REQ                     ,"MM_CAMD_REQ                     ",256       , sizeof(CAMD_REQ)                     , LOC_MM_0181);
    MM_MGR_DEF(MM_CAMD_NODE                    ,"MM_CAMD_NODE                    ",256       , sizeof(CAMD_NODE)                    , LOC_MM_0182);
    MM_MGR_DEF(MM_CAMD_SATA                    ,"MM_CAMD_SATA                    ",256       , sizeof(CAMD_SATA)                    , LOC_MM_0183);
    MM_MGR_DEF(MM_CAMD_SSD                     ,"MM_CAMD_SSD                     ",256       , sizeof(CAMD_SSD)                     , LOC_MM_0184);
    MM_MGR_DEF(MM_CAMD_COND                    ,"MM_CAMD_COND                    ",256       , sizeof(CAMD_COND)                    , LOC_MM_0185);
    MM_MGR_DEF(MM_CAMD_FILE_REQ                ,"MM_CAMD_FILE_REQ                ",256       , sizeof(CAMD_FILE_REQ)                , LOC_MM_0186);
    MM_MGR_DEF(MM_CDIO_FILE_REQ                ,"MM_CDIO_FILE_REQ                ",256       , sizeof(CDIO_FILE_REQ)                , LOC_MM_0187);
    MM_MGR_DEF(MM_CDCDN                        ,"MM_CDCDN                        ",1         , sizeof(CDCDN)                        , LOC_MM_0188);
    MM_MGR_DEF(MM_CDCPGV                       ,"MM_CDCPGV                       ",1         , sizeof(CDCPGV)                       , LOC_MM_0189);
    MM_MGR_DEF(MM_CDCPGD                       ,"MM_CDCPGD                       ",256       , sizeof(CDCPGD)                       , LOC_MM_0190);

    MM_MGR_DEF(MM_CDCNP                        ,"MM_CDCNP                        ",1         , sizeof(CDCNP)                        , LOC_MM_0191);
    MM_MGR_DEF(MM_CDCNP_FNODE                  ,"MM_CDCNP_FNODE                  ",256       , sizeof(CDCNP_FNODE)                  , LOC_MM_0192);
    MM_MGR_DEF(MM_CDCNP_DNODE                  ,"MM_CDCNP_DNODE                  ",256       , sizeof(CDCNP_DNODE)                  , LOC_MM_0193);
    MM_MGR_DEF(MM_CDCNP_KEY                    ,"MM_CDCNP_KEY                    ",256       , sizeof(CDCNP_KEY)                    , LOC_MM_0194);
    MM_MGR_DEF(MM_CDCNP_ITEM                   ,"MM_CDCNP_ITEM                   ",256       , sizeof(CDCNP_ITEM)                   , LOC_MM_0195);
    MM_MGR_DEF(MM_CDCNP_BITMAP                 ,"MM_CDCNP_BITMAP                 ",256       , sizeof(CDCNP_BITMAP)                 , LOC_MM_0196);

    MM_MGR_DEF(MM_CDC_PAGE                     ,"MM_CDC_PAGE                     ",256       , sizeof(CDC_PAGE)                     , LOC_MM_0197);
    MM_MGR_DEF(MM_CDC_REQ                      ,"MM_CDC_REQ                      ",256       , sizeof(CDC_REQ)                      , LOC_MM_0198);
    MM_MGR_DEF(MM_CDC_NODE                     ,"MM_CDC_NODE                     ",256       , sizeof(CDC_NODE)                     , LOC_MM_0199);
    MM_MGR_DEF(MM_CFC                          ,"MM_CFC                          ",4         , sizeof(CFC)                          , LOC_MM_0200);

    MM_MGR_DEF(MM_CMMAP_NODE                   ,"MM_CMMAP_NODE                   ",4         , sizeof(CMMAP_NODE)                   , LOC_MM_0201);
    MM_MGR_DEF(MM_CMSYNC_NODE                  ,"MM_CMSYNC_NODE                  ",4         , sizeof(CMSYNC_NODE)                  , LOC_MM_0202);

    MM_MGR_DEF(MM_CXFSPGB                      ,"MM_CXFSPGB                      ",1        , CXFSPGB_SIZE                        , LOC_MM_0203);
    MM_MGR_DEF(MM_CXFSPGD                      ,"MM_CXFSPGD                      ",256      , sizeof(CXFSPGD)                     , LOC_MM_0204);
    MM_MGR_DEF(MM_CXFSPGV                      ,"MM_CXFSPGV                      ",64       , sizeof(CXFSPGV)                     , LOC_MM_0205);

    MM_MGR_DEF(MM_CXFSDN                       ,"MM_CXFSDN                       ",1        , sizeof(CXFSDN)                      , LOC_MM_0206);

    MM_MGR_DEF(MM_CXFSNP_FNODE                 ,"MM_CXFSNP_FNODE                 ",1        , sizeof(CXFSNP_FNODE)                , LOC_MM_0207);
    MM_MGR_DEF(MM_CXFSNP_DNODE                 ,"MM_CXFSNP_DNODE                 ",1        , sizeof(CXFSNP_DNODE)                , LOC_MM_0208);
    MM_MGR_DEF(MM_CXFSNP_ITEM                  ,"MM_CXFSNP_ITEM                  ",1        , sizeof(CXFSNP_ITEM)                 , LOC_MM_0209);
    MM_MGR_DEF(MM_CXFSNP                       ,"MM_CXFSNP                       ",1        , sizeof(CXFSNP)                      , LOC_MM_0210);
    MM_MGR_DEF(MM_CXFSNP_MGR                   ,"MM_CXFSNP_MGR                   ",1        , sizeof(CXFSNP_MGR)                  , LOC_MM_0211);
    MM_MGR_DEF(MM_CXFSNP_KEY                   ,"MM_CXFSNP_KEY                   ",1        , sizeof(CXFSNP_KEY)                  , LOC_MM_0212);

    MM_MGR_DEF(MM_CXFS_LOCKED_FILE             ,"MM_CXFS_LOCKED_FILE             ",32        , sizeof(CXFS_LOCKED_FILE)           , LOC_MM_0213);
    MM_MGR_DEF(MM_CXFS_WAIT_FILE               ,"MM_CXFS_WAIT_FILE               ",256       , sizeof(CXFS_WAIT_FILE)             , LOC_MM_0214);
    ...
    MM_MGR_DEF(MM_CXFSNBD_SEG                  ,"MM_CXFSNBD_SEG                  ",32        , sizeof(CXFSNBD_SEG)                , LOC_MM_0218);

    MM_MGR_DEF(MM_CXFSC_RNODE                  ,"MM_CXFSC_RNODE                  ",32        , sizeof(CXFSC_RNODE)                , LOC_MM_0219);

    MM_MGR_DEF(MM_CMON_NODE                    ,"MM_CMON_NODE                    ",256       , sizeof(CMON_NODE)                  , LOC_MM_0220);
    MM_MGR_DEF(MM_CMON_HOT_PATH                ,"MM_CMON_HOT_PATH                ",32        , sizeof(CMON_HOT_PATH)              , LOC_MM_0221);

    MM_MGR_DEF(MM_CCONHASH                     ,"MM_CCONHASH                     ",1         , sizeof(CCONHASH)                   , LOC_MM_0222);
    MM_MGR_DEF(MM_CCONHASH_RNODE               ,"MM_CCONHASH_RNODE               ",32        , sizeof(CCONHASH_RNODE)             , LOC_MM_0223);
    MM_MGR_DEF(MM_CCONHASH_VNODE               ,"MM_CCONHASH_VNODE               ",32        , sizeof(CCONHASH_VNODE)             , LOC_MM_0224);

    MM_MGR_DEF(MM_CSDISC_NODE                  ,"MM_CSDISC_NODE                  ",1         , sizeof(CSDISC_NODE)                , LOC_MM_0225);
    MM_MGR_DEF(MM_CSDISC_SENDER                ,"MM_CSDISC_SENDER                ",1         , sizeof(CSDISC_SENDER)              , LOC_MM_0226);
    MM_MGR_DEF(MM_CSDISC_RECVER                ,"MM_CSDISC_RECVER                ",1         , sizeof(CSDISC_RECVER)              , LOC_MM_0227);

    MM_MGR_DEF(MM_CDNSCACHE_NODE               ,"MM_CDNSCACHE_NODE               ",1         , sizeof(CDNSCACHE_NODE)             , LOC_MM_0228);
    MM_MGR_DEF(MM_CDNSCACHE                    ,"MM_CDNSCACHE                    ",1         , sizeof(CDNSCACHE)                  , LOC_MM_0229);

    MM_MGR_DEF(MM_CEVENTFD_NODE                ,"MM_CEVENTFD_NODE                ",4         , sizeof(CEVENTFD_NODE)              , LOC_MM_0230);

    MM_MGR_DEF(MM_CMAGLEV                      ,"MM_CMAGLEV                      ",1         , sizeof(CMAGLEV)                    , LOC_MM_0231);
    MM_MGR_DEF(MM_CMAGLEV_RNODE                ,"MM_CMAGLEV_RNODE                ",1         , sizeof(CMAGLEV_RNODE)              , LOC_MM_0232);
    MM_MGR_DEF(MM_CMAGLEV_QNODE                ,"MM_CMAGLEV_QNODE                ",2         , sizeof(CMAGLEV_QNODE)              , LOC_MM_0233);
...
{
    free_static_mem(MM_MM_MAN_OCCUPY_NODE, mm_man_occupy_node, LOC_MM_0263);
    return (0);
}
...
{
    free_static_mem(MM_MM_MAN_LOAD_NODE, mm_man_load_node, LOC_MM_0264);
    return (0);
}
