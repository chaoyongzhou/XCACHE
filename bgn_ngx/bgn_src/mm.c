...
STATIC_CAST static UINT32 init_mem_manager()
{
    ...
    MM_MGR_DEF(MM_CRFSNP_KEY                   ,"MM_CRFSNP_KEY                   ",1        , sizeof(CRFSNP_KEY)                  , LOC_MM_0138);
    ...
    MM_MGR_DEF(MM_CRFSCHTTP_NODE               ,"MM_CRFSCHTTP_NODE               ",32        , sizeof(CRFSCHTTP_NODE)             , LOC_MM_0160);

    MM_MGR_DEF(MM_CEXPAT_ATTR                  ,"MM_CEXPAT_ATTR                  ",256       , sizeof(CEXPAT_ATTR)                , LOC_MM_0161);
    MM_MGR_DEF(MM_CEXPAT_NODE                  ,"MM_CEXPAT_NODE                  ",256       , sizeof(CEXPAT_NODE)                , LOC_MM_0162);
    MM_MGR_DEF(MM_CRFS_LOCKED_FILE             ,"MM_CRFS_LOCKED_FILE             ",32        , sizeof(CRFS_LOCKED_FILE)           , LOC_MM_0163);
    MM_MGR_DEF(MM_CHTTP_NODE                   ,"MM_CHTTP_NODE                   ",256       , sizeof(CHTTP_NODE)                 , LOC_MM_0164);

    MM_MGR_DEF(MM_TASK_RUNNER_NODE             ,"MM_TASK_RUNNER_NODE             ",4         , sizeof(TASK_RUNNER_NODE)           , LOC_MM_0165);

    MM_MGR_DEF(MM_CHTTP_REQ                    ,"MM_CHTTP_REQ                    ",32        , sizeof(CHTTP_REQ)                  , LOC_MM_0166);
    MM_MGR_DEF(MM_CHTTP_RSP                    ,"MM_CHTTP_RSP                    ",32        , sizeof(CHTTP_RSP)                  , LOC_MM_0167);
    MM_MGR_DEF(MM_CHTTP_REST                   ,"MM_CHTTP_REST                   ",32        , sizeof(CHTTP_REST)                 , LOC_MM_0168);

    MM_MGR_DEF(MM_CDNS_NODE                    ,"MM_CDNS_NODE                    ",32        , sizeof(CDNS_NODE)                  , LOC_MM_0169);
    MM_MGR_DEF(MM_CDNS_REQ                     ,"MM_CDNS_REQ                     ",32        , sizeof(CDNS_REQ)                   , LOC_MM_0170);
    MM_MGR_DEF(MM_CDNS_RSP                     ,"MM_CDNS_RSP                     ",32        , sizeof(CDNS_RSP)                   , LOC_MM_0171);
    MM_MGR_DEF(MM_CDNS_RSP_NODE                ,"MM_CDNS_RSP_NODE                ",32        , sizeof(CDNS_RSP_NODE)              , LOC_MM_0172);

    MM_MGR_DEF(MM_CHTTP_STAT                   ,"MM_CHTTP_STAT                   ",256       , sizeof(CHTTP_STAT)                 , LOC_MM_0173);
    MM_MGR_DEF(MM_SUPER_CCOND                  ,"MM_SUPER_CCOND                  ",256       , sizeof(SUPER_CCOND)                , LOC_MM_0174);

    MM_MGR_DEF(MM_COROUTINE_CHECKER            ,"MM_COROUTINE_CHECKER            ",256       , sizeof(COROUTINE_CHECKER)          , LOC_MM_0175);
    MM_MGR_DEF(MM_COROUTINE_CLEANER            ,"MM_COROUTINE_CLEANER            ",256       , sizeof(COROUTINE_CLEANER)          , LOC_MM_0176);

    MM_MGR_DEF(MM_COROUTINE_COND               ,"MM_COROUTINE_COND               ",256       , sizeof(COROUTINE_COND)             , LOC_MM_0177);
    MM_MGR_DEF(MM_CHTTP_STORE                  ,"MM_CHTTP_STORE                  ",256       , sizeof(CHTTP_STORE)                , LOC_MM_0178);

    MM_MGR_DEF(MM_CRFS_WAIT_FILE               ,"MM_CRFS_WAIT_FILE               ",256       , sizeof(CRFS_WAIT_FILE)             , LOC_MM_0179);

    MM_MGR_DEF(MM_CCONNP                       ,"MM_CCONNP                       ",256       , sizeof(CCONNP)                     , LOC_MM_0180);
    MM_MGR_DEF(MM_CCONNP_MGR                   ,"MM_CCONNP_MGR                   ",256       , sizeof(CCONNP_MGR)                 , LOC_MM_0181);
    MM_MGR_DEF(MM_CRFS_NODE                    ,"MM_CRFS_NODE                    ",256       , sizeof(CRFS_NODE)                  , LOC_MM_0182);
    MM_MGR_DEF(MM_CRFS_HOT_PATH                ,"MM_CRFS_HOT_PATH                ",32        , sizeof(CRFS_HOT_PATH)              , LOC_MM_0183);
    MM_MGR_DEF(MM_CHTTPS_NODE                  ,"MM_CHTTPS_NODE                  ",256       , sizeof(CHTTPS_NODE)                , LOC_MM_0184);
    MM_MGR_DEF(MM_CHTTPS_REST                  ,"MM_CHTTPS_REST                  ",256       , sizeof(CHTTPS_REST)                , LOC_MM_0185);
    MM_MGR_DEF(MM_CSSL_NODE                    ,"MM_CSSL_NODE                    ",256       , sizeof(CSSL_NODE)                  , LOC_MM_0186);

    MM_MGR_DEF(MM_CHFS_LOCKED_FILE             ,"MM_CHFS_LOCKED_FILE             ",32        , sizeof(CHFS_LOCKED_FILE)           , LOC_MM_0187);
    MM_MGR_DEF(MM_CHFS_WAIT_FILE               ,"MM_CHFS_WAIT_FILE               ",256       , sizeof(CHFS_WAIT_FILE)             , LOC_MM_0188);

    MM_MGR_DEF(MM_CHFSCONHASH                  ,"MM_CHFSCONHASH                  ",1         , sizeof(CHFSCONHASH)                , LOC_MM_0189);
    MM_MGR_DEF(MM_CHFSCONHASH_RNODE            ,"MM_CHFSCONHASH_RNODE            ",32        , sizeof(CHFSCONHASH_RNODE)          , LOC_MM_0190);
    MM_MGR_DEF(MM_CHFSCONHASH_VNODE            ,"MM_CHFSCONHASH_VNODE            ",32        , sizeof(CHFSCONHASH_VNODE)          , LOC_MM_0191);
    MM_MGR_DEF(MM_CHFS_NODE                    ,"MM_CHFS_NODE                    ",256       , sizeof(CHFS_NODE)                  , LOC_MM_0192);

    MM_MGR_DEF(MM_CSFSDN                       ,"MM_CSFSDN                       ",256       , sizeof(CSFSDN)                     , LOC_MM_0193);
    MM_MGR_DEF(MM_CSFSDN_NODE                  ,"MM_CSFSDN_NODE                  ",256       , sizeof(CSFSDN_NODE)                , LOC_MM_0194);
    MM_MGR_DEF(MM_CSFSB                        ,"MM_CSFSB                        ",1         , sizeof(CSFSB)                      , LOC_MM_0195);
    MM_MGR_DEF(MM_CSFSD                        ,"MM_CSFSD                        ",256       , sizeof(CSFSD)                      , LOC_MM_0196);
    MM_MGR_DEF(MM_CSFSV                        ,"MM_CSFSV                        ",256       , sizeof(CSFSV)                      , LOC_MM_0197);
    MM_MGR_DEF(MM_CSFS_LOCKED_FILE             ,"MM_CSFS_LOCKED_FILE             ",32        , sizeof(CSFS_LOCKED_FILE)           , LOC_MM_0198);
    MM_MGR_DEF(MM_CSFS_WAIT_FILE               ,"MM_CSFS_WAIT_FILE               ",256       , sizeof(CSFS_WAIT_FILE)             , LOC_MM_0199);
    MM_MGR_DEF(MM_CSFSNP                       ,"MM_CSFSNP                       ",1        , sizeof(CSFSNP)                      , LOC_MM_0200);
    MM_MGR_DEF(MM_CSFSNP_MGR                   ,"MM_CSFSNP_MGR                   ",1        , sizeof(CSFSNP_MGR)                  , LOC_MM_0201);

    MM_MGR_DEF(MM_CSFSCONHASH                  ,"MM_CSFSCONHASH                  ",1         , sizeof(CSFSCONHASH)                , LOC_MM_0202);
    MM_MGR_DEF(MM_CSFSCONHASH_RNODE            ,"MM_CSFSCONHASH_RNODE            ",32        , sizeof(CSFSCONHASH_RNODE)          , LOC_MM_0203);
    MM_MGR_DEF(MM_CSFSCONHASH_VNODE            ,"MM_CSFSCONHASH_VNODE            ",32        , sizeof(CSFSCONHASH_VNODE)          , LOC_MM_0204);
    MM_MGR_DEF(MM_CSFS_NODE                    ,"MM_CSFS_NODE                    ",256       , sizeof(CSFS_NODE)                  , LOC_MM_0205);

    MM_MGR_DEF(MM_CRANGE_SEG                   ,"MM_CRANGE_SEG                   ",32        , sizeof(CRANGE_SEG)                 , LOC_MM_0206);
    MM_MGR_DEF(MM_CRANGE_NODE                  ,"MM_CRANGE_NODE                  ",32        , sizeof(CRANGE_NODE)                , LOC_MM_0207);
    MM_MGR_DEF(MM_CRANGE_MGR                   ,"MM_CRANGE_MGR                   ",32        , sizeof(CRANGE_MGR)                 , LOC_MM_0208);

#if (SWITCH_ON == NGX_BGN_SWITCH)
    MM_MGR_DEF(MM_CNGX_RANGE                   ,"MM_CNGX_RANGE                   ",32        , sizeof(CNGX_RANGE)                 , LOC_MM_0209);
    MM_MGR_DEF(MM_CNGX_HTTP_BGN_MOD            ,"MM_CNGX_HTTP_BGN_MOD            ",32        , sizeof(CNGX_HTTP_BGN_MOD)          , LOC_MM_0210);
#endif/*(SWITCH_ON == NGX_BGN_SWITCH)*/

    MM_MGR_DEF(MM_CCALLBACK_NODE               ,"MM_CCALLBACK_NODE               ",256       , sizeof(CCALLBACK_NODE)             , LOC_MM_0211);

#if (SWITCH_ON == NGX_BGN_SWITCH)
    MM_MGR_DEF(MM_CNGX_KSSL_NODE               ,"MM_CNGX_KSSL_NODE               ",32        , sizeof(CNGX_KSSL_NODE)             , LOC_MM_0212);
#endif/*(SWITCH_ON == NGX_BGN_SWITCH)*/

    MM_MGR_DEF(MM_CTDNSNP_ITEM                  ,"MM_CTDNSNP_ITEM                ",256       , sizeof(CTDNSNP_ITEM)                 , LOC_MM_0213);
    MM_MGR_DEF(MM_CTDNSNP                       ,"MM_CTDNSNP                     ",256       , sizeof(CTDNSNP)                      , LOC_MM_0214);
    MM_MGR_DEF(MM_CTDNSNP_MGR                   ,"MM_CTDNSNP_MGR                 ",256       , sizeof(CTDNSNP_MGR)                  , LOC_MM_0215);
    MM_MGR_DEF(MM_CTDNSSV_ITEM                  ,"MM_CTDNSSV_ITEM                ",256       , sizeof(CTDNSSV_ITEM)                 , LOC_MM_0216);
    MM_MGR_DEF(MM_CTDNSSV_NODE                  ,"MM_CTDNSSV_NODE                ",256       , sizeof(CTDNSSV_NODE)                 , LOC_MM_0217);
    MM_MGR_DEF(MM_CTDNSSV_NODE_MGR              ,"MM_CTDNSSV_NODE_MGR            ",1         , sizeof(CTDNSSV_NODE_MGR)             , LOC_MM_0218);
    MM_MGR_DEF(MM_CTDNSSV_MGR                   ,"MM_CTDNSSV_MGR                 ",256       , sizeof(CTDNSSV_MGR)                  , LOC_MM_0219);
    MM_MGR_DEF(MM_CTDNSSV                       ,"MM_CTDNSSV                     ",256       , sizeof(CTDNSSV)                      , LOC_MM_0220);
    ...
    MM_MGR_DEF(MM_CDETECTN_DOMAIN_NODE          ,"MM_CDETECTN_DOMAIN_NODE         ",256      , sizeof(CDETECTN_DOMAIN_NODE)         , LOC_MM_0224);
    ...
    MM_MGR_DEF(MM_CMCDN                        ,"MM_CMCDN                        ",1         , sizeof(CMCDN)                        , LOC_MM_0230);
    MM_MGR_DEF(MM_CMCPGV                       ,"MM_CMCPGV                       ",1         , sizeof(CMCPGV)                       , LOC_MM_0231);
    MM_MGR_DEF(MM_CMCPGD                       ,"MM_CMCPGD                       ",256       , sizeof(CMCPGD)                       , LOC_MM_0232);

    MM_MGR_DEF(MM_CMCNP                        ,"MM_CMCNP                        ",1         , sizeof(CMCNP)                        , LOC_MM_0233);
    MM_MGR_DEF(MM_CMCNP_FNODE                  ,"MM_CMCNP_FNODE                  ",256       , sizeof(CMCNP_FNODE)                  , LOC_MM_0234);
    MM_MGR_DEF(MM_CMCNP_DNODE                  ,"MM_CMCNP_DNODE                  ",256       , sizeof(CMCNP_DNODE)                  , LOC_MM_0235);
    MM_MGR_DEF(MM_CMCNP_KEY                    ,"MM_CMCNP_KEY                    ",256       , sizeof(CMCNP_KEY)                    , LOC_MM_0236);
    MM_MGR_DEF(MM_CMCNP_ITEM                   ,"MM_CMCNP_ITEM                   ",256       , sizeof(CMCNP_ITEM)                   , LOC_MM_0237);
    MM_MGR_DEF(MM_CMCNP_BITMAP                 ,"MM_CMCNP_BITMAP                 ",256       , sizeof(CMCNP_BITMAP)                 , LOC_MM_0238);
...
UINT32 destory_static_mem()
{
    ...
    for ( type = 0; type < MM_END; type ++ )
    {
        ...
        MAN_UNLOCK(pMan, LOC_MM_0275);
        MAN_CLEAN_LOCK(pMan, LOC_MM_0276);/*clean lock*/
    }
...
{
    free_static_mem(MM_MM_MAN_OCCUPY_NODE, mm_man_occupy_node, LOC_MM_0280);
    return (0);
}
...
{
    free_static_mem(MM_MM_MAN_LOAD_NODE, mm_man_load_node, LOC_MM_0281);
    return (0);
}
