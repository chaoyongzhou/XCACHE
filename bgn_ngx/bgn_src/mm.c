...
STATIC_CAST static UINT32 init_mem_manager()
{
    ...
    MM_MGR_DEF(MM_CBYTES                       ,"MM_CBYTES                       ",4        , sizeof(CBYTES)                      , LOC_MM_0091);
    MM_MGR_DEF(MM_CBITMAP                      ,"MM_CBITMAP                      ",1        , sizeof(CBITMAP)                     , LOC_MM_0092);

    MM_MGR_DEF(MM_CBTIMER_NODE                 ,"MM_CBTIMER_NODE                 ",4        , sizeof(CBTIMER_NODE)                , LOC_MM_0093);
    MM_MGR_DEF(MM_CLUSTER_NODE_CFG             ,"MM_CLUSTER_NODE_CFG             ",4        , sizeof(CLUSTER_NODE_CFG)            , LOC_MM_0094);
    MM_MGR_DEF(MM_CLUSTER_CFG                  ,"MM_CLUSTER_CFG                  ",4        , sizeof(CLUSTER_CFG)                 , LOC_MM_0095);
    MM_MGR_DEF(MM_CPARACFG                     ,"MM_CPARACFG                     ",1        , sizeof(CPARACFG)                    , LOC_MM_0096);
    MM_MGR_DEF(MM_MCAST_CFG                    ,"MM_MCAST_CFG                    ",1        , sizeof(MCAST_CFG)                   , LOC_MM_0097);
    MM_MGR_DEF(MM_BCAST_DHCP_CFG               ,"MM_BCAST_DHCP_CFG               ",1        , sizeof(BCAST_DHCP_CFG)              , LOC_MM_0098);
    MM_MGR_DEF(MM_MACIP_CFG                    ,"MM_MACIP_CFG                    ",4        , sizeof(MACIP_CFG)                   , LOC_MM_0099);
    MM_MGR_DEF(MM_SYS_CFG                      ,"MM_SYS_CFG                      ",1        , sizeof(SYS_CFG)                     , LOC_MM_0100);

    MM_MGR_DEF(MM_SUPER_FNODE                  ,"MM_SUPER_FNODE                  ",1        , sizeof(SUPER_FNODE)                 , LOC_MM_0101);

    MM_MGR_DEF(MM_CMAP_NODE                    ,"MM_CMAP_NODE                    ",4        , sizeof(CMAP_NODE)                   , LOC_MM_0102);
    MM_MGR_DEF(MM_CMAP                         ,"MM_CMAP                         ",4        , sizeof(CMAP)                        , LOC_MM_0103);
    MM_MGR_DEF(MM_CSESSION_NODE                ,"MM_CSESSION_NODE                ",4        , sizeof(CSESSION_NODE)               , LOC_MM_0104);
    MM_MGR_DEF(MM_CSESSION_ITEM                ,"MM_CSESSION_ITEM                ",4        , sizeof(CSESSION_ITEM)               , LOC_MM_0105);
    MM_MGR_DEF(MM_CTIMET                       ,"MM_CTIMET                       ",4        , sizeof(CTIMET)                      , LOC_MM_0106);

    MM_MGR_DEF(MM_COROUTINE_TASK               ,"MM_COROUTINE_TASK               ",4        , sizeof(COROUTINE_TASK)              , LOC_MM_0107);
    MM_MGR_DEF(MM_COROUTINE_NODE               ,"MM_COROUTINE_NODE               ",4        , sizeof(COROUTINE_NODE)              , LOC_MM_0108);
    MM_MGR_DEF(MM_COROUTINE_POOL               ,"MM_COROUTINE_POOL               ",4        , sizeof(COROUTINE_POOL)              , LOC_MM_0109);

    MM_MGR_DEF(MM_CRFSDN_NODE                  ,"MM_CRFSDN_NODE                  ",4        , sizeof(CRFSDN_NODE)                 , LOC_MM_0110);
    MM_MGR_DEF(MM_CRFSDN                       ,"MM_CRFSDN                       ",1        , sizeof(CRFSDN)                      , LOC_MM_0111);

    MM_MGR_DEF(MM_CPGB                         ,"MM_CPGB                         ",1        , CPGB_SIZE                           , LOC_MM_0112);
    MM_MGR_DEF(MM_CPGD                         ,"MM_CPGD                         ",256      , sizeof(CPGD)                        , LOC_MM_0113);
    MM_MGR_DEF(MM_CPGV                         ,"MM_CPGV                         ",64       , sizeof(CPGV)                        , LOC_MM_0114);

    MM_MGR_DEF(MM_CRB_NODE                     ,"MM_CRB_NODE                     ",64       , sizeof(CRB_NODE)                    , LOC_MM_0115);
    MM_MGR_DEF(MM_CRB_TREE                     ,"MM_CRB_TREE                     ",1        , sizeof(CRB_TREE)                    , LOC_MM_0116);

    MM_MGR_DEF(MM_CRFSNP_FNODE                 ,"MM_CRFSNP_FNODE                 ",1        , sizeof(CRFSNP_FNODE)                , LOC_MM_0117);
    MM_MGR_DEF(MM_CRFSNP_DNODE                 ,"MM_CRFSNP_DNODE                 ",1        , sizeof(CRFSNP_DNODE)                , LOC_MM_0118);
    MM_MGR_DEF(MM_CRFSNP_ITEM                  ,"MM_CRFSNP_ITEM                  ",1        , sizeof(CRFSNP_ITEM)                 , LOC_MM_0119);
    MM_MGR_DEF(MM_CRFSNP                       ,"MM_CRFSNP                       ",1        , sizeof(CRFSNP)                      , LOC_MM_0120);
    MM_MGR_DEF(MM_CRFSNP_MGR                   ,"MM_CRFSNP_MGR                   ",1        , sizeof(CRFSNP_MGR)                  , LOC_MM_0121);
    ...
    MM_MGR_DEF(MM_CSEM                         ,"MM_CSEM                         ",32        , sizeof(CSEM)                       , LOC_MM_0130);

    MM_MGR_DEF(MM_CSTRKV                       ,"MM_CSTRKV                       ",32        , sizeof(CSTRKV)                     , LOC_MM_0131);
    MM_MGR_DEF(MM_CSTRKV_MGR                   ,"MM_CSTRKV_MGR                   ",32        , sizeof(CSTRKV_MGR)                 , LOC_MM_0132);
    MM_MGR_DEF(MM_CBUFFER                      ,"MM_CBUFFER                      ",32        , sizeof(CBUFFER)                    , LOC_MM_0133);
    MM_MGR_DEF(MM_CHUNK                        ,"MM_CHUNK                        ",32        , sizeof(CHUNK)                      , LOC_MM_0134);
    MM_MGR_DEF(MM_CHUNK_MGR                    ,"MM_CHUNK_MGR                    ",32        , sizeof(CHUNK_MGR)                  , LOC_MM_0135);

    MM_MGR_DEF(MM_CMD5_DIGEST                  ,"MM_CMD5_DIGEST                  ",4         , sizeof(CMD5_DIGEST)                , LOC_MM_0136);
    MM_MGR_DEF(MM_CRFSOP                       ,"MM_CRFSOP                       ",32        , sizeof(CRFSOP)                     , LOC_MM_0137);

    MM_MGR_DEF(MM_CRFSDT_PNODE                 ,"MM_CRFSDT_PNODE                 ",32        , sizeof(CRFSDT_PNODE)               , LOC_MM_0138);
    MM_MGR_DEF(MM_CRFSDT_RNODE                 ,"MM_CRFSDT_RNODE                 ",32        , sizeof(CRFSDT_RNODE)               , LOC_MM_0139);
    MM_MGR_DEF(MM_CRFSDT                       ,"MM_CRFSDT                       ",32        , sizeof(CRFSDT)                     , LOC_MM_0140);

    MM_MGR_DEF(MM_CRFSCONHASH                  ,"MM_CRFSCONHASH                  ",1         , sizeof(CRFSCONHASH)                , LOC_MM_0141);
    MM_MGR_DEF(MM_CRFSCONHASH_RNODE            ,"MM_CRFSCONHASH_RNODE            ",32        , sizeof(CRFSCONHASH_RNODE)          , LOC_MM_0142);
    MM_MGR_DEF(MM_CRFSCONHASH_VNODE            ,"MM_CRFSCONHASH_VNODE            ",32        , sizeof(CRFSCONHASH_VNODE)          , LOC_MM_0143);

    MM_MGR_DEF(MM_CRFSCHTTP_NODE               ,"MM_CRFSCHTTP_NODE               ",32        , sizeof(CRFSCHTTP_NODE)             , LOC_MM_0144);

    MM_MGR_DEF(MM_CEXPAT_ATTR                  ,"MM_CEXPAT_ATTR                  ",256       , sizeof(CEXPAT_ATTR)                , LOC_MM_0145);
    MM_MGR_DEF(MM_CEXPAT_NODE                  ,"MM_CEXPAT_NODE                  ",256       , sizeof(CEXPAT_NODE)                , LOC_MM_0146);
    MM_MGR_DEF(MM_CRFS_LOCKED_FILE             ,"MM_CRFS_LOCKED_FILE             ",32        , sizeof(CRFS_LOCKED_FILE)           , LOC_MM_0147);
    MM_MGR_DEF(MM_CHTTP_NODE                   ,"MM_CHTTP_NODE                   ",256       , sizeof(CHTTP_NODE)                 , LOC_MM_0148);

    MM_MGR_DEF(MM_TASK_RUNNER_NODE             ,"MM_TASK_RUNNER_NODE             ",4         , sizeof(TASK_RUNNER_NODE)           , LOC_MM_0149);

    MM_MGR_DEF(MM_CHTTP_REQ                    ,"MM_CHTTP_REQ                    ",32        , sizeof(CHTTP_REQ)                  , LOC_MM_0150);
    MM_MGR_DEF(MM_CHTTP_RSP                    ,"MM_CHTTP_RSP                    ",32        , sizeof(CHTTP_RSP)                  , LOC_MM_0151);
    MM_MGR_DEF(MM_CHTTP_REST                   ,"MM_CHTTP_REST                   ",32        , sizeof(CHTTP_REST)                 , LOC_MM_0152);

    MM_MGR_DEF(MM_CDNS_NODE                    ,"MM_CDNS_NODE                    ",32        , sizeof(CDNS_NODE)                  , LOC_MM_0153);
    MM_MGR_DEF(MM_CDNS_REQ                     ,"MM_CDNS_REQ                     ",32        , sizeof(CDNS_REQ)                   , LOC_MM_0154);
    MM_MGR_DEF(MM_CDNS_RSP                     ,"MM_CDNS_RSP                     ",32        , sizeof(CDNS_RSP)                   , LOC_MM_0155);
    MM_MGR_DEF(MM_CDNS_RSP_NODE                ,"MM_CDNS_RSP_NODE                ",32        , sizeof(CDNS_RSP_NODE)              , LOC_MM_0156);

    MM_MGR_DEF(MM_CHTTP_STAT                   ,"MM_CHTTP_STAT                   ",256       , sizeof(CHTTP_STAT)                 , LOC_MM_0157);
    MM_MGR_DEF(MM_SUPER_CCOND                  ,"MM_SUPER_CCOND                  ",256       , sizeof(SUPER_CCOND)                , LOC_MM_0158);

    MM_MGR_DEF(MM_COROUTINE_CHECKER            ,"MM_COROUTINE_CHECKER            ",256       , sizeof(COROUTINE_CHECKER)          , LOC_MM_0159);
    MM_MGR_DEF(MM_COROUTINE_CLEANER            ,"MM_COROUTINE_CLEANER            ",256       , sizeof(COROUTINE_CLEANER)          , LOC_MM_0160);

    MM_MGR_DEF(MM_COROUTINE_COND               ,"MM_COROUTINE_COND               ",256       , sizeof(COROUTINE_COND)             , LOC_MM_0161);
    MM_MGR_DEF(MM_CHTTP_STORE                  ,"MM_CHTTP_STORE                  ",256       , sizeof(CHTTP_STORE)                , LOC_MM_0162);

    MM_MGR_DEF(MM_CRFS_WAIT_FILE               ,"MM_CRFS_WAIT_FILE               ",256       , sizeof(CRFS_WAIT_FILE)             , LOC_MM_0163);

    MM_MGR_DEF(MM_CCONNP                       ,"MM_CCONNP                       ",256       , sizeof(CCONNP)                     , LOC_MM_0164);
    MM_MGR_DEF(MM_CCONNP_MGR                   ,"MM_CCONNP_MGR                   ",256       , sizeof(CCONNP_MGR)                 , LOC_MM_0165);
    MM_MGR_DEF(MM_CRFS_NODE                    ,"MM_CRFS_NODE                    ",256       , sizeof(CRFS_NODE)                  , LOC_MM_0166);
    MM_MGR_DEF(MM_CRFS_HOT_PATH                ,"MM_CRFS_HOT_PATH                ",32        , sizeof(CRFS_HOT_PATH)              , LOC_MM_0167);
    ...
    MM_MGR_DEF(MM_CSFSDN                       ,"MM_CSFSDN                       ",256       , sizeof(CSFSDN)                     , LOC_MM_0177);
    MM_MGR_DEF(MM_CSFSDN_NODE                  ,"MM_CSFSDN_NODE                  ",256       , sizeof(CSFSDN_NODE)                , LOC_MM_0178);
    MM_MGR_DEF(MM_CSFSB                        ,"MM_CSFSB                        ",1         , sizeof(CSFSB)                      , LOC_MM_0179);
    MM_MGR_DEF(MM_CSFSD                        ,"MM_CSFSD                        ",256       , sizeof(CSFSD)                      , LOC_MM_0180);
    MM_MGR_DEF(MM_CSFSV                        ,"MM_CSFSV                        ",256       , sizeof(CSFSV)                      , LOC_MM_0181);
    MM_MGR_DEF(MM_CSFS_LOCKED_FILE             ,"MM_CSFS_LOCKED_FILE             ",32        , sizeof(CSFS_LOCKED_FILE)           , LOC_MM_0182);
    MM_MGR_DEF(MM_CSFS_WAIT_FILE               ,"MM_CSFS_WAIT_FILE               ",256       , sizeof(CSFS_WAIT_FILE)             , LOC_MM_0183);
    MM_MGR_DEF(MM_CSFSNP                       ,"MM_CSFSNP                       ",1        , sizeof(CSFSNP)                      , LOC_MM_0184);
    MM_MGR_DEF(MM_CSFSNP_MGR                   ,"MM_CSFSNP_MGR                   ",1        , sizeof(CSFSNP_MGR)                  , LOC_MM_0185);

    MM_MGR_DEF(MM_CSFSCONHASH                  ,"MM_CSFSCONHASH                  ",1         , sizeof(CSFSCONHASH)                , LOC_MM_0186);
    MM_MGR_DEF(MM_CSFSCONHASH_RNODE            ,"MM_CSFSCONHASH_RNODE            ",32        , sizeof(CSFSCONHASH_RNODE)          , LOC_MM_0187);
    MM_MGR_DEF(MM_CSFSCONHASH_VNODE            ,"MM_CSFSCONHASH_VNODE            ",32        , sizeof(CSFSCONHASH_VNODE)          , LOC_MM_0188);
    MM_MGR_DEF(MM_CSFS_NODE                    ,"MM_CSFS_NODE                    ",256       , sizeof(CSFS_NODE)                  , LOC_MM_0189);
    ...
    MM_MGR_DEF(MM_CRANGE_MGR                   ,"MM_CRANGE_MGR                   ",32        , sizeof(CRANGE_MGR)                 , LOC_MM_0192);

#if (SWITCH_ON == NGX_BGN_SWITCH)
    MM_MGR_DEF(MM_CNGX_RANGE                   ,"MM_CNGX_RANGE                   ",32        , sizeof(CNGX_RANGE)                 , LOC_MM_0193);
    MM_MGR_DEF(MM_CNGX_HTTP_BGN_MOD            ,"MM_CNGX_HTTP_BGN_MOD            ",32        , sizeof(CNGX_HTTP_BGN_MOD)          , LOC_MM_0194);
#endif/*(SWITCH_ON == NGX_BGN_SWITCH)*/

    MM_MGR_DEF(MM_CCALLBACK_NODE               ,"MM_CCALLBACK_NODE               ",256       , sizeof(CCALLBACK_NODE)             , LOC_MM_0195);

#if (SWITCH_ON == NGX_BGN_SWITCH && SWITCH_ON == NGX_KSSL_SWITCH)
    MM_MGR_DEF(MM_CNGX_KSSL_NODE               ,"MM_CNGX_KSSL_NODE               ",32        , sizeof(CNGX_KSSL_NODE)             , LOC_MM_0196);
#endif/*(SWITCH_ON == NGX_BGN_SWITCH && SWITCH_ON == NGX_KSSL_SWITCH)*/

    MM_MGR_DEF(MM_CTDNSNP_ITEM                  ,"MM_CTDNSNP_ITEM                ",256       , sizeof(CTDNSNP_ITEM)                 , LOC_MM_0197);
    MM_MGR_DEF(MM_CTDNSNP                       ,"MM_CTDNSNP                     ",256       , sizeof(CTDNSNP)                      , LOC_MM_0198);
    MM_MGR_DEF(MM_CTDNSNP_MGR                   ,"MM_CTDNSNP_MGR                 ",256       , sizeof(CTDNSNP_MGR)                  , LOC_MM_0199);
    MM_MGR_DEF(MM_CTDNSSV_ITEM                  ,"MM_CTDNSSV_ITEM                ",256       , sizeof(CTDNSSV_ITEM)                 , LOC_MM_0200);
    MM_MGR_DEF(MM_CTDNSSV_NODE                  ,"MM_CTDNSSV_NODE                ",256       , sizeof(CTDNSSV_NODE)                 , LOC_MM_0201);
    MM_MGR_DEF(MM_CTDNSSV_NODE_MGR              ,"MM_CTDNSSV_NODE_MGR            ",1         , sizeof(CTDNSSV_NODE_MGR)             , LOC_MM_0202);
    MM_MGR_DEF(MM_CTDNSSV_MGR                   ,"MM_CTDNSSV_MGR                 ",256       , sizeof(CTDNSSV_MGR)                  , LOC_MM_0203);
    MM_MGR_DEF(MM_CTDNSSV                       ,"MM_CTDNSSV                     ",256       , sizeof(CTDNSSV)                      , LOC_MM_0204);

    MM_MGR_DEF(MM_CDETECTN_ORIG_NODE            ,"MM_CDETECTN_ORIG_NODE           ",256      , sizeof(CDETECTN_ORIG_NODE)           , LOC_MM_0205);
    MM_MGR_DEF(MM_CDETECTN_IP_NODE              ,"MM_CDETECTN_IP_NODE             ",256      , sizeof(CDETECTN_IP_NODE)             , LOC_MM_0206);
    MM_MGR_DEF(MM_CDETECTN_STATUS_RANGE         ,"MM_CDETECTN_STATUS_RANGE        ",256      , sizeof(CDETECTN_STATUS_RANGE)        , LOC_MM_0207);
    MM_MGR_DEF(MM_CDETECTN_DOMAIN_NODE          ,"MM_CDETECTN_DOMAIN_NODE         ",256      , sizeof(CDETECTN_DOMAIN_NODE)         , LOC_MM_0208);

    MM_MGR_DEF(MM_CP2P_FILE                     ,"MM_CP2P_FILE                   ",256       , sizeof(CP2P_FILE)                    , LOC_MM_0209);
    MM_MGR_DEF(MM_CP2P_CMD                      ,"MM_CP2P_CMD                    ",256       , sizeof(CP2P_CMD)                     , LOC_MM_0210);

    MM_MGR_DEF(MM_CAGENT                        ,"MM_CAGENT                      ",1         , sizeof(CAGENT)                       , LOC_MM_0211);
    MM_MGR_DEF(MM_CPING_NODE                    ,"MM_CPING_NODE                  ",1         , sizeof(CPING_NODE)                   , LOC_MM_0212);

    MM_MGR_DEF(MM_CTDNS_SUSV_NODE               ,"MM_CTDNS_SUSV_NODE             ",1         , sizeof(CTDNS_SUSV_NODE)              , LOC_MM_0213);

    MM_MGR_DEF(MM_CMCDN                        ,"MM_CMCDN                        ",1         , sizeof(CMCDN)                        , LOC_MM_0214);
    MM_MGR_DEF(MM_CMCPGV                       ,"MM_CMCPGV                       ",1         , sizeof(CMCPGV)                       , LOC_MM_0215);
    MM_MGR_DEF(MM_CMCPGD                       ,"MM_CMCPGD                       ",256       , sizeof(CMCPGD)                       , LOC_MM_0216);

    MM_MGR_DEF(MM_CMCNP                        ,"MM_CMCNP                        ",1         , sizeof(CMCNP)                        , LOC_MM_0217);
    MM_MGR_DEF(MM_CMCNP_FNODE                  ,"MM_CMCNP_FNODE                  ",256       , sizeof(CMCNP_FNODE)                  , LOC_MM_0218);
    MM_MGR_DEF(MM_CMCNP_DNODE                  ,"MM_CMCNP_DNODE                  ",256       , sizeof(CMCNP_DNODE)                  , LOC_MM_0219);
    MM_MGR_DEF(MM_CMCNP_KEY                    ,"MM_CMCNP_KEY                    ",256       , sizeof(CMCNP_KEY)                    , LOC_MM_0220);
    MM_MGR_DEF(MM_CMCNP_ITEM                   ,"MM_CMCNP_ITEM                   ",256       , sizeof(CMCNP_ITEM)                   , LOC_MM_0221);
    MM_MGR_DEF(MM_CMCNP_BITMAP                 ,"MM_CMCNP_BITMAP                 ",256       , sizeof(CMCNP_BITMAP)                 , LOC_MM_0222);

    MM_MGR_DEF(MM_CAIO_NODE                    ,"MM_CAIO_NODE                    ",32        , sizeof(CAIO_NODE)                    , LOC_MM_0223);
    MM_MGR_DEF(MM_CAIO_REQ                     ,"MM_CAIO_REQ                     ",32        , sizeof(CAIO_REQ)                     , LOC_MM_0224);
    MM_MGR_DEF(MM_CAIO_PAGE                    ,"MM_CAIO_PAGE                    ",64        , sizeof(CAIO_PAGE)                    , LOC_MM_0225);
    MM_MGR_DEF(MM_CAIO_DISK                    ,"MM_CAIO_DISK                    ",64        , sizeof(CAIO_DISK)                    , LOC_MM_0226);

    MM_MGR_DEF(MM_CAMD_PAGE                    ,"MM_CAMD_PAGE                    ",256       , sizeof(CAMD_PAGE)                    , LOC_MM_0227);
    MM_MGR_DEF(MM_CAMD_REQ                     ,"MM_CAMD_REQ                     ",256       , sizeof(CAMD_REQ)                     , LOC_MM_0228);
    MM_MGR_DEF(MM_CAMD_NODE                    ,"MM_CAMD_NODE                    ",256       , sizeof(CAMD_NODE)                    , LOC_MM_0229);
    MM_MGR_DEF(MM_CAMD_SATA                    ,"MM_CAMD_SATA                    ",256       , sizeof(CAMD_SATA)                    , LOC_MM_0230);
    MM_MGR_DEF(MM_CAMD_SSD                     ,"MM_CAMD_SSD                     ",256       , sizeof(CAMD_SSD)                     , LOC_MM_0231);
    MM_MGR_DEF(MM_CAMD_COND                    ,"MM_CAMD_COND                    ",256       , sizeof(CAMD_COND)                    , LOC_MM_0232);

    MM_MGR_DEF(MM_CDCDN                        ,"MM_CDCDN                        ",1         , sizeof(CDCDN)                        , LOC_MM_0235);
    MM_MGR_DEF(MM_CDCPGV                       ,"MM_CDCPGV                       ",1         , sizeof(CDCPGV)                       , LOC_MM_0236);
    MM_MGR_DEF(MM_CDCPGD                       ,"MM_CDCPGD                       ",256       , sizeof(CDCPGD)                       , LOC_MM_0237);

    MM_MGR_DEF(MM_CDCNP                        ,"MM_CDCNP                        ",1         , sizeof(CDCNP)                        , LOC_MM_0238);
    MM_MGR_DEF(MM_CDCNP_FNODE                  ,"MM_CDCNP_FNODE                  ",256       , sizeof(CDCNP_FNODE)                  , LOC_MM_0239);
    MM_MGR_DEF(MM_CDCNP_DNODE                  ,"MM_CDCNP_DNODE                  ",256       , sizeof(CDCNP_DNODE)                  , LOC_MM_0240);
    MM_MGR_DEF(MM_CDCNP_KEY                    ,"MM_CDCNP_KEY                    ",256       , sizeof(CDCNP_KEY)                    , LOC_MM_0241);
    MM_MGR_DEF(MM_CDCNP_ITEM                   ,"MM_CDCNP_ITEM                   ",256       , sizeof(CDCNP_ITEM)                   , LOC_MM_0242);
    MM_MGR_DEF(MM_CDCNP_BITMAP                 ,"MM_CDCNP_BITMAP                 ",256       , sizeof(CDCNP_BITMAP)                 , LOC_MM_0243);

    MM_MGR_DEF(MM_CDC_PAGE                     ,"MM_CDC_PAGE                     ",256       , sizeof(CDC_PAGE)                     , LOC_MM_0244);
    MM_MGR_DEF(MM_CDC_REQ                      ,"MM_CDC_REQ                      ",256       , sizeof(CDC_REQ)                      , LOC_MM_0245);
    MM_MGR_DEF(MM_CDC_NODE                     ,"MM_CDC_NODE                     ",256       , sizeof(CDC_NODE)                     , LOC_MM_0246);
    MM_MGR_DEF(MM_CFC                          ,"MM_CFC                          ",4         , sizeof(CFC)                          , LOC_MM_0247);

    MM_MGR_DEF(MM_CMMAP_NODE                   ,"MM_CMMAP_NODE                   ",4         , sizeof(CMMAP_NODE)                   , LOC_MM_0248);
    MM_MGR_DEF(MM_CMSYNC_NODE                  ,"MM_CMSYNC_NODE                  ",4         , sizeof(CMSYNC_NODE)                  , LOC_MM_0249);

    MM_MGR_DEF(MM_CXFSPGB                      ,"MM_CXFSPGB                      ",1        , CXFSPGB_SIZE                        , LOC_MM_0250);
    MM_MGR_DEF(MM_CXFSPGD                      ,"MM_CXFSPGD                      ",256      , sizeof(CXFSPGD)                     , LOC_MM_0251);
    MM_MGR_DEF(MM_CXFSPGV                      ,"MM_CXFSPGV                      ",64       , sizeof(CXFSPGV)                     , LOC_MM_0252);

    MM_MGR_DEF(MM_CXFSDN                       ,"MM_CXFSDN                       ",1        , sizeof(CXFSDN)                      , LOC_MM_0253);

    MM_MGR_DEF(MM_CXFSNP_FNODE                 ,"MM_CXFSNP_FNODE                 ",1        , sizeof(CXFSNP_FNODE)                , LOC_MM_0254);
    MM_MGR_DEF(MM_CXFSNP_DNODE                 ,"MM_CXFSNP_DNODE                 ",1        , sizeof(CXFSNP_DNODE)                , LOC_MM_0255);
    MM_MGR_DEF(MM_CXFSNP_ITEM                  ,"MM_CXFSNP_ITEM                  ",1        , sizeof(CXFSNP_ITEM)                 , LOC_MM_0256);
    MM_MGR_DEF(MM_CXFSNP                       ,"MM_CXFSNP                       ",1        , sizeof(CXFSNP)                      , LOC_MM_0257);
    MM_MGR_DEF(MM_CXFSNP_MGR                   ,"MM_CXFSNP_MGR                   ",1        , sizeof(CXFSNP_MGR)                  , LOC_MM_0258);
    MM_MGR_DEF(MM_CXFSNP_KEY                   ,"MM_CXFSNP_KEY                   ",1        , sizeof(CXFSNP_KEY)                  , LOC_MM_0259);

    MM_MGR_DEF(MM_CXFSCONHASH                  ,"MM_CXFSCONHASH                  ",1         , sizeof(CXFSCONHASH)                , LOC_MM_0260);
    MM_MGR_DEF(MM_CXFSCONHASH_RNODE            ,"MM_CXFSCONHASH_RNODE            ",32        , sizeof(CXFSCONHASH_RNODE)          , LOC_MM_0261);
    MM_MGR_DEF(MM_CXFSCONHASH_VNODE            ,"MM_CXFSCONHASH_VNODE            ",32        , sizeof(CXFSCONHASH_VNODE)          , LOC_MM_0262);

    MM_MGR_DEF(MM_CXFS_LOCKED_FILE             ,"MM_CXFS_LOCKED_FILE             ",32        , sizeof(CXFS_LOCKED_FILE)           , LOC_MM_0263);
    MM_MGR_DEF(MM_CXFS_WAIT_FILE               ,"MM_CXFS_WAIT_FILE               ",256       , sizeof(CXFS_WAIT_FILE)             , LOC_MM_0264);

    MM_MGR_DEF(MM_CXFS_NODE                    ,"MM_CXFS_NODE                    ",256       , sizeof(CXFS_NODE)                  , LOC_MM_0265);
    MM_MGR_DEF(MM_CXFS_HOT_PATH                ,"MM_CXFS_HOT_PATH                ",32        , sizeof(CXFS_HOT_PATH)              , LOC_MM_0266);
    MM_MGR_DEF(MM_CXFSOP_MGR                   ,"MM_CXFSOP_MGR                   ",4         , sizeof(CXFSOP_MGR)                 , LOC_MM_0267);
...
UINT32 destory_static_mem()
{
    ...
    for ( type = 0; type < MM_END; type ++ )
    {
        ...
        MAN_CLEAN_LOCK(pMan, LOC_MM_0286);/*clean lock*/
    }
...
{
    free_static_mem(MM_MM_MAN_OCCUPY_NODE, mm_man_occupy_node, LOC_MM_0290);
    return (0);
}
...
{
    free_static_mem(MM_MM_MAN_LOAD_NODE, mm_man_load_node, LOC_MM_0291);
    return (0);
}
