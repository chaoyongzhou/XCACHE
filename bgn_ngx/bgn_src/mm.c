...
static UINT32 init_mem_manager()
{
    ...
    MM_MGR_DEF(MM_CTDNSNP_ITEM                  ,"MM_CTDNSNP_ITEM                ",1        , sizeof(CTDNSNP_ITEM)                 , LOC_MM_0213); 
    MM_MGR_DEF(MM_CTDNSNP                       ,"MM_CTDNSNP                     ",1        , sizeof(CTDNSNP)                      , LOC_MM_0214); 
    MM_MGR_DEF(MM_CTDNSNP_MGR                   ,"MM_CTDNSNP_MGR                 ",1        , sizeof(CTDNSNP_MGR)                  , LOC_MM_0215); 

    MM_MGR_DEF(MM_CDETECT_ORIG_NODE             ,"MM_CDETECT_ORIG_NODE           ",256      , sizeof(CDETECT_ORIG_NODE)            , LOC_MM_0216); 
    MM_MGR_DEF(MM_CDETECT_IP_NODE               ,"MM_CDETECT_IP_NODE             ",256      , sizeof(CDETECT_IP_NODE)              , LOC_MM_0217); 
...
UINT32 destory_static_mem()
{
    ...
    for ( type = 0; type < MM_END; type ++ )
    {
        ...
        MAN_CLEAN_LOCK(pMan, LOC_MM_0236);/*clean lock*/
    }
...
{
    free_static_mem(MM_MM_MAN_OCCUPY_NODE, mm_man_occupy_node, LOC_MM_0239);
    return (0);
}
...
{
    free_static_mem(MM_MM_MAN_LOAD_NODE, mm_man_load_node, LOC_MM_0240);
    return (0);
}
