...
static EC_BOOL __chfsmc_release_dn_no_lock(CHFSMC *chfsmc, const CHFSNP_FNODE *chfsnp_fnode)
{
...
static EC_BOOL __chfsmc_recycle_np_no_lock(CHFSMC *chfsmc, const uint32_t node_pos)
{
    CHFSNP      *chfsnp;
    CHFSMCLIST  *chfsmclist;
