...
static const CHTTP_API g_crfshttp_api_list[] = {
    ...
    {CONST_STR_AND_LEN("dsmf")              , CHTTP_METHOD_DELETE, crfshttp_commit_dsmf_request},
    {CONST_STR_AND_LEN("ddir")              , CHTTP_METHOD_DELETE, crfshttp_commit_ddir_request},
    {CONST_STR_AND_LEN("sexpire")           , CHTTP_METHOD_PATCH , crfshttp_commit_sexpire_request},
    ...
    {CONST_STR_AND_LEN("renew_header")      , CHTTP_METHOD_PUT   , crfshttp_commit_renew_header_request},
    ...
    {CONST_STR_AND_LEN("update")            , CHTTP_METHOD_PUT   , crfshttp_commit_update_request},
    {CONST_STR_AND_LEN("renew")             , CHTTP_METHOD_PUT   , crfshttp_commit_renew_request},
    {CONST_STR_AND_LEN("mexpire")           , CHTTP_METHOD_PATCH , crfshttp_commit_mexpire_request},
    {CONST_STR_AND_LEN("mdsmf")             , CHTTP_METHOD_DELETE, crfshttp_commit_mdsmf_request},
    {CONST_STR_AND_LEN("mddir")             , CHTTP_METHOD_DELETE, crfshttp_commit_mddir_request},
};
...
EC_BOOL crfshttp_commit_request(CHTTP_NODE *chttp_node)
{
    ...
    if(CHTTP_METHOD_UNKNOWN != method)
    {
        ...
        croutine_node = croutine_pool_load_preempt(TASK_REQ_CTHREAD_POOL(task_brd_default_get()),
                                           (UINT32)crfshttp_commit_start, 2, chttp_node, (UINT32)method);
        if(NULL_PTR == croutine_node)
        {
            dbg_log(SEC_0049_CRFSHTTP, 0)(LOGSTDOUT, "error:crfshttp_commit_request: "
                                                     "no croutine\n");
        ...
        CROUTINE_NODE_COND_RELEASE(croutine_node, LOC_CRFSHTTP_0002);
...
EC_BOOL crfshttp_commit_start(CHTTP_NODE *chttp_node, const UINT32 method)
{
    ...
    if(NULL_PTR == chttp_api)
    {
        ...
        dbg_log(SEC_0049_CRFSHTTP, 0)(LOGSTDOUT, "error:crfshttp_commit_start: "
                                                 "no api for %s:'%.*s'\n",
        ...
        CHTTP_NODE_LOG_INFO_WHEN_DONE(chttp_node, "error:crfshttp_commit_start: invalid request %s:'%.*s'",
                                                  chttp_method_str((uint32_t)method),
    ...
    dbg_log(SEC_0049_CRFSHTTP, 9)(LOGSTDOUT, "[DEBUG] crfshttp_commit_start: "
                                             "api: method %d, name %s\n",
