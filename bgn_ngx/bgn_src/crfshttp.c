...
STATIC_CAST static EC_BOOL __crfshttp_uri_is_setsmf_memc_post_op(const CBUFFER *uri_cbuffer)
{
    const uint8_t *uri_str;
    uint32_t       uri_len;
...
STATIC_CAST static EC_BOOL __crfshttp_uri_is_check_memc_get_op(const CBUFFER *uri_cbuffer)
{
    const uint8_t *uri_str;
    uint32_t       uri_len;
...
STATIC_CAST static EC_BOOL __crfshttp_uri_is_getsmf_memc_get_op(const CBUFFER *uri_cbuffer)
{
    const uint8_t *uri_str;
    uint32_t       uri_len;
...
STATIC_CAST static EC_BOOL __crfshttp_uri_is_update_memc_post_op(const CBUFFER *uri_cbuffer)
{
    const uint8_t *uri_str;
    uint32_t       uri_len;
...
STATIC_CAST static EC_BOOL __crfshttp_uri_is_dsmf_memc_get_op(const CBUFFER *uri_cbuffer)
{
    const uint8_t *uri_str;
    uint32_t       uri_len;
...
STATIC_CAST static EC_BOOL __crfshttp_uri_is_ddir_memc_get_op(const CBUFFER *uri_cbuffer)
{
    const uint8_t *uri_str;
    uint32_t       uri_len;
...
/*delete multiple files*/
STATIC_CAST static EC_BOOL __crfshttp_uri_is_mdbgf_post_op(const CBUFFER *uri_cbuffer)
{
    const uint8_t *uri_str;
    uint32_t       uri_len;
