...
void api_ui_cp_add_history(API_UI_INSTANCE* instance, API_UI_ELEM* element)
{
    ...
    new_node = (API_UI_HISTORY*) api_ui_malloc(sizeof(API_UI_HISTORY), LOC_API_0313);
...
void api_ui_cp_add_param(API_UI_INSTANCE* instance, API_UI_ELEM* element, char* word) {
    ...
    new_node = (API_UI_PARAM*) api_ui_malloc(sizeof(API_UI_PARAM), LOC_API_0314);
    ...
    if (new_node != NULL)
    {
        ...
        switch(element->type)
        {
            ...
            case API_UI_ELEM_TYPE_STR:
                ...
                new_node->x.str = (char*)api_ui_malloc(sizeof(char)*string_length, LOC_API_0315);
...
//    API_UI_HISTORY* tmp_history;
    ...
    while(instance->params != NULL)
    {
        ...
        {
            api_ui_free(instance->params->x.str, LOC_API_0316);
        }

        tmp_params = instance->params;
        instance->params = tmp_params->next;

        api_ui_free(tmp_params, LOC_API_0317);
    }
#if 0
    ...
    while(instance->history)
    {
        ...
        api_ui_free(tmp_history, LOC_API_0318);
    }
#endif
    /* Free up the actual instance */
    api_ui_free(instance, LOC_API_0319);
...
API_UI_INSTANCE* api_ui_cp_init(EC_BOOL interactive)
{
    ...
    retValue = (API_UI_INSTANCE*) api_ui_malloc(sizeof(API_UI_INSTANCE), LOC_API_0320);
