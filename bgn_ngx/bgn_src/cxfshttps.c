...
EC_BOOL cxfshttps_commit_http_get(CHTTPS_NODE *chttps_node)
{
    ...
    else if (EC_TRUE == cxfshttps_is_http_get_xfs_up(chttps_node))
    {
        ret = cxfshttps_commit_xfs_up_get_request(chttps_node);
    }
    else if (EC_TRUE == cxfshttps_is_http_get_xfs_down(chttps_node))
    {
        ret = cxfshttps_commit_xfs_down_get_request(chttps_node);
    }
    else if (EC_TRUE == cxfshttps_is_http_get_xfs_add(chttps_node))
    {
        ret = cxfshttps_commit_xfs_add_get_request(chttps_node);
    }
    else if (EC_TRUE == cxfshttps_is_http_get_xfs_del(chttps_node))
    {
        ret = cxfshttps_commit_xfs_del_get_request(chttps_node);
    }
    else if (EC_TRUE == cxfshttps_is_http_get_xfs_list(chttps_node))
    {
        ret = cxfshttps_commit_xfs_list_get_request(chttps_node);
    }
    else
    {
        CBUFFER *uri_cbuffer;
...
STATIC_CAST static EC_BOOL __cxfshttps_uri_is_xfs_up_get_op(const CBUFFER *uri_cbuffer)
{
    const uint8_t *uri_str;
    uint32_t       uri_len;
...
EC_BOOL cxfshttps_is_http_get_xfs_up(const CHTTPS_NODE *chttps_node)
{
    const CBUFFER *uri_cbuffer;

    uri_cbuffer  = CHTTPS_NODE_URI(chttps_node);

    dbg_log(SEC_0200_CXFSHTTPS, 9)(LOGSTDOUT, "[DEBUG] cxfshttps_is_http_get_xfs_up: uri: '%.*s' [len %d]\n",
                        CBUFFER_USED(uri_cbuffer),
                        CBUFFER_DATA(uri_cbuffer),
                        CBUFFER_USED(uri_cbuffer));
...
EC_BOOL cxfshttps_commit_xfs_up_get_request(CHTTPS_NODE *chttps_node)
{
    EC_BOOL ret;

    if(EC_FALSE == cxfshttps_handle_xfs_up_get_request(chttps_node))
    {
        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error:cxfshttps_commit_xfs_up_get_request: handle 'GET' request failed\n");
        return (EC_FALSE);
    }

    if(EC_FALSE == cxfshttps_make_xfs_up_get_response(chttps_node))
    {
        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error:cxfshttps_commit_xfs_up_get_request: make 'GET' response failed\n");
        return (EC_FALSE);
    }

    ret = cxfshttps_commit_xfs_up_get_response(chttps_node);
    if(EC_FALSE == ret)
    {
        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error:cxfshttps_commit_xfs_up_get_request: commit 'GET' response failed\n");
        return (EC_FALSE);
    }
...
EC_BOOL cxfshttps_handle_xfs_up_get_request(CHTTPS_NODE *chttps_node)
{
    CBUFFER       *uri_cbuffer;
    ...
    if(!(0 == req_body_chunk_num))
    {
        ...
        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error: cxfshttps_handle_xfs_up_get_request: chunk num %ld\n", req_body_chunk_num);

        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error: cxfshttps_handle_xfs_up_get_request: chunk mgr %p info\n", req_body_chunks);
        chunk_mgr_print_info(LOGSTDOUT, req_body_chunks);

        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error: cxfshttps_handle_xfs_up_get_request: chunk mgr %p chars\n", req_body_chunks);
        chunk_mgr_print_chars(LOGSTDOUT, req_body_chunks);

        CHTTPS_NODE_LOG_TIME_WHEN_DONE(chttps_node);
        CHTTPS_NODE_LOG_STAT_WHEN_DONE(chttps_node, "XFS_ERR %s %u --", "GET", CHTTP_BAD_REQUEST);
        CHTTPS_NODE_LOG_INFO_WHEN_DONE(chttps_node, "[DEBUG] cxfshttps_handle_xfs_up_get_request");
...
EC_BOOL cxfshttps_make_xfs_up_get_response(CHTTPS_NODE *chttps_node)
{
    if(EC_FALSE == chttps_make_response_header_common(chttps_node, (uint64_t)0))
    {
        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error:cxfshttps_make_xfs_up_get_response: make response header failed\n");
        return (EC_FALSE);
    }
    ...
    if(BIT_TRUE == CHTTPS_NODE_KEEPALIVE(chttps_node))
    {
        if(EC_FALSE == chttps_make_response_header_keepalive(chttps_node))
        {
            dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error:cxfshttps_make_xfs_up_get_response: make response header keepalive failed\n");
            return (EC_FALSE);
        }
    }
    ...
    if(EC_FALSE == chttps_make_response_header_end(chttps_node))
    {
        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error:cxfshttps_make_xfs_up_get_response: make header end failed\n");
        return (EC_FALSE);
    }
...
EC_BOOL cxfshttps_commit_xfs_up_get_response(CHTTPS_NODE *chttps_node)
{
    CSOCKET_CNODE * csocket_cnode;
    ...
    if(NULL_PTR == csocket_cnode)
    {
        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error:cxfshttps_commit_xfs_up_get_response: csocket_cnode of chttps_node %p is null\n", chttps_node);
        return (EC_FALSE);
    }
...
STATIC_CAST static EC_BOOL __cxfshttps_uri_is_xfs_down_get_op(const CBUFFER *uri_cbuffer)
{
    const uint8_t *uri_str;
    uint32_t       uri_len;
...
EC_BOOL cxfshttps_is_http_get_xfs_down(const CHTTPS_NODE *chttps_node)
{
    const CBUFFER *uri_cbuffer;

    uri_cbuffer  = CHTTPS_NODE_URI(chttps_node);

    dbg_log(SEC_0200_CXFSHTTPS, 9)(LOGSTDOUT, "[DEBUG] cxfshttps_is_http_get_xfs_down: uri: '%.*s' [len %d]\n",
                        CBUFFER_USED(uri_cbuffer),
                        CBUFFER_DATA(uri_cbuffer),
                        CBUFFER_USED(uri_cbuffer));
...
EC_BOOL cxfshttps_commit_xfs_down_get_request(CHTTPS_NODE *chttps_node)
{
    EC_BOOL ret;

    if(EC_FALSE == cxfshttps_handle_xfs_down_get_request(chttps_node))
    {
        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error:cxfshttps_commit_xfs_down_get_request: handle 'GET' request failed\n");
        return (EC_FALSE);
    }

    if(EC_FALSE == cxfshttps_make_xfs_down_get_response(chttps_node))
    {
        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error:cxfshttps_commit_xfs_down_get_request: make 'GET' response failed\n");
        return (EC_FALSE);
    }

    ret = cxfshttps_commit_xfs_down_get_response(chttps_node);
    if(EC_FALSE == ret)
    {
        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error:cxfshttps_commit_xfs_down_get_request: commit 'GET' response failed\n");
        return (EC_FALSE);
    }
...
EC_BOOL cxfshttps_handle_xfs_down_get_request(CHTTPS_NODE *chttps_node)
{
    CBUFFER       *uri_cbuffer;
    ...
    if(!(0 == req_body_chunk_num))
    {
        ...
        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error: cxfshttps_handle_xfs_down_get_request: chunk num %ld\n", req_body_chunk_num);

        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error: cxfshttps_handle_xfs_down_get_request: chunk mgr %p info\n", req_body_chunks);
        chunk_mgr_print_info(LOGSTDOUT, req_body_chunks);

        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error: cxfshttps_handle_xfs_down_get_request: chunk mgr %p chars\n", req_body_chunks);
        chunk_mgr_print_chars(LOGSTDOUT, req_body_chunks);

        CHTTPS_NODE_LOG_TIME_WHEN_DONE(chttps_node);
        CHTTPS_NODE_LOG_STAT_WHEN_DONE(chttps_node, "XFS_ERR %s %u --", "GET", CHTTP_BAD_REQUEST);
        CHTTPS_NODE_LOG_INFO_WHEN_DONE(chttps_node, "[DEBUG] cxfshttps_handle_xfs_down_get_request");
...
EC_BOOL cxfshttps_make_xfs_down_get_response(CHTTPS_NODE *chttps_node)
{
    if(EC_FALSE == chttps_make_response_header_common(chttps_node, (uint64_t)0))
    {
        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error:cxfshttps_make_xfs_down_get_response: make response header failed\n");
        return (EC_FALSE);
    }
    ...
    if(BIT_TRUE == CHTTPS_NODE_KEEPALIVE(chttps_node))
    {
        if(EC_FALSE == chttps_make_response_header_keepalive(chttps_node))
        {
            dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error:cxfshttps_make_xfs_down_get_response: make response header keepalive failed\n");
            return (EC_FALSE);
        }
    }
    ...
    if(EC_FALSE == chttps_make_response_header_end(chttps_node))
    {
        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error:cxfshttps_make_xfs_down_get_response: make header end failed\n");
        return (EC_FALSE);
    }
...
EC_BOOL cxfshttps_commit_xfs_down_get_response(CHTTPS_NODE *chttps_node)
{
    CSOCKET_CNODE * csocket_cnode;
    ...
    if(NULL_PTR == csocket_cnode)
    {
        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error:cxfshttps_commit_xfs_down_get_response: csocket_cnode of chttps_node %p is null\n", chttps_node);
        return (EC_FALSE);
    }
...
STATIC_CAST static EC_BOOL __cxfshttps_uri_is_xfs_add_get_op(const CBUFFER *uri_cbuffer)
{
    const uint8_t *uri_str;
    uint32_t       uri_len;
...
EC_BOOL cxfshttps_is_http_get_xfs_add(const CHTTPS_NODE *chttps_node)
{
    const CBUFFER *uri_cbuffer;

    uri_cbuffer  = CHTTPS_NODE_URI(chttps_node);

    dbg_log(SEC_0200_CXFSHTTPS, 9)(LOGSTDOUT, "[DEBUG] cxfshttps_is_http_get_xfs_add: uri: '%.*s' [len %d]\n",
                        CBUFFER_USED(uri_cbuffer),
                        CBUFFER_DATA(uri_cbuffer),
                        CBUFFER_USED(uri_cbuffer));
...
EC_BOOL cxfshttps_commit_xfs_add_get_request(CHTTPS_NODE *chttps_node)
{
    EC_BOOL ret;

    if(EC_FALSE == cxfshttps_handle_xfs_add_get_request(chttps_node))
    {
        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error:cxfshttps_commit_xfs_add_get_request: handle 'GET' request failed\n");
        return (EC_FALSE);
    }

    if(EC_FALSE == cxfshttps_make_xfs_add_get_response(chttps_node))
    {
        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error:cxfshttps_commit_xfs_add_get_request: make 'GET' response failed\n");
        return (EC_FALSE);
    }

    ret = cxfshttps_commit_xfs_add_get_response(chttps_node);
    if(EC_FALSE == ret)
    {
        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error:cxfshttps_commit_xfs_add_get_request: commit 'GET' response failed\n");
        return (EC_FALSE);
    }
...
EC_BOOL cxfshttps_handle_xfs_add_get_request(CHTTPS_NODE *chttps_node)
{
    CBUFFER       *uri_cbuffer;
    ...
    if(!(0 == req_body_chunk_num))
    {
        ...
        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error: cxfshttps_handle_xfs_add_get_request: chunk num %ld\n", req_body_chunk_num);

        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error: cxfshttps_handle_xfs_add_get_request: chunk mgr %p info\n", req_body_chunks);
        chunk_mgr_print_info(LOGSTDOUT, req_body_chunks);

        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error: cxfshttps_handle_xfs_add_get_request: chunk mgr %p chars\n", req_body_chunks);
        chunk_mgr_print_chars(LOGSTDOUT, req_body_chunks);

        CHTTPS_NODE_LOG_TIME_WHEN_DONE(chttps_node);
        CHTTPS_NODE_LOG_STAT_WHEN_DONE(chttps_node, "XFS_ERR %s %u --", "GET", CHTTP_BAD_REQUEST);
        CHTTPS_NODE_LOG_INFO_WHEN_DONE(chttps_node, "[DEBUG] cxfshttps_handle_xfs_add_get_request");
...
EC_BOOL cxfshttps_make_xfs_add_get_response(CHTTPS_NODE *chttps_node)
{
    if(EC_FALSE == chttps_make_response_header_common(chttps_node, (uint64_t)0))
    {
        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error:cxfshttps_make_xfs_add_get_response: make response header failed\n");
        return (EC_FALSE);
    }
    ...
    if(BIT_TRUE == CHTTPS_NODE_KEEPALIVE(chttps_node))
    {
        if(EC_FALSE == chttps_make_response_header_keepalive(chttps_node))
        {
            dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error:cxfshttps_make_xfs_add_get_response: make response header keepalive failed\n");
            return (EC_FALSE);
        }
    }
    ...
    if(EC_FALSE == chttps_make_response_header_end(chttps_node))
    {
        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error:cxfshttps_make_xfs_add_get_response: make header end failed\n");
        return (EC_FALSE);
    }
...
EC_BOOL cxfshttps_commit_xfs_add_get_response(CHTTPS_NODE *chttps_node)
{
    CSOCKET_CNODE * csocket_cnode;
    ...
    if(NULL_PTR == csocket_cnode)
    {
        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error:cxfshttps_commit_xfs_add_get_response: csocket_cnode of chttps_node %p is null\n", chttps_node);
        return (EC_FALSE);
    }
...
STATIC_CAST static EC_BOOL __cxfshttps_uri_is_xfs_del_get_op(const CBUFFER *uri_cbuffer)
{
    const uint8_t *uri_str;
    uint32_t       uri_len;
...
EC_BOOL cxfshttps_is_http_get_xfs_del(const CHTTPS_NODE *chttps_node)
{
    const CBUFFER *uri_cbuffer;

    uri_cbuffer  = CHTTPS_NODE_URI(chttps_node);

    dbg_log(SEC_0200_CXFSHTTPS, 9)(LOGSTDOUT, "[DEBUG] cxfshttps_is_http_get_xfs_del: uri: '%.*s' [len %d]\n",
                        CBUFFER_USED(uri_cbuffer),
                        CBUFFER_DATA(uri_cbuffer),
                        CBUFFER_USED(uri_cbuffer));
...
EC_BOOL cxfshttps_commit_xfs_del_get_request(CHTTPS_NODE *chttps_node)
{
    EC_BOOL ret;

    if(EC_FALSE == cxfshttps_handle_xfs_del_get_request(chttps_node))
    {
        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error:cxfshttps_commit_xfs_del_get_request: handle 'GET' request failed\n");
        return (EC_FALSE);
    }

    if(EC_FALSE == cxfshttps_make_xfs_del_get_response(chttps_node))
    {
        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error:cxfshttps_commit_xfs_del_get_request: make 'GET' response failed\n");
        return (EC_FALSE);
    }

    ret = cxfshttps_commit_xfs_del_get_response(chttps_node);
    if(EC_FALSE == ret)
    {
        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error:cxfshttps_commit_xfs_del_get_request: commit 'GET' response failed\n");
        return (EC_FALSE);
    }
...
EC_BOOL cxfshttps_handle_xfs_del_get_request(CHTTPS_NODE *chttps_node)
{
    CBUFFER       *uri_cbuffer;
    ...
    if(!(0 == req_body_chunk_num))
    {
        ...
        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error: cxfshttps_handle_xfs_del_get_request: chunk num %ld\n", req_body_chunk_num);

        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error: cxfshttps_handle_xfs_del_get_request: chunk mgr %p info\n", req_body_chunks);
        chunk_mgr_print_info(LOGSTDOUT, req_body_chunks);

        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error: cxfshttps_handle_xfs_del_get_request: chunk mgr %p chars\n", req_body_chunks);
        chunk_mgr_print_chars(LOGSTDOUT, req_body_chunks);

        CHTTPS_NODE_LOG_TIME_WHEN_DONE(chttps_node);
        CHTTPS_NODE_LOG_STAT_WHEN_DONE(chttps_node, "XFS_ERR %s %u --", "GET", CHTTP_BAD_REQUEST);
        CHTTPS_NODE_LOG_INFO_WHEN_DONE(chttps_node, "[DEBUG] cxfshttps_handle_xfs_del_get_request");
...
EC_BOOL cxfshttps_make_xfs_del_get_response(CHTTPS_NODE *chttps_node)
{
    if(EC_FALSE == chttps_make_response_header_common(chttps_node, (uint64_t)0))
    {
        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error:cxfshttps_make_xfs_del_get_response: make response header failed\n");
        return (EC_FALSE);
    }
    ...
    if(BIT_TRUE == CHTTPS_NODE_KEEPALIVE(chttps_node))
    {
        if(EC_FALSE == chttps_make_response_header_keepalive(chttps_node))
        {
            dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error:cxfshttps_make_xfs_del_get_response: make response header keepalive failed\n");
            return (EC_FALSE);
        }
    }
    ...
    if(EC_FALSE == chttps_make_response_header_end(chttps_node))
    {
        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error:cxfshttps_make_xfs_del_get_response: make header end failed\n");
        return (EC_FALSE);
    }
...
EC_BOOL cxfshttps_commit_xfs_del_get_response(CHTTPS_NODE *chttps_node)
{
    CSOCKET_CNODE * csocket_cnode;
    ...
    if(NULL_PTR == csocket_cnode)
    {
        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error:cxfshttps_commit_xfs_del_get_response: csocket_cnode of chttps_node %p is null\n", chttps_node);
        return (EC_FALSE);
    }
...
STATIC_CAST static EC_BOOL __cxfshttps_uri_is_xfs_list_get_op(const CBUFFER *uri_cbuffer)
{
    const uint8_t *uri_str;
    uint32_t       uri_len;
...
EC_BOOL cxfshttps_is_http_get_xfs_list(const CHTTPS_NODE *chttps_node)
{
    const CBUFFER *uri_cbuffer;

    uri_cbuffer  = CHTTPS_NODE_URI(chttps_node);

    dbg_log(SEC_0200_CXFSHTTPS, 9)(LOGSTDOUT, "[DEBUG] cxfshttps_is_http_get_xfs_list: uri: '%.*s' [len %d]\n",
                        CBUFFER_USED(uri_cbuffer),
                        CBUFFER_DATA(uri_cbuffer),
                        CBUFFER_USED(uri_cbuffer));
...
EC_BOOL cxfshttps_commit_xfs_list_get_request(CHTTPS_NODE *chttps_node)
{
    EC_BOOL ret;

    if(EC_FALSE == cxfshttps_handle_xfs_list_get_request(chttps_node))
    {
        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error:cxfshttps_commit_xfs_list_get_request: handle 'GET' request failed\n");
        return (EC_FALSE);
    }

    if(EC_FALSE == cxfshttps_make_xfs_list_get_response(chttps_node))
    {
        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error:cxfshttps_commit_xfs_list_get_request: make 'GET' response failed\n");
        return (EC_FALSE);
    }

    ret = cxfshttps_commit_xfs_list_get_response(chttps_node);
    if(EC_FALSE == ret)
    {
        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error:cxfshttps_commit_xfs_list_get_request: commit 'GET' response failed\n");
        return (EC_FALSE);
    }
...
EC_BOOL cxfshttps_handle_xfs_list_get_request(CHTTPS_NODE *chttps_node)
{
    CBUFFER       *uri_cbuffer;
    ...
    if(!(0 == req_body_chunk_num))
    {
        ...
        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error: cxfshttps_handle_xfs_list_get_request: chunk num %ld\n", req_body_chunk_num);

        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error: cxfshttps_handle_xfs_list_get_request: chunk mgr %p info\n", req_body_chunks);
        chunk_mgr_print_info(LOGSTDOUT, req_body_chunks);

        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error: cxfshttps_handle_xfs_list_get_request: chunk mgr %p chars\n", req_body_chunks);
        chunk_mgr_print_chars(LOGSTDOUT, req_body_chunks);

        CHTTPS_NODE_LOG_TIME_WHEN_DONE(chttps_node);
        CHTTPS_NODE_LOG_STAT_WHEN_DONE(chttps_node, "XFS_ERR %s %u --", "GET", CHTTP_BAD_REQUEST);
        CHTTPS_NODE_LOG_INFO_WHEN_DONE(chttps_node, "[DEBUG] cxfshttps_handle_xfs_list_get_request");
    ...
    if(EC_TRUE == __cxfshttps_uri_is_xfs_list_get_op(uri_cbuffer))
    {
        ...
        CHTTPS_NODE_LOG_TIME_WHEN_DONE(chttps_node);
        CHTTPS_NODE_LOG_STAT_WHEN_DONE(chttps_node, "XFSMON_SUCC %s %u --", "GET", CHTTP_OK);
        CHTTPS_NODE_LOG_INFO_WHEN_DONE(chttps_node, "[DEBUG] cxfshttps_handle_xfs_list_get_request: list xfs done");
...
EC_BOOL cxfshttps_make_xfs_list_get_response(CHTTPS_NODE *chttps_node)
{
    CBYTES        *content_cbytes;
    uint64_t       content_len;
    ...
    if(EC_FALSE == chttps_make_response_header_common(chttps_node, content_len))
    {
        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error:cxfshttps_make_xfs_list_get_response: make response header failed\n");
        return (EC_FALSE);
    }
    ...
    if(BIT_TRUE == CHTTPS_NODE_KEEPALIVE(chttps_node))
    {
        if(EC_FALSE == chttps_make_response_header_keepalive(chttps_node))
        {
            dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error:cxfshttps_make_xfs_list_get_response: make response header keepalive failed\n");
            return (EC_FALSE);
        }
    }
    ...
    if(EC_FALSE == chttps_make_response_header_end(chttps_node))
    {
        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error:cxfshttps_make_xfs_list_get_response: make header end failed\n");
        return (EC_FALSE);
    }
    ...
    if(EC_FALSE == chttps_make_response_body_ext(chttps_node,
                                              ...
                                              (uint32_t)CBYTES_LEN(content_cbytes)))
    {
        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error:cxfshttps_make_xfs_list_get_response: make body with len %d failed\n",
                           (uint32_t)CBYTES_LEN(content_cbytes));
        return (EC_FALSE);
    }
    cbytes_umount(content_cbytes, NULL_PTR, NULL_PTR);
...
EC_BOOL cxfshttps_commit_xfs_list_get_response(CHTTPS_NODE *chttps_node)
{
    CSOCKET_CNODE * csocket_cnode;
    ...
    if(NULL_PTR == csocket_cnode)
    {
        dbg_log(SEC_0200_CXFSHTTPS, 0)(LOGSTDOUT, "error:cxfshttps_commit_xfs_list_get_response: csocket_cnode of chttps_node %p is null\n", chttps_node);
        return (EC_FALSE);
    }
