...
static void __cbgt_print_table_name(const UINT32 cbgt_md_id, LOG *log)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:__cbgt_print_table_name: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
...
static void __cbgt_print_row(const UINT32 cbgt_md_id, const CBYTES *row, LOG *log)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:__cbgt_print_row: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
static void __cbgt_print_key(const UINT32 cbgt_md_id, const uint8_t *key, LOG *log)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:__cbgt_print_key: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
UINT32 cbgt_free_module_static_mem(const UINT32 cbgt_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_free_module_static_mem: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
...
EC_BOOL cbgt_aging_handle(const UINT32 cbgt_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_aging_handle: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        return (EC_FALSE);
    }
...
UINT32 cbgt_set_mod_mgr(const UINT32 cbgt_md_id, const MOD_MGR * src_mod_mgr)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_set_mod_mgr: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
void    cbgt_close_mod_mgr(const UINT32 cbgt_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_close_mod_mgr: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
void cbgt_print_status(const UINT32 cbgt_md_id, LOG *log)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_print_status: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_is_root_server(const UINT32 cbgt_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "warn:cbgt_is_root_server: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        return (EC_FALSE);
    }
...
EC_BOOL cbgt_is_meta_server(const UINT32 cbgt_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "warn:cbgt_is_meta_server: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        return (EC_FALSE);
    }
...
EC_BOOL cbgt_is_colf_server(const UINT32 cbgt_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "warn:cbgt_is_colf_server: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        return (EC_FALSE);
    }
...
EC_BOOL cbgt_is_user_server(const UINT32 cbgt_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "warn:cbgt_is_user_server: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        return (EC_FALSE);
    }
...
EC_BOOL cbgt_is_user_client(const UINT32 cbgt_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "warn:cbgt_is_user_client: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        return (EC_FALSE);
    }
...
EC_BOOL cbgt_check_exist(const UINT32 cbgt_md_id, const UINT32 table_id, const MOD_NODE *mod_node)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_check_exist: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
UINT32  cbgt_fetch_table_id(const UINT32 cbgt_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_fetch_table_id: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
...
CBYTES *cbgt_kv_new(const UINT32 cbgt_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_kv_new: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_kv_init(const UINT32 cbgt_md_id, const CBYTES *row, const CBYTES *colf, const CBYTES *colq, const CBYTES *val, CBYTES *kv)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_kv_init: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_kv_clean(const UINT32 cbgt_md_id, CBYTES *kv)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_kv_clean: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
CBYTES *cbgt_key_new(const UINT32 cbgt_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_key_new: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_key_init(const UINT32 cbgt_md_id, const CBYTES *row, const CBYTES *colf, const CBYTES *colq, const ctime_t ts, CBYTES *key)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_key_init: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_key_clean(const UINT32 cbgt_md_id, CBYTES *key)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_key_clean: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_reserve_table_id(const UINT32 cbgt_md_id, UINT32 *table_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_reserve_table_id: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_release_table_id(const UINT32 cbgt_md_id, const UINT32 table_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_release_table_id: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_get_root_mod_node(const UINT32 cbgt_md_id, MOD_NODE *mod_node)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_get_root_mod_node: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
                                ...
                                const CBYTES *right_row, const UINT32 right_table_id, const MOD_NODE *right_mod_node)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_split_register_no_lock: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
                                ...
                                const CBYTES *right_row, const UINT32 right_table_id, const MOD_NODE *right_mod_node)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_split_register: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
                                ...
                                const CBYTES *des_row  , const UINT32 des_table_id  , const MOD_NODE *des_mod_node )
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_merge_register_no_lock: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
                                ...
                                const CBYTES *des_row  , const UINT32 des_table_id  , const MOD_NODE *des_mod_node )
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_merge_register: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_delete_kv_no_lock(const UINT32 cbgt_md_id, const CBYTES *key_bytes)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_delete_kv_no_lock: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_delete_kv(const UINT32 cbgt_md_id, const CBYTES *key_bytes)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_delete_kv: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL __cbgt_merge_one_group(const UINT32 cbgt_md_id, const CVECTOR *kv_bytes_vec)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:__cbgt_merge_one_group: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL __cbgt_merge_groups(const UINT32 cbgt_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:__cbgt_merge_groups: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_merge(const UINT32 cbgt_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_merge: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
static EC_BOOL __cbgt_split_no_lock(const UINT32 cbgt_md_id, EC_BOOL *split_flag)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:__cbgt_split_no_lock: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_split_no_lock(const UINT32 cbgt_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_split_no_lock: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_split(const UINT32 cbgt_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_split: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_unlink(const UINT32 cbgt_md_id, const UINT32 table_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_unlink: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_merge_table(const UINT32 cbgt_md_id, const CBYTES *left_table_name, const UINT32 left_table_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_merge_table: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_flush(const UINT32 cbgt_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_flush: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_exist_table(const UINT32 cbgt_md_id, const CBYTES *table_name)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_exist_table: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_create_table_on_root(const UINT32 cbgt_md_id, const CBYTES *table_name, const CVECTOR *col_family_name_vec)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_create_table_on_root: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_create_table_on_meta(const UINT32 cbgt_md_id, const CVECTOR *col_family_name_vec)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_create_table_on_meta: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_create_colf_on_meta(const UINT32 cbgt_md_id, const CBYTES  *colf_name)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_create_colf_on_meta: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_create_table_on_colf(const UINT32 cbgt_md_id, const CBYTES *colf_row)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_create_table_on_colf: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
static EC_BOOL __cbgt_get_table_and_key_no_lock(const UINT32 cbgt_md_id, const CBYTES *table_key, UINT32 *table_id, MOD_NODE *mod_node, CBYTES *key_bytes)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:__cbgt_get_table_and_key_no_lock: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
static EC_BOOL __cbgt_get_table(const UINT32 cbgt_md_id, const CBYTES *table_name, UINT32 *table_id, MOD_NODE *mod_node)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:__cbgt_get_table: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
static EC_BOOL __cbgt_get_rmc_table_and_key_no_lock(const UINT32 cbgt_md_id, const CBYTES *table_name, UINT32 *table_id, MOD_NODE *mod_node, CBYTES *key_bytes)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:__cbgt_get_rmc_table_and_key_no_lock: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
static EC_BOOL __cbgt_get_rmc_table(const UINT32 cbgt_md_id, const CBYTES *table_name, UINT32 *table_id, MOD_NODE *mod_node)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:__cbgt_get_rmc_table: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
static EC_BOOL __cbgt_get_user_table_and_key_no_lock(const UINT32 cbgt_md_id, const CBYTES *user_table_key, UINT32 *table_id, MOD_NODE *mod_node, CBYTES *key_bytes)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:__cbgt_get_user_table_and_key_no_lock: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
static EC_BOOL __cbgt_get_user_table(const UINT32 cbgt_md_id, const CBYTES *user_rowkey, UINT32 *table_id, MOD_NODE *mod_node)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:__cbgt_get_user_table: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_get_colf_table_from_root(const UINT32 cbgt_md_id, const CBYTES *table_name, const CBYTES *colf, UINT32 *table_id, MOD_NODE *mod_node)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_get_colf_table_from_root: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_get_colf_table_from_meta(const UINT32 cbgt_md_id, const CBYTES *colf, UINT32 *table_id, MOD_NODE *mod_node)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_get_colf_table_from_meta: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_get_user_table_from_root(const UINT32 cbgt_md_id, const CBYTES *table_name, const CBYTES *row, const CBYTES *colf, const CBYTES *colq, UINT32 *table_id, MOD_NODE *mod_node)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_get_user_table_from_root: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_get_user_table_from_meta(const UINT32 cbgt_md_id, const CBYTES *row, const CBYTES *colf, const CBYTES *colq, UINT32 *table_id, MOD_NODE *mod_node)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_get_user_table_from_meta: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_get_user_table_from_colf(const UINT32 cbgt_md_id, const CBYTES *row, const CBYTES *colf, const CBYTES *colq, UINT32 *table_id, MOD_NODE *mod_node)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_get_user_table_from_colf: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
static EC_BOOL __cbgt_open_rmc_table(const UINT32 cbgt_md_id, const UINT32 server_type, const CBYTES *table_name, UINT32 *table_id, MOD_NODE *mod_node)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:__cbgt_open_rmc_table: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
static EC_BOOL __cbgt_open_user_table(const UINT32 cbgt_md_id, const CBYTES *user_table_key, CBYTES *user_table_name, UINT32 *table_id, MOD_NODE *mod_node)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:__cbgt_open_user_table: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_open_colf_table_from_root(const UINT32 cbgt_md_id, const CBYTES *table_name, const CBYTES *colf, UINT32 *table_id, MOD_NODE *mod_node)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_open_colf_table_from_root: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_open_colf_table_from_meta(const UINT32 cbgt_md_id, const CBYTES *colf, UINT32 *table_id, MOD_NODE *mod_node)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_open_colf_table_from_meta: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_open_user_table_from_root(const UINT32 cbgt_md_id, const CBYTES *table_name, const CBYTES * row, const CBYTES *colf, const CBYTES * colq, CBYTES *user_table_name, UINT32 *table_id, MOD_NODE *mod_node)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_open_user_table_from_root: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_open_user_table_from_colf(const UINT32 cbgt_md_id, const CBYTES * row, const CBYTES *colf, const CBYTES * colq, CBYTES *user_table_name, UINT32 *table_id, MOD_NODE *mod_node)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_open_user_table_from_colf: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_close_rmc_table(const UINT32 cbgt_md_id, const CBYTES *table_name, const UINT32 table_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_close_rmc_table: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_close_user_table(const UINT32 cbgt_md_id, const CBYTES *table_name, const UINT32 table_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_close_user_table: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_report_closing(const UINT32 cbgt_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_report_closing: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_fetch_key_no_lock(const UINT32 cbgt_md_id, const CBYTES *kv_bytes, CBYTES *key_bytes)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_fetch_key_no_lock: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_fetch_key(const UINT32 cbgt_md_id, const CBYTES *kv_bytes, CBYTES *key_bytes)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_fetch_key: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_fetch_row_no_lock(const UINT32 cbgt_md_id, const CBYTES *kv_bytes, CBYTES *row_bytes)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_fetch_row_no_lock: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_fetch_row(const UINT32 cbgt_md_id, const CBYTES *kv_bytes, CBYTES *row_bytes)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_fetch_row: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_fetch_from_rmc_no_lock(const UINT32 cbgt_md_id, const CBYTES *kv_bytes, UINT32 *table_id, MOD_NODE *mod_node)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_fetch_from_rmc_no_lock: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_fetch_from_rmc(const UINT32 cbgt_md_id, const CBYTES *kv_bytes, UINT32 *table_id, MOD_NODE *mod_node)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_fetch_from_rmc: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_insert_rfqv_no_lock(const UINT32 cbgt_md_id, const CBYTES *row, const CBYTES *colf, const CBYTES *colq, const CBYTES *val)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_insert_rfqv_no_lock: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_insert_rfqv(const UINT32 cbgt_md_id, const CBYTES *row, const CBYTES *colf, const CBYTES *colq, const CBYTES *val)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_insert_rfqv: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_update_value_no_lock(const UINT32 cbgt_md_id, const CBYTES *key, CBYTES *val)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_update_value_no_lock: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_update_value(const UINT32 cbgt_md_id, const CBYTES *key, CBYTES *val)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_update_value: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_mess_register_no_lock(const UINT32 cbgt_md_id, const CBYTES *key, const UINT32 table_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_mess_register_no_lock: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_mess_register(const UINT32 cbgt_md_id, const CBYTES *key, const UINT32 table_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_mess_register: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_update_register_no_lock(const UINT32 cbgt_md_id, const CBYTES *key, const UINT32 table_id, const MOD_NODE *mod_node)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_update_register_no_lock: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_update_register(const UINT32 cbgt_md_id, const CBYTES *key, const UINT32 table_id, const MOD_NODE *mod_node)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_update_register: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_insert_register_no_lock(const UINT32 cbgt_md_id, const CBYTES *row, const UINT32 table_id, const MOD_NODE *mod_node)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_insert_register_no_lock: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_insert_register(const UINT32 cbgt_md_id, const CBYTES *row, const UINT32 table_id, const MOD_NODE *mod_node)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_insert_register: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_fetch_user_table_no_lock(const UINT32 cbgt_md_id, const CBYTES *row, const CBYTES *colf, const CBYTES *colq, UINT32 *user_table_id, MOD_NODE *user_mod_node)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_fetch_user_table_no_lock: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_fetch_user_table(const UINT32 cbgt_md_id, const CBYTES *row, const CBYTES *colf, const CBYTES *colq, UINT32 *user_table_id, MOD_NODE *user_mod_node)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_fetch_user_table: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_insert_colf(const UINT32 cbgt_md_id, const CBYTES *row, const CBYTES *colf, const CBYTES *colq, const CBYTES *val)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_insert_colf: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
static EC_BOOL __cbgt_set_user_table_to_session(const UINT32 cbgt_md_id, const CSTRING *colf_session_path, const CBYTES *user_table_name, const UINT32 user_table_id, const MOD_NODE *mod_node)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:__cbgt_set_user_table_to_session: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
                                                                ...
                                                                UINT32 *user_table_id, MOD_NODE *mod_node)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:__cbgt_get_user_table_from_session: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
static EC_BOOL __cbgt_set_colf_table_to_session(const UINT32 cbgt_md_id, const CSTRING *colf_session_path, const UINT32 colf_table_id, const MOD_NODE *mod_node)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:__cbgt_set_colf_table_to_session: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
                                                              ...
                                                              CSTRING *colf_session_path, UINT32 *colf_table_id, MOD_NODE *mod_node)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:__cbgt_get_colf_table_from_session: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
static EC_BOOL __cbgt_rmv_colf_table_from_session(const UINT32 cbgt_md_id, const CSTRING *colf_session_path)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:__cbgt_rmv_colf_table_from_session: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
static EC_BOOL __cbgt_set_meta_table_to_session(const UINT32 cbgt_md_id, const CSTRING *meta_session_path, const UINT32 meta_table_id, const MOD_NODE *mod_node)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:__cbgt_set_meta_table_to_session: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
void cbgt_was_access(const UINT32 cbgt_md_id)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_was_access: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
static EC_BOOL __cbgt_get_meta_table_from_session(const UINT32 cbgt_md_id, const CBYTES *table_name, CSTRING *meta_session_path, UINT32 *meta_table_id, MOD_NODE *mod_node)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:__cbgt_get_meta_table_from_session: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_insert(const UINT32 cbgt_md_id, const CBYTES *table_name, const CBYTES *row, const CBYTES *colf, const CBYTES *colq, const CBYTES *val)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_insert: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_fetch_kv_from_colf_no_lock(const UINT32 cbgt_md_id, const CBYTES *row, const CBYTES *colf, const CBYTES *colq, CBYTES *kv)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_fetch_kv_from_colf_no_lock: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_search_from_colf(const UINT32 cbgt_md_id, const CBYTES *row, const CBYTES *colf, const CBYTES *colq, CBYTES *val)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_search_from_colf: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_search_from_user(const UINT32 cbgt_md_id, const CBYTES *row, const CBYTES *colf, const CBYTES *colq, CBYTES *val)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_search_from_user: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_search(const UINT32 cbgt_md_id, const CBYTES *table_name, const CBYTES *row, const CBYTES *colf, const CBYTES *colq, CBYTES *val)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_search: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_fetch0(const UINT32 cbgt_md_id, const CBYTES *table_name, const CBYTES *row, const CBYTES *colf, const CBYTES *colq, CBYTES *val)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_fetch: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL __cbgt_fetch(const UINT32 cbgt_md_id, const CBYTES *table_name, const CBYTES *row, const CBYTES *colf, const CBYTES *colq, CBYTES *val)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:__cbgt_fetch: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_delete_from_user(const UINT32 cbgt_md_id, const CBYTES *row, const CBYTES *colf, const CBYTES *colq)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_delete_from_user: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_delete_from_colf(const UINT32 cbgt_md_id, const CBYTES *row, const CBYTES *colf, const CBYTES *colq)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_delete_from_colf: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_delete(const UINT32 cbgt_md_id, const CBYTES *table_name, const CBYTES *row, const CBYTES *colf, const CBYTES *colq)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_delete: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_cleanup_colf_table(const UINT32 cbgt_md_id, const CBYTES *table_name)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_cleanup_colf_table: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_cleanup_meta_table(const UINT32 cbgt_md_id, const CBYTES *table_name)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_cleanup_meta_table: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_delete_user_table(const UINT32 cbgt_md_id, const CBYTES *table_name)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_delete_user_table: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_delete_colf_table(const UINT32 cbgt_md_id, const CBYTES *table_name, const CBYTES *colf_name)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_delete_colf_table: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_add_colf_table(const UINT32 cbgt_md_id, const CBYTES *table_name, const CBYTES *colf_name)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_add_colf_table: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_select_from_user(const UINT32 cbgt_md_id, const CSTRING *row_pattern, const CSTRING *colf_pattern, const CSTRING *colq_pattern, const CSTRING *val_pattern, CVECTOR *ret_kv_vec)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_select_from_user: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_select_from_colf(const UINT32 cbgt_md_id, const UINT32 cached_mode, const CSTRING *row_pattern, const CSTRING *colf_pattern, const CSTRING *colq_pattern, const CSTRING *val_pattern, CVECTOR *ret_kv_vec)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_select_from_colf: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_select_from_meta(const UINT32 cbgt_md_id, const UINT32 cached_mode, const CSTRING *row_pattern, const CSTRING *colf_pattern, const CSTRING *colq_pattern, const CSTRING *val_pattern, CVECTOR *ret_kv_vec)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_select_from_meta: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_select_from_root(const UINT32 cbgt_md_id, const UINT32 cached_mode, const CSTRING *table_pattern, const CSTRING *row_pattern, const CSTRING *colf_pattern, const CSTRING *colq_pattern, const CSTRING *val_pattern, CVECTOR *ret_kv_vec)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_select_from_root: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_select_in_meta(const UINT32 cbgt_md_id, const UINT32 cached_mode, const CBYTES *table_name, const CSTRING *row_pattern, const CSTRING *colf_pattern, const CSTRING *colq_pattern, const CSTRING *val_pattern, CVECTOR *ret_kv_vec)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_select_in_meta: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_select_in_colf(const UINT32 cbgt_md_id, const UINT32 cached_mode, const CBYTES *table_name, const CBYTES *colf_name, const CSTRING *row_pattern,  const CSTRING *colq_pattern, const CSTRING *val_pattern, CVECTOR *ret_kv_vec)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_select_in_colf: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
EC_BOOL cbgt_select(const UINT32 cbgt_md_id, const UINT32 cached_mode, const CSTRING *table_pattern, const CSTRING *row_pattern, const CSTRING *colf_pattern, const CSTRING *colq_pattern, const CSTRING *val_pattern, CVECTOR *ret_kv_vec)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_select: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
void cbgt_traversal_no_lock(const UINT32 cbgt_md_id, LOG *log)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_traversal_no_lock: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
void cbgt_traversal(const UINT32 cbgt_md_id, LOG *log)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_traversal: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
void cbgt_runthrough_no_lock(const UINT32 cbgt_md_id, LOG *log)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_runthrough_no_lock: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
void cbgt_runthrough(const UINT32 cbgt_md_id, LOG *log)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_runthrough: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
void cbgt_traversal_depth(const UINT32 cbgt_md_id, LOG *log)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_traversal_depth: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
...
void cbgt_runthrough_depth(const UINT32 cbgt_md_id, LOG *log)
{
    ...
    {
        sys_log(LOGSTDOUT,
                "error:cbgt_runthrough_depth: cbgt module #0x%lx not started.\n",
                cbgt_md_id);
        cbgt_print_module_status(cbgt_md_id, LOGSTDOUT);
        dbg_exit(MD_CBGT, cbgt_md_id);
    }
