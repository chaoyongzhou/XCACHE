...
EC_BOOL api_cmd_ui_cxfs_qlist_seg_of_np(CMD_PARA_VEC * param)
{
    ...
    seg_cstr_vec = cvector_new(0, MM_CSTRING, LOC_API_0445);
    ...
    cvector_clean(seg_cstr_vec, (CVECTOR_DATA_CLEANER)cstring_free, LOC_API_0446);
    cvector_free(seg_cstr_vec, LOC_API_0447);
...
EC_BOOL api_cmd_ui_cxfs_qlist_path(CMD_PARA_VEC * param)
{
    ...
    path_cstr_vec = cvector_new(0, MM_CSTRING, LOC_API_0448);
    ...
    cvector_clean(path_cstr_vec, (CVECTOR_DATA_CLEANER)cstring_free, LOC_API_0449);
    cvector_free(path_cstr_vec, LOC_API_0450);
...
EC_BOOL api_cmd_ui_cxfs_qlist_seg(CMD_PARA_VEC * param)
{
    ...
    seg_cstr_vec = cvector_new(0, MM_CSTRING, LOC_API_0451);
    ...
    cvector_clean(seg_cstr_vec, (CVECTOR_DATA_CLEANER)cstring_free, LOC_API_0452);
    cvector_free(seg_cstr_vec, LOC_API_0453);
...
EC_BOOL api_cmd_ui_cxfs_qlist_tree_of_np(CMD_PARA_VEC * param)
{
    ...
    tree_cstr_vec = cvector_new(0, MM_CSTRING, LOC_API_0454);
    ...
    cvector_clean(tree_cstr_vec, (CVECTOR_DATA_CLEANER)cstring_free, LOC_API_0455);
    cvector_free(tree_cstr_vec, LOC_API_0456);
...
EC_BOOL api_cmd_ui_cxfs_qlist_tree(CMD_PARA_VEC * param)
{
    ...
    path_cstr_vec = cvector_new(0, MM_CSTRING, LOC_API_0457);
    ...
    cvector_clean(path_cstr_vec, (CVECTOR_DATA_CLEANER)cstring_free, LOC_API_0458);
    cvector_free(path_cstr_vec, LOC_API_0459);
